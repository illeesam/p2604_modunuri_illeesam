...
window.XsSample12 = {
  ...
  setup() {
    ...
    const uiState = reactive({ loading: false, error: null, previewDate: coUtil.cofToYmd(new Date()), previewTime: new Date().toTimeString().slice(0, 5), showAreaDrop: false, showCatModal: false });
