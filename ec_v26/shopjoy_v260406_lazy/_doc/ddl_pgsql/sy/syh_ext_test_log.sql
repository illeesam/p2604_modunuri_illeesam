...
CREATE TABLE IF NOT EXISTS shopjoy_2604.syh_ext_test_log (
    ...
    upd_by          VARCHAR(40),
    upd_date        TIMESTAMP,
    CONSTRAINT syh_ext_test_log_pk_log_id PRIMARY KEY (log_id)
);
...
COMMENT ON COLUMN shopjoy_2604.syh_ext_test_log.reg_site_id      IS '사이트ID';
...
COMMENT ON COLUMN shopjoy_2604.syh_ext_test_log.test_result_cd  IS '테스트결과 (SUCCESS/FAIL)';
