...
CREATE TABLE shopjoy_2604.sy_user_pref (
    user_pref_id VARCHAR(21)  NOT NULL,
    ...
    CONSTRAINT sy_user_pref_pk_user_pref_id PRIMARY KEY (user_pref_id),
    CONSTRAINT sy_user_pref_uk_user_id_pref_key_x2 UNIQUE (user_id, pref_key)
);
