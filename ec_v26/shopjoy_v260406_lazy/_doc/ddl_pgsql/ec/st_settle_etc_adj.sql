...
CREATE TABLE shopjoy_2604.st_settle_etc_adj (
    settle_etc_adj_id   VARCHAR(21)  NOT NULL CONSTRAINT st_settle_etc_adj_pk_settle_etc_adj_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.st_settle_etc_adj.reg_site_id IS '사이트ID';
...
CREATE INDEX st_settle_etc_adj_ix01_settle_id ON shopjoy_2604.st_settle_etc_adj USING btree (settle_id);
