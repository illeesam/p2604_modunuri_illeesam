...
CREATE TABLE shopjoy_2604.pdh_prod_sku_price_hist (
    hist_id          VARCHAR(21)  NOT NULL CONSTRAINT pdh_prod_sku_price_hist_pk_hist_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pdh_prod_sku_price_hist.reg_site_id IS '사이트ID (sy_site.site_id)';
COMMENT ON COLUMN shopjoy_2604.pdh_prod_sku_price_hist.prod_sku_id IS 'SKU ID (pd_prod_sku.prod_sku_id)';
...
CREATE INDEX pdh_prod_sku_price_hist_ix01_chg_date ON shopjoy_2604.pdh_prod_sku_price_hist USING btree (chg_date);
CREATE INDEX pdh_prod_sku_price_hist_ix02_prod_id ON shopjoy_2604.pdh_prod_sku_price_hist USING btree (prod_id);
CREATE INDEX pdh_prod_sku_price_hist_ix03_prod_sku_id ON shopjoy_2604.pdh_prod_sku_price_hist USING btree (prod_sku_id);
