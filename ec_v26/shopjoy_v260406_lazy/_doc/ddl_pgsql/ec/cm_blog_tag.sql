...
CREATE TABLE shopjoy_2604.cm_blog_tag (
    blog_tag_id VARCHAR(21) NOT NULL CONSTRAINT cm_blog_tag_pk_blog_tag_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.cm_blog_tag.reg_site_id IS '사이트ID';
...
CREATE INDEX cm_blog_tag_ix01_blog_id ON shopjoy_2604.cm_blog_tag USING btree (blog_id);
