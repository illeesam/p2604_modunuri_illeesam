...
CREATE TABLE shopjoy_2604.st_recon (
    recon_id               VARCHAR(21) NOT NULL CONSTRAINT st_recon_pk_recon_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.st_recon.reg_site_id IS '사이트ID';
...
CREATE INDEX st_recon_ix04_settle_period ON shopjoy_2604.st_recon USING btree (settle_period);
