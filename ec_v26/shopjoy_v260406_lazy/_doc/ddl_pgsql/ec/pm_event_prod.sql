...
CREATE TABLE shopjoy_2604.pm_event_prod (
    event_prod_id VARCHAR(21)  NOT NULL,
    event_id   VARCHAR(21) NOT NULL,
    prod_id    VARCHAR(21) NOT NULL,
    reg_site_id    VARCHAR(21) NOT NULL,
    reg_date   TIMESTAMP   DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pm_event_prod_pk_event_prod_id PRIMARY KEY (event_prod_id),
    CONSTRAINT pm_event_prod_uk_event_id_prod_id_x2 UNIQUE (event_id, prod_id)
);
