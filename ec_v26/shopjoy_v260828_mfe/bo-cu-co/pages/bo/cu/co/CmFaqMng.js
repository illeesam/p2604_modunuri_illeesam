/* ShopJoy Admin - FAQ관리 */
window.BoCuCoCmFaqMng = {
  name: 'bo-cu-co-cmFaqMng',
  props: {
  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      console.log(' ■■ BoCuCoCmFaqMng.js : handleBtnAction -> ', cmd, param);
    ...
    const handleSelectAction = (cmd, param = {}) => {
      console.log(' ■■ BoCuCoCmFaqMng.js : handleSelectAction -> ', cmd, param);
    ...
    const handleGridCellAction = (cmd, colKey, row, e = {}) => {
      console.log(' ■■ BoCuCoCmFaqMng.js : handleGridCellAction -> ', cmd, colKey, row);
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['USE_YN'], {compNm: 'bo-cu-co-cmFaqMng'});
