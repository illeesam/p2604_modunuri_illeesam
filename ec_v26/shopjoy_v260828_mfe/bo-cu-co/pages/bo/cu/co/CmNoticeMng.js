 ...
 */
window.BoCuCoCmNoticeMng = {
  name: 'bo-cu-co-cmNoticeMng',
  props: {
  ...
  setup(props) {
    ...
    const handleGridCellAction = (cmd, colKey, row, e = {}) => {
      console.log(' ■■ BoCuCoCmNoticeMng.js : handleGridCellAction -> ', cmd, colKey, row);
    ...
    const fnLoadCodes = async () => {
      ...
      await s.saLoadCodes(['NOTICE_TYPE_CD', 'NOTICE_STATUS', 'DATE_RANGE_OPT'], {compNm: 'bo-cu-co-cmNoticeMng'});
