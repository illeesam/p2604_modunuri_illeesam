/* ShopJoy Admin - 공지사항관리 상세/등록 (bo-cu-co 전용 사본)
 ...
 * 실제로 bo-cu-co(registerComponents, 태그 'CmNoticeDtl')와 bo-sy-ba(register() 메뉴
 ...
 * 경로를 미리 새겨둠) 밑으로 옮겼다 — 이제 bo-cu-ba의 원본과는 이름이 달라 어떤 순서로
...
window.BoCuCoCmNoticeDtl = {
  ...
  setup(props) {
    ...
    const fnLoadCodes = async () => {
      ...
      await s.saLoadCodes(['NOTICE_TYPE_CD', 'NOTICE_STATUS'], {compNm: 'bo-cu-co-cmNoticeDtl'});
