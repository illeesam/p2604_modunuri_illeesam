...
export default {
  name: 'bo-ap-home-dashboardBoEc02',
  props: {
  ...
  setup() {
    ...
    const fnBuildApiParams = (compId) => ({
      compId,
      uiNm: 'bo-ap-home-dashboardBoEc02',
    ...
    const loadDashboard = async () => {
      ...
      try {
        ...
        const items = COMP_IDS.map(compId => ({ compId, itemKey: COMP_ITEM_KEY[compId], uiNm: 'bo-ap-home-dashboardBoEc02', siteId, startYmd, endYmd }));
