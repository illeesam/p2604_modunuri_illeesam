 ...
 * 대메뉴 목록을 넘긴다:
 *   - bo-aa-main/mfe.html: 7개 도메인 전부 → 통합 데모 화면
 *   - bo-aa-main/mfe-{조합}.html: 대메뉴 일부만 골라 조합(예: mfe-sy.html, mfe-sy-pd.html)
  ...
  const App = {
    ...
    setup() {
      ...
      /* groupedMenuOf — 대메뉴 하나에 여러 마이크로 레포가 소그룹(=카탈로그 폴더 하나)
         으로 나눠 기여한다(예: pd = bo-pd-pd 의 "상품" + bo-pd-cate 의 "카테고리"). 카탈로그가
