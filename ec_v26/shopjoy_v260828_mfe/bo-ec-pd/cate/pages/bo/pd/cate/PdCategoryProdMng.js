...
export default {
  name: 'pd-cate-pdCategoryProdMng',
  props: {
  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      console.log(' ■■ BoPdCatePdCategoryProdMng.js : handleBtnAction -> ', cmd, param);
      // 검색조건으로 목록 조회
    ...
    const handleSelectAction = (cmd, param = {}) => {
      console.log(' ■■ BoPdCatePdCategoryProdMng.js : handleSelectAction -> ', cmd, param);
      // 좌측 트리 노드 선택
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['PROD_STATUS_CD'], {compNm: 'pd-cate-pdCategoryProdMng'});
      try {
