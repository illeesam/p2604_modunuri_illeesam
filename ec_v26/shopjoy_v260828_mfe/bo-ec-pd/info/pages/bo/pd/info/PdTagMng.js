...
export default {
  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      console.log(' ■■ BoPdPdPdTagMng.js : handleBtnAction -> ', cmd, param);
      // 검색조건으로 목록 조회
    ...
    const handleSelectAction = (cmd, param = {}) => {
      console.log(' ■■ BoPdPdPdTagMng.js : handleSelectAction -> ', cmd, param);
      // 태그 그리드 행 삭제
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['USE_YN'], {compNm: 'pd-info-pdTagMng'});
      try {
  ...
  template: `
<bo-page title="태그관리" :share-query="searchParam">
  <!-- ===== ■. 검색 ====================================================== -->
  <bo-container>
    <!-- ===== ■.■. 검색 영역 ================================================= -->
  ...
  <bo-container title="태그 목록" :count-text="baseGridPager.pageTotalCount + '건'">
    ...
    <bo-excel-down-modal :show="excelModal.show" domain="pdTag" area-nm="태그"
      :columns="columns.baseGrid" ui-nm="태그관리" :params="buildExcelParams()"
