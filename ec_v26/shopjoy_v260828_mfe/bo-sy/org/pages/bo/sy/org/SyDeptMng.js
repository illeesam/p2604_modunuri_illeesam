...
export default {
  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      console.log(' ■■ BoSyOrgSyDeptMng.js : handleBtnAction -> ', cmd, param);
      // 검색조건으로 목록 조회
    ...
    const handleSelectAction = (cmd, param = {}) => {
      console.log(' ■■ BoSyOrgSyDeptMng.js : handleSelectAction -> ', cmd, param);
      // 부서 그리드 행 삭제 마킹
    ...
    const fnCallbackModal = (popCmd, param, result) => {
      console.log(' ■■ BoSyOrgSyDeptMng : fnCallbackModal -> ', popCmd, param, result);
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['USE_YN', 'DEPT_TYPE_CD'], { compNm: 'sy-org-syDeptMng' });
