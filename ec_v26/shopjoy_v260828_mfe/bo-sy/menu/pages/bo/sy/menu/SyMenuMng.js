...
export default {
  ...
  setup(props) {
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['MENU_TYPE_CD', 'USE_YN'], {compNm: 'SyMenuMng'});
      codes.menu_type = codeStore.sgGetGrpCodes('MENU_TYPE_CD');
  ...
  template: /* html */`
<bo-page title="메뉴관리" :share-query="searchParam">
  <!-- ===== ■. 검색 영역 =================================================== -->
  <bo-container>
