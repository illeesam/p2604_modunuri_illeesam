...
(function () {
  ...
  const scripts = [
    R.loadScript(base + 'pages/bo/pd/pd/PdTagMng.js'),
    R.loadScript(base + 'pages/bo/pd/pd/PdRestockNotiMng.js'),
  ];

  Promise.all(scripts).then(function () {
    const screens = [
      { id: 'bo-pd-pd-pdTagMng', label: '상품태그관리', group: '상품', comp: window.BoPdPdPdTagMng },
      { id: 'bo-pd-pd-pdRestockNotiMng', label: '재입고알림관리', group: '상품', comp: window.BoPdPdPdRestockNotiMng },
    ];
