...
window.BoPdCatePdCategoryMng = {
  name: 'bo-pd-cate-pdCategoryMng',
  props: {
  ...
  setup(props) {
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['CATEGORY_DEPTH', 'PROD_STATUS_CD', 'CATEGORY_STATUS_CD'], {compNm: 'bo-pd-cate-pdCategoryMng'});
      try {
