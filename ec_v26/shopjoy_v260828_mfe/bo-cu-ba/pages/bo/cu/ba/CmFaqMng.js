...
window.BoCuBaCmFaqMng = {
  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      console.log(' ■■ BoCuBaCmFaqMng.js : handleBtnAction -> ', cmd, param);
    ...
    const handleSelectAction = (cmd, param = {}) => {
      console.log(' ■■ BoCuBaCmFaqMng.js : handleSelectAction -> ', cmd, param);
    ...
    const handleGridCellAction = (cmd, colKey, row, e = {}) => {
      console.log(' ■■ BoCuBaCmFaqMng.js : handleGridCellAction -> ', cmd, colKey, row);
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['USE_YN'], {compNm: 'bo-cu-ba-cmFaqMng'});
