...
window.BoCuBaCmFaqDtl = {
  name: 'bo-cu-ba-cmFaqDtl',
  props: {
  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      console.log(' ■■ BoCuBaCmFaqDtl.js : handleBtnAction -> ', cmd, param);
      if (cmd === 'form-save') {
        return handleSave();
    ...
    const handleSelectAction = (cmd, param = {}) => {
      console.log(' ■■ BoCuBaCmFaqDtl.js : handleSelectAction -> ', cmd, param);
    ...
    const fnCallbackModal = (popCmd, param, result) => {
      console.log(' ■■ BoCuBaCmFaqDtl : fnCallbackModal -> ', popCmd, param, result);
    ...
    const fnLoadCodes = async () => {
      try {
        ...
        await codeStore.saLoadCodes(['USE_YN'], {compNm: 'bo-cu-ba-cmFaqDtl'});
