...
(function () {
  ...
  const scripts = [
    R.loadScript(base + 'pages/bo/cu/ba/CmNoticeDtl.js'),
    R.loadScript(base + 'pages/bo/cu/ba/CmNoticeMng.js'),
    R.loadScript(base + 'pages/bo/cu/ba/CmFaqDtl.js'),
    R.loadScript(base + 'pages/bo/cu/ba/CmFaqMng.js'),
  ];

  Promise.all(scripts).then(function () {
    const screens = [
      { id: 'bo-cu-ba-cmNoticeMng', label: '공지사항관리', group: '고객', comp: window.BoCuBaCmNoticeMng },
      { id: 'bo-cu-ba-cmFaqMng', label: 'FAQ관리', group: '고객', comp: window.BoCuBaCmFaqMng },
    ];
    const innerComps = [
      { tag: 'CmNoticeDtl', comp: window.BoCuBaCmNoticeDtl },
      { tag: 'CmFaqDtl', comp: window.BoCuBaCmFaqDtl },
    ];
