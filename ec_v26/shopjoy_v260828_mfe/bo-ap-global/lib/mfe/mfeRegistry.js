 ...
 * 모른다. 각 도메인 폴더(bo-ap-home/, bo-ec-pd-pd/, bo-ec-pd-cate/, bo-ec-cu-ba/, bo-ec-cu-co/, bo-sy-ba/, bo-sy-org/ —
 * 메인프레임 bo-ap-global/ 의 형제 폴더)가 자기 화면을 스스로 이 레지스트리에 등록(register)
...
window.MFE_REGISTRY = (function () {
  ...
  /* toAbsFolder — 상대경로('../bo-ec-pd-pd/')를 절대 URL로 정규화. manifest.js 내부에서
  ...
  return {
    ...
    /* ensureMenuLoaded(menuKey) — 카탈로그에 있는 폴더들을 "전부" 로드. 대메뉴를
       ...
       (2026-08-28) — bo-ec-cu-ba/bo-ec-cu-co 처럼 서로 다른 폴더가 같은 window 전역명
