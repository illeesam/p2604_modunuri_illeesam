...
export default {
  ...
  setup(props) {
    ...
    const searchParam = reactive({ searchType: '', searchValue: '', memberId: '', memberNm: '', claimTypeCd: '', claimStatusCd: '', dateRangeType: '', dateRange: '', dateRangeStart: '', dateRangeEnd: '' });
    ...
    const initPage = async () => {
      ...
      Object.assign(searchParam, { dateRangeType: 'request_date', dateRangeStart: `${thisYear - 3}-01-01`, dateRangeEnd: `${thisYear}-12-31` });
      await fnLoadCodes();
