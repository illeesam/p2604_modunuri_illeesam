...
export default {
  ...
  setup() {
    ...
    const fnBuildApiParams = (compId) => ({
      compId,
      uiNm: 'bo-ab-home-dashboardBoEc01',
    ...
    const loadDashboard = async () => {
      ...
      try {
        ...
        const items = COMP_IDS.map(compId => ({ compId, itemKey: COMP_ITEM_KEY[compId], uiNm: 'bo-ab-home-dashboardBoEc01', siteId, startYmd, endYmd }));
