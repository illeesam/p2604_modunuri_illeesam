...
window.BoSyOrgSyUserMng = {
  name: 'bo-sy-org-syUserMng',
  props: {
  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      console.log(' ■■ BoSyOrgSyUserMng.js : handleBtnAction -> ', cmd, param);
      // 검색조건으로 목록 조회
    ...
    const handleSelectAction = (cmd, param = {}) => {
      console.log(' ■■ BoSyOrgSyUserMng.js : handleSelectAction -> ', cmd, param);
      // 페이지 크기 변경
    ...
    const handleGridCellAction = (cmd, colKey, row, e = {}) => {
      console.log(' ■■ BoSyOrgSyUserMng.js : handleGridCellAction -> ', cmd, colKey, row);
    ...
    const fnCallbackModal = (popCmd, param, result) => {
      console.log(' ■■ BoSyOrgSyUserMng : fnCallbackModal -> ', popCmd, param, result);
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['USER_STATUS_CD', 'USER_ROLE', 'USER_DATE_TYPE', 'DATE_RANGE_OPT'], {compNm: 'bo-sy-org-syUserMng'});
    ...
    const fnStatusBadge = s => coUtil.cofCodeBadge('USER_STATUS_CD', s, _USER_STATUS_FB[s] || 'badge-gray');
