...
(function (global) {
  ...
  boApiSvc.cmBlog = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/cm/blog/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/cm/blog/${_id}`, hdr(uiNm, cmdNm)); },
    setUse(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/cm/blog/${_id}/use`, body, hdr(uiNm, cmdNm)); },
  };

  /* ── cm: 채팅 ───────────────────────────────────────────────── */
  boApiSvc.cmChatt = {
    getPage(params, uiNm, cmdNm) { return global.boApi.get(   '/bo/ec/cm/chatt/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)    { return global.boApi.get(   `/bo/ec/cm/chatt/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)    { return global.boApi.post(  '/bo/ec/cm/chatt', body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)     { return global.boApi.delete(`/bo/ec/cm/chatt/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── cm: 공지사항 ───────────────────────────────────────────── */
  boApiSvc.cmNotice = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/cm/notice/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/cm/notice/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/cm/notice', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/cm/notice/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/cm/notice/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.dpArea = {
    ...
    update(_id, body, uiNm, cmdNm)   { return global.boApi.put(   `/bo/ec/dp/area/${_id}`, body, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.dpPanel = {
    ...
    getById(_id, uiNm, cmdNm)        { return global.boApi.get(   `/bo/ec/dp/panel/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)        { return global.boApi.post(  '/bo/ec/dp/panel', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm)   { return global.boApi.put(   `/bo/ec/dp/panel/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)         { return global.boApi.delete(`/bo/ec/dp/panel/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── dp: 전시위젯 ───────────────────────────────────────────── */
  boApiSvc.dpWidget = {
    getPage(params, uiNm, cmdNm) { return global.boApi.get(   '/bo/ec/dp/widget/page', { params, ...hdr(uiNm, cmdNm) }); },
    remove(_id, uiNm, cmdNm)     { return global.boApi.delete(`/bo/ec/dp/widget/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.dpUi = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/dp/ui/${_id}`, body, hdr(uiNm, cmdNm)); },
  };

  /* ── dp: 위젯라이브러리 ─────────────────────────────────────── */
  boApiSvc.dpWidgetLib = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/dp/widget-lib/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/dp/widget-lib/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/dp/widget-lib', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/dp/widget-lib/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/dp/widget-lib/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.mbMemGrade = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/mb/member-grade/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/mb/member-grade/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.mbMemGroup = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/mb/member-group/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/mb/member-group/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.mbMember = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/mb/member/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/mb/member', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/mb/member/${_id}`, body, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.odClaim = {
    ...
    getById(_id, uiNm, cmdNm)          { return global.boApi.get(   `/bo/ec/od/claim/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)          { return global.boApi.post(  '/bo/ec/od/claim', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm)     { return global.boApi.put(   `/bo/ec/od/claim/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)           { return global.boApi.delete(`/bo/ec/od/claim/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.odDliv = {
    ...
    getById(_id, uiNm, cmdNm)          { return global.boApi.get(   `/bo/ec/od/dliv/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)          { return global.boApi.post(  '/bo/ec/od/dliv', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm)     { return global.boApi.put(   `/bo/ec/od/dliv/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)           { return global.boApi.delete(`/bo/ec/od/dliv/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.odOrder = {
    ...
    getById(_id, uiNm, cmdNm)           { return global.boApi.get(   `/bo/ec/od/order/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)           { return global.boApi.post(  '/bo/ec/od/order', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm)      { return global.boApi.put(   `/bo/ec/od/order/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)            { return global.boApi.delete(`/bo/ec/od/order/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.pdBundle = {
    ...
    updateItems(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pd/prod-bundle/${_id}/items`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)            { return global.boApi.delete(`/bo/ec/pd/prod-bundle/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.pdCategory = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pd/category/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pd/category', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pd/category/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pd/category/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.pdDlivTmplt = {
    ...
    remove(_id, uiNm, cmdNm)     { return global.boApi.delete(`/bo/ec/pd/dliv-tmplt/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pd: 상품 ───────────────────────────────────────────────── */
  boApiSvc.pdProd = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pd/prod/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pd/prod/${_id}`, hdr(uiNm, cmdNm)); },
    getImages(_id, uiNm, cmdNm)    { return global.boApi.get(   `/bo/ec/pd/prod/${_id}/images`,   hdr(uiNm, cmdNm)); },
    getOpts(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pd/prod/${_id}/opts`,     hdr(uiNm, cmdNm)); },
    getSkus(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pd/prod/${_id}/skus`,     hdr(uiNm, cmdNm)); },
    getContents(_id, uiNm, cmdNm)  { return global.boApi.get(   `/bo/ec/pd/prod/${_id}/contents`, hdr(uiNm, cmdNm)); },
    getRels(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pd/prod/${_id}/rels`,     hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pd/prod', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pd/prod/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pd/prod/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.pdReview = {
    ...
    updateStatus(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pd/review/${_id}/status`, body, hdr(uiNm, cmdNm)); },
  };

  /* ── pd: 세트상품 ───────────────────────────────────────────── */
  boApiSvc.pdSet = {
    create(body, uiNm, cmdNm)           { return global.boApi.post(  '/bo/ec/pd/prod-set', body, hdr(uiNm, cmdNm)); },
    updateItems(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pd/prod-set/${_id}/items`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)            { return global.boApi.delete(`/bo/ec/pd/prod-set/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.pdTag = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pd/tag/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pd/tag/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.pmCache = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pm/cache/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/cache', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pm/cache/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pm/cache/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 쿠폰 ───────────────────────────────────────────────── */
  boApiSvc.pmCoupon = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pm/coupon/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pm/coupon/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/coupon', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pm/coupon/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pm/coupon/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.pmDiscnt = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pm/discnt/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/discnt', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pm/discnt/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pm/discnt/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 이벤트 ─────────────────────────────────────────────── */
  boApiSvc.pmEvent = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pm/event/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pm/event/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/event', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pm/event/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pm/event/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 사은품 ─────────────────────────────────────────────── */
  boApiSvc.pmGift = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pm/gift/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pm/gift/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/gift', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pm/gift/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pm/gift/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 기획전 ─────────────────────────────────────────────── */
  boApiSvc.pmPlan = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pm/plan/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pm/plan/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/plan', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pm/plan/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pm/plan/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 적립금 ─────────────────────────────────────────────── */
  boApiSvc.pmSave = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pm/save/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/ec/pm/save/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/save', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/pm/save/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/pm/save/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 바우처 ─────────────────────────────────────────────── */
  boApiSvc.pmVoucher = {
    getPage(params, uiNm, cmdNm)    { return global.boApi.get(   '/bo/ec/pm/voucher/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)       { return global.boApi.get(   `/bo/ec/pm/voucher/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)       { return global.boApi.post(  '/bo/ec/pm/voucher', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm)  { return global.boApi.put(   `/bo/ec/pm/voucher/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)        { return global.boApi.delete(`/bo/ec/pm/voucher/${_id}`, hdr(uiNm, cmdNm)); },
    sendSns(_id, body, uiNm, cmdNm) { return global.boApi.post(  `/bo/ec/pm/voucher/${_id}/send-sns`, body, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.stSettleConfig = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/st/config/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/st/config/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.stSettleAdj = {
    ...
    update(_id, body, uiNm, cmdNm)  { return global.boApi.put(   `/bo/ec/st/adj/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)        { return global.boApi.delete(`/bo/ec/st/adj/${_id}`, hdr(uiNm, cmdNm)); },
    approve(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/st/adj/${_id}/approve`, body, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.stSettleEtcAdj = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/st/etc-adj/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/ec/st/etc-adj/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── st: 정산지급 ───────────────────────────────────────────── */
  boApiSvc.stSettlePay = {
    getPage(params, uiNm, cmdNm) { return global.boApi.get(   '/base/ec/st/settle-pay/page', { params, ...hdr(uiNm, cmdNm) }); },
    pay(_id, body, uiNm, cmdNm)  { return global.boApi.put(   `/bo/ec/st/pay/${_id}/pay`, body, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.stSettleClose = {
    ...
    reopen(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/ec/st/close/${_id}/reopen`, body, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.stErp = {
    ...
    resend(_id, body, uiNm, cmdNm)    { return global.boApi.post(  `/bo/ec/st/erp/resend/${_id}`, body, hdr(uiNm, cmdNm)); },
    fixRecon(_id, body, uiNm, cmdNm)  { return global.boApi.put(   `/bo/ec/st/erp/recon/${_id}/fix`, body, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 알람 ───────────────────────────────────────────────── */
  boApiSvc.syAlarm = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/sy/alarm/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/alarm/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/alarm', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/alarm/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/alarm/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.syBbs = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/bbs/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/bbs', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/bbs/${_id}`, body, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 게시판모드(BBM) ────────────────────────────────────── */
  boApiSvc.syBbm = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/sy/bbm/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/bbm/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/bbm', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/bbm/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/bbm/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.syCode = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/code/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/code', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/code/${_id}`, body, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 문의(Contact) ──────────────────────────────────────── */
  boApiSvc.syContact = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/sy/contact/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/contact/${_id}`, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/contact/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/contact/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.syI18n = {
    ...
    getMsgs(_id, uiNm, cmdNm)          { return global.boApi.get(   `/bo/sy/i18n/${_id}/msgs`, hdr(uiNm, cmdNm)); },
    updateMsgs(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/i18n/${_id}/msgs`, body, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.syPath = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/path/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/path/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.syRole = {
    ...
    getMenus(_id, uiNm, cmdNm)        { return global.boApi.get(   `/bo/sy/role/${_id}/menus`, hdr(uiNm, cmdNm)); },
    getUsers(_id, uiNm, cmdNm)        { return global.boApi.get(   `/bo/sy/role/${_id}/users`, hdr(uiNm, cmdNm)); },
    saveMenus(_id, body, uiNm, cmdNm) { return global.boApi.post(  `/bo/sy/role/${_id}/menus`, body, hdr(uiNm, cmdNm)); },
    saveUsers(_id, body, uiNm, cmdNm) { return global.boApi.post(  `/bo/sy/role/${_id}/users`, body, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.sySite = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/site/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/site', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/site/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/site/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 템플릿 ─────────────────────────────────────────────── */
  boApiSvc.syTemplate = {
    getPage(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/sy/template/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/template/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/template', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/template/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/template/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.syUser = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/user/${_id}`, hdr(uiNm, cmdNm)); },
    getRoles(_id, uiNm, cmdNm)     { return global.boApi.get(   `/bo/sy/user/${_id}/roles`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/user', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/user/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/user/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.syVendor = {
    ...
    getById(_id, uiNm, cmdNm)      { return global.boApi.get(   `/bo/sy/vendor/${_id}`, hdr(uiNm, cmdNm)); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/sy/vendor', body, hdr(uiNm, cmdNm)); },
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/bo/sy/vendor/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/bo/sy/vendor/${_id}`, hdr(uiNm, cmdNm)); },
  };
  ...
  boApiSvc.syVendorUser = {
    ...
    update(_id, body, uiNm, cmdNm) { return global.boApi.put(   `/base/sy/vendor-user/${_id}`, body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return global.boApi.delete(`/base/sy/vendor-user/${_id}`, hdr(uiNm, cmdNm)); },
    addRole(body, uiNm, cmdNm)     { return global.boApi.post(  '/base/sy/vendor-user-role', body, hdr(uiNm, cmdNm)); },
    removeRole(_id, uiNm, cmdNm)   { return global.boApi.delete(`/base/sy/vendor-user-role/${_id}`, hdr(uiNm, cmdNm)); },
  };
