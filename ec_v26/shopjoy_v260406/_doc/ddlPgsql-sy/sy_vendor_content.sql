...
-- 코드값 참조
-- ============================================================
-- [CODES] sy_vendor_content.content_type_cd (콘텐츠유형) : VENDOR_CONTENT_TYPE: INTRO/POLICY/NOTICE
-- [CODES] sy_vendor_content.vendor_content_status_cd (상태) : VENDOR_CONTENT_STATUS: DRAFT/ACTIVE/INACTIVE
