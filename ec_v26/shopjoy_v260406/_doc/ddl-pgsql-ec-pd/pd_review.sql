...
COMMENT ON COLUMN pd_review.member_id       IS '회원ID (mb_mem.member_id)';
...
COMMENT ON COLUMN pd_review.reg_by          IS '등록자 (sy_user.user_id, mb_mem.member_id)';
COMMENT ON COLUMN pd_review.reg_date        IS '등록일';
COMMENT ON COLUMN pd_review.upd_by          IS '수정자 (sy_user.user_id, mb_mem.member_id)';
