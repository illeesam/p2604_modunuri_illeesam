...
-- ============================================================
CREATE TABLE od_pay_status_hist (
...
COMMENT ON TABLE od_pay_status_hist IS '결제 상태 이력 (결제 상태 변경만 추적)';
COMMENT ON COLUMN od_pay_status_hist.pay_status_hist_id    IS '결제상태이력ID (YYMMDDhhmmss+rand4)';
COMMENT ON COLUMN od_pay_status_hist.site_id               IS '사이트ID (sy_site.site_id)';
...
COMMENT ON COLUMN od_pay_status_hist.memo                  IS '메모';
COMMENT ON COLUMN od_pay_status_hist.reg_by                IS '등록자 (sy_user.user_id, mb_mem.member_id)';
COMMENT ON COLUMN od_pay_status_hist.reg_date              IS '등록일';
COMMENT ON COLUMN od_pay_status_hist.upd_by                IS '수정자 (sy_user.user_id, mb_mem.member_id)';
COMMENT ON COLUMN od_pay_status_hist.upd_date              IS '수정일';

CREATE INDEX idx_od_pay_status_hist_pay   ON od_pay_status_hist (pay_id);
CREATE INDEX idx_od_pay_status_hist_order ON od_pay_status_hist (order_id);
CREATE INDEX idx_od_pay_status_hist_date  ON od_pay_status_hist (chg_date);
