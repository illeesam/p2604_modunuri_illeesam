...
COMMENT ON COLUMN od_cart.sku_id       IS 'SKU ID (pd_prod_opt_sku.)';
COMMENT ON COLUMN od_cart.opt_id_1     IS '옵션1 값ID (pd_prod_opt., 예: 색상)';
COMMENT ON COLUMN od_cart.opt_id_2     IS '옵션2 값ID (pd_prod_opt., 예: 사이즈)';
COMMENT ON COLUMN od_cart.opt_nm_1     IS '옵션1명 스냅샷 (예: 블랙)';
COMMENT ON COLUMN od_cart.opt_nm_2     IS '옵션2명 스냅샷 (예: M)';
