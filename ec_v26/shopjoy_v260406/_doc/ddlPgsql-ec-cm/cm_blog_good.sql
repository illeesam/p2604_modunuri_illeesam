...
COMMENT ON COLUMN cm_blog_good.reg_by   IS '등록자 (sy_user.user_id, mb_member.member_id)';
COMMENT ON COLUMN cm_blog_good.upd_by   IS '수정자 (sy_user.user_id, mb_member.member_id)';
COMMENT ON COLUMN cm_blog_good.upd_date IS '수정일';
