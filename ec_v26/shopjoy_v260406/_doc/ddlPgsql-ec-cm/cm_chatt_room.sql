...
COMMENT ON COLUMN cm_chatt_room.reg_by               IS '등록자 (sy_user.user_id, mb_mem.member_id)';
COMMENT ON COLUMN cm_chatt_room.reg_date             IS '등록일';
COMMENT ON COLUMN cm_chatt_room.upd_by               IS '수정자 (sy_user.user_id, mb_mem.member_id)';
