...
| 파일 | 내용 |
|---|---|
| `cb.01.코바늘도안.md` | 목적/범위, 독립 모듈 아키텍처, 보기/편집 모드, 데이터 모델, 편집기 기능(격자/배색/재료/대표이미지), 상태 코드, 백엔드 구조, 제약사항, 향후 확장 로드맵 |

## 관련 테이블
`md_cb_pattern`, `md_cb_pattern_cell`, `md_cb_pattern_yarn`, `md_cb_symbol`, `md_cb_yarn`
