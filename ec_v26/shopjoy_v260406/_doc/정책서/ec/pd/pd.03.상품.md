...
| `prod_img_id` | 이미지ID |
| `prod_id` | 상품ID |
| `prod_opt1_id` | 옵션1 값ID (pd_prod_opt.prod_opt_id, NULL=공통) |
| `prod_opt2_id` | 옵션2 값ID (pd_prod_opt.prod_opt_id, NULL=옵션1 전체 공통) |
...
#### 이미지 범위 규칙
| prod_opt1_id | prod_opt2_id | 적용 범위 |
|---|---|---|
...
- pd_prod_img: 상품 이미지 (prod_opt1_id/2로 옵션 연동)
