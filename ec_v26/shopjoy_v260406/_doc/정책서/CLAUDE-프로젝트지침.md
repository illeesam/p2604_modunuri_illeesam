...
├─ lib/utils/foApiAxios.js + coUtil.js + foUtil.js + coEnvConsts.js + coExtSdk.js
...
├─ lib/utils/boApiAxios.js (window.boApi) + coUtil.js + boUtil.js + coEnvConsts.js + coExtSdk.js
