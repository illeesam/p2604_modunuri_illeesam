...
├─ lib/utils/foApiAxios.js + coUtil.js + foUtil.js + lib/env/foEnvConsts.js + coExtSdk.js
...
├─ lib/utils/boApiAxios.js (window.boApi) + coUtil.js + boUtil.js + lib/env/boEnvConsts.js + coExtSdk.js
...
| `window.boUtil` | `lib/utils/boUtil.js` | BO 공통 유틸 (`bofGetSiteNm`, `bofGetDateRange`, `bofGetPathLabel`, `bofBuildRoleTree` 등). `window.visibilityUtil`도 여기서 정의 |
...
| `window.coApiSvc` | `lib/services/coApiSvc.js` | FO·BO 공통 API (cmBoAppStore / cmFoAppStore / syCode / syPath / sySite) |
...
0. **표준 참조 모델** ⭐ (2026-05-28) — 신규 BO Mng/Dtl 작성 시 다음 두 파일 구조를 모델로 따른다.
   - [`pages/bo/ec/cm/CmNoticeMng.js`](pages/bo/ec/cm/CmNoticeMng.js) — BO Mng 표준 (cofGrid/cofDetail + 6섹션 [01]~[06] + cmd 라우팅)
