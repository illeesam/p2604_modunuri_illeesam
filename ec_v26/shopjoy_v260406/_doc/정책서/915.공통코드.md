...
| PAY_STATUS | PENDING, COMPLETED, FAILED, CANCELLED, REFUNDED | 결제상태 |
| ORDER_STATUS | PENDING, PAID, PREPARING, SHIPPED, COMPLETED | 주문상태 |
| DLIV_STATUS | READY, PICKED, IN_TRANSIT, DELIVERED | 배송상태 |
| CLAIM_STATUS | REQUESTED, APPROVED, IN_PICKUP, COMPLETED | 클레임상태 |
...
| COURIER | 01CJGLS, 02HANJIN, 04LOTTE, 05EMS, 06DAESIN | 택배사 |
| REFUND_METHOD | CARD, ACCOUNT, MOBILE | 환불수단 |
