...
COMMENT ON COLUMN cm_blog_file.upd_by   IS '수정자 (sy_user.user_id, mb_member.member_id)';
COMMENT ON COLUMN cm_blog_file.upd_date IS '수정일';
