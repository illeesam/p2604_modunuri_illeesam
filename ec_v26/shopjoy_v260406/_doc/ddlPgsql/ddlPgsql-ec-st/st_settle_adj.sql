...
CREATE TABLE st_settle_adj (
    ...
    aprv_status_cd      VARCHAR(20),                            -- 코드: SETTLE_ADJ_STATUS (대기/승인/반려)
    reg_by              VARCHAR(30),
...
COMMENT ON COLUMN st_settle_adj.aprv_status_cd  IS '승인상태 (코드: SETTLE_ADJ_STATUS — 대기/승인/반려)';
...
-- [CODES] st_settle_adj.aprv_status_cd    (승인상태) : SETTLE_ADJ_STATUS { 대기, 승인, 반려 }
