...
-- 코드값 참조
-- ============================================================
-- [CODES] st_settle_etc_adj.etc_adj_type_cd (기타조정유형) : SETTLE_ETC_ADJ_TYPE(SETTLE_ETC_ADJ_TYPE) { 코드값 미정의 }
-- [CODES] st_settle_etc_adj.etc_adj_dir_cd (가산/차감) : ADJ_DIR(ADJ_DIR) { 코드값 미정의 }
