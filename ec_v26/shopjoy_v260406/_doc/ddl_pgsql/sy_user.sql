...
COMMENT ON COLUMN sy_user_login_hist.site_id       IS '사이트ID (sy_site.site_id)';
...
COMMENT ON COLUMN sy_user_login_hist.reg_by        IS '등록자 (sy_user.user_id)';
COMMENT ON COLUMN sy_user_login_hist.reg_date      IS '등록일';
COMMENT ON COLUMN sy_user_login_hist.upd_by        IS '수정자 (sy_user.user_id)';
COMMENT ON COLUMN sy_user_login_hist.upd_date      IS '수정일';
