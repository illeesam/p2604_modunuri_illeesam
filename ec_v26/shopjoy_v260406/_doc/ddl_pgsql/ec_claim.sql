...
COMMENT ON COLUMN ec_claim.member_name    IS '회원명';
...
COMMENT ON COLUMN ec_claim.prod_name      IS '상품명';
...
COMMENT ON COLUMN ec_claim_item.prod_name     IS '상품명 (주문시점 스냅샷)';
...
COMMENT ON COLUMN ec_claim_item.reg_date      IS '등록일시';
...
COMMENT ON COLUMN ec_claim_hist.proc_by       IS '처리자';
