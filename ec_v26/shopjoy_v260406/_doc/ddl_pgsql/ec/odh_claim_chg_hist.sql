...
CREATE TABLE shopjoy_2604.odh_claim_chg_hist (
    claim_chg_hist_id VARCHAR(21)  NOT NULL CONSTRAINT odh_claim_chg_hist_pk_claim_chg_hist_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.odh_claim_chg_hist.reg_site_id IS '사이트ID';
...
CREATE INDEX odh_claim_chg_hist_ix03_claim_id ON shopjoy_2604.odh_claim_chg_hist USING btree (claim_id);
CREATE INDEX odh_claim_chg_hist_ix01_chg_date ON shopjoy_2604.odh_claim_chg_hist USING btree (chg_date);
CREATE INDEX odh_claim_chg_hist_ix02_chg_type_cd ON shopjoy_2604.odh_claim_chg_hist USING btree (chg_type_cd);
