...
CREATE TABLE shopjoy_2604.pdh_prod_chg_hist (
    prod_chg_hist_id VARCHAR(21)  NOT NULL CONSTRAINT pdh_prod_chg_hist_pk_prod_chg_hist_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pdh_prod_chg_hist.reg_site_id IS '사이트ID (sy_site.site_id)';
...
CREATE INDEX pdh_prod_chg_hist_ix01_prod_id ON shopjoy_2604.pdh_prod_chg_hist USING btree (prod_id);
