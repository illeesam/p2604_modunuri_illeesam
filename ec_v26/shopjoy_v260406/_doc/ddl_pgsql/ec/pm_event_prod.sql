...
CREATE INDEX idx_pm_event_prod_prod  ON shopjoy_2604.pm_event_prod USING btree (prod_id);
CREATE INDEX idx_pm_event_prod_site  ON shopjoy_2604.pm_event_prod USING btree (site_id);
CREATE INDEX idx_pm_event_prod_event ON shopjoy_2604.pm_event_prod USING btree (event_id);
