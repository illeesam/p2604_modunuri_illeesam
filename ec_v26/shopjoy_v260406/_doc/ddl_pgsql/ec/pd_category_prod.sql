...
CREATE TABLE shopjoy_2604.pd_category_prod (
    category_prod_id      VARCHAR(21)  NOT NULL CONSTRAINT pd_category_prod_pk_category_prod_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pd_category_prod.reg_site_id IS '사이트ID (sy_site.site_id)';
