...
CREATE TABLE shopjoy_2604.pd_restock_noti (
    restock_noti_id VARCHAR(21) NOT NULL CONSTRAINT pd_restock_noti_pk_restock_noti_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pd_restock_noti.reg_site_id IS '사이트ID (sy_site.site_id)';
COMMENT ON COLUMN shopjoy_2604.pd_restock_noti.prod_id IS '상품ID (pd_prod.prod_id)';
COMMENT ON COLUMN shopjoy_2604.pd_restock_noti.prod_sku_id IS 'SKU ID (pd_prod_sku.prod_sku_id)';
