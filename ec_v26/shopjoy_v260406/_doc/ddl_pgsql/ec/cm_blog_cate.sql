...
CREATE TABLE shopjoy_2604.cm_blog_cate (
    blog_cate_id        VARCHAR(21)  NOT NULL CONSTRAINT cm_blog_cate_pk_blog_cate_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.cm_blog_cate.reg_site_id IS '사이트ID (sy_site.site_id)';
...
CREATE INDEX cm_blog_cate_ix01_parent_blog_cate_id ON shopjoy_2604.cm_blog_cate USING btree (parent_blog_cate_id);
