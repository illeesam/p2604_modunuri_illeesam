...
CREATE TABLE shopjoy_2604.pm_save_prod (
    ...
    CONSTRAINT pm_save_prod_pk_save_id_prod_id_x2 PRIMARY KEY (save_id, prod_id)
);
...
CREATE INDEX pm_save_prod_ix_save ON shopjoy_2604.pm_save_prod USING btree (save_id);
