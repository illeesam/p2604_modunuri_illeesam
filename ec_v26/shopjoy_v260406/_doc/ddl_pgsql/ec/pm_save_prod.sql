...
CREATE INDEX idx_pm_save_prod_prod ON shopjoy_2604.pm_save_prod USING btree (prod_id);
CREATE INDEX idx_pm_save_prod_site ON shopjoy_2604.pm_save_prod USING btree (site_id);
CREATE INDEX idx_pm_save_prod_save ON shopjoy_2604.pm_save_prod USING btree (save_id);
