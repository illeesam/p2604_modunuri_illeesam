...
CREATE TABLE shopjoy_2604.pm_discnt_item (
    discnt_item_id VARCHAR(21) NOT NULL CONSTRAINT pm_discnt_item_pk_discnt_item_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pm_discnt_item.reg_site_id IS '사이트ID';
