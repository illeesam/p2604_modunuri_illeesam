...
CREATE TABLE shopjoy_2604.odh_dliv_status_hist (
    dliv_status_hist_id   VARCHAR(21)  NOT NULL CONSTRAINT odh_dliv_status_hist_pk_dliv_status_hist_id PRIMARY KEY,
    ...
    upd_by                VARCHAR(30) ,
    upd_date              TIMESTAMP   ,
    CONSTRAINT odh_dliv_status_hist_fk_dliv_id FOREIGN KEY (dliv_id) REFERENCES shopjoy_2604.od_dliv (dliv_id)
);
...
COMMENT ON COLUMN shopjoy_2604.odh_dliv_status_hist.reg_site_id IS '사이트ID (sy_site.site_id)';
...
CREATE INDEX odh_dliv_status_hist_ix01_chg_date ON shopjoy_2604.odh_dliv_status_hist USING btree (chg_date);
CREATE INDEX odh_dliv_status_hist_ix02_dliv_id ON shopjoy_2604.odh_dliv_status_hist USING btree (dliv_id);
CREATE INDEX odh_dliv_status_hist_ix03_order_id ON shopjoy_2604.odh_dliv_status_hist USING btree (order_id);
