...
COMMENT ON TABLE  ec_review_reply               IS '리뷰 댓글';
COMMENT ON COLUMN ec_review_reply.reply_id      IS '댓글ID';
...
COMMENT ON COLUMN ec_review_reply.upd_date      IS '수정일';
