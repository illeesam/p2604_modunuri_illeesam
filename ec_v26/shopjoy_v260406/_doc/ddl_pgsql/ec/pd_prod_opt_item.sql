-- [DEPRECATED 2026-07-12] pd_prod_opt_item 테이블 DDL
-- 이 테이블은 pd_prod_opt 으로 이름이 변경되었습니다.
-- 현재 DDL: pd_prod_opt.sql 참조
-- 마이그레이션: migration_20260712_pd_prod_opt_rename.sql
...
CREATE TABLE shopjoy_2604.pd_prod_opt_item (
    ...
    opt_item_val_code_id   VARCHAR(50) ,
