...
COMMENT ON TABLE  ec_prod_chg_hist              IS '상품 변경 이력';
COMMENT ON COLUMN ec_prod_chg_hist.prod_chg_hist_id IS '이력ID';
COMMENT ON COLUMN ec_prod_chg_hist.site_id      IS '사이트ID (sy_site.site_id)';
COMMENT ON COLUMN ec_prod_chg_hist.prod_id      IS '상품ID';
COMMENT ON COLUMN ec_prod_chg_hist.chg_type_cd  IS '변경유형코드 (PRICE/STOCK/STATUS)';
...
COMMENT ON COLUMN ec_prod_chg_hist.reg_by       IS '등록자 (sy_user.user_id, ec_member.member_id)';
COMMENT ON COLUMN ec_prod_chg_hist.reg_date     IS '등록일';
COMMENT ON COLUMN ec_prod_chg_hist.upd_by       IS '수정자 (sy_user.user_id, ec_member.member_id)';
COMMENT ON COLUMN ec_prod_chg_hist.upd_date     IS '수정일';
