...
COMMENT ON COLUMN ec_dliv.approval_amt       IS '결재 요청금액';
COMMENT ON COLUMN ec_dliv.approval_target_cd IS '결재대상 구분 (코드: APPROVAL_TARGET)';
COMMENT ON COLUMN ec_dliv.approval_target_nm IS '결재 대상명';
COMMENT ON COLUMN ec_dliv.approval_reason    IS '사유/메모';
COMMENT ON COLUMN ec_dliv.approval_req_user_id    IS '결재 요청자 (sy_user.user_id)';
COMMENT ON COLUMN ec_dliv.approval_req_date  IS '결재 요청일시';
COMMENT ON COLUMN ec_dliv.approval_aprv_user_id   IS '결재자 (sy_user.user_id)';
COMMENT ON COLUMN ec_dliv.approval_aprv_date IS '결재일시';
