...
CREATE TABLE shopjoy_2604.pd_prod_content (
    prod_content_id VARCHAR(21) NOT NULL CONSTRAINT pd_prod_content_pk_prod_content_id PRIMARY KEY,
...
CREATE INDEX pd_prod_content_ix01_prod_id ON shopjoy_2604.pd_prod_content USING btree (prod_id);
