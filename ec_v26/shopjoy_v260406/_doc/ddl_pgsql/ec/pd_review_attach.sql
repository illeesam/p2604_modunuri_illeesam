...
CREATE TABLE shopjoy_2604.pd_review_attach (
    review_attach_id VARCHAR(21)  NOT NULL CONSTRAINT pd_review_attach_pk_review_attach_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pd_review_attach.reg_site_id IS '사이트ID';
...
CREATE INDEX pd_review_attach_ix01_attach_id ON shopjoy_2604.pd_review_attach USING btree (attach_id);
CREATE INDEX pd_review_attach_ix02_review_id ON shopjoy_2604.pd_review_attach USING btree (review_id);
