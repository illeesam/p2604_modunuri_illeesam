...
CREATE INDEX pm_coupon_issue_ix01_coupon_id ON shopjoy_2604.pm_coupon_issue USING btree (coupon_id);
CREATE INDEX pm_coupon_issue_ix02_member_id ON shopjoy_2604.pm_coupon_issue USING btree (member_id);
CREATE INDEX pm_coupon_issue_ix03_order_id ON shopjoy_2604.pm_coupon_issue USING btree (order_id);
