...
CREATE TABLE ec_disp_panel (
    ...
    condition_type  VARCHAR(30),                            -- [DEPRECATED] ALL/GRADE/LOGIN — visibility_targets로 대체
...
COMMENT ON COLUMN ec_disp_panel.condition_type IS '[DEPRECATED] 노출조건 (ALL/GRADE/LOGIN) — visibility_targets로 대체';
