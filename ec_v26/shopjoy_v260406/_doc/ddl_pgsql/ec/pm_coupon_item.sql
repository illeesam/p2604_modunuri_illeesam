...
CREATE INDEX pm_coupon_item_ix_coupon ON shopjoy_2604.pm_coupon_item USING btree (coupon_id);
...
CREATE UNIQUE INDEX pm_coupon_item_uk_coupon_id_target_type_cd_x3 ON shopjoy_2604.pm_coupon_item USING btree (coupon_id, target_type_cd, target_id);
