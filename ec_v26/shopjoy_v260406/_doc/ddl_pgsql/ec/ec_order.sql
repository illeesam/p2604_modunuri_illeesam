...
COMMENT ON COLUMN ec_order.appr_reason    IS '사유/메모';
COMMENT ON COLUMN ec_order.appr_req_user_id    IS '결재 요청자 (sy_user.user_id)';
COMMENT ON COLUMN ec_order.appr_req_date  IS '결재 요청일시';
COMMENT ON COLUMN ec_order.appr_aprv_user_id   IS '결재자 (sy_user.user_id)';
COMMENT ON COLUMN ec_order.appr_aprv_date IS '결재일시';
