...
COMMENT ON COLUMN shopjoy_2604.dp_ui_area.disp_start_date IS '전시시작일';
COMMENT ON COLUMN shopjoy_2604.dp_ui_area.disp_start_time IS '전시시작시간';
COMMENT ON COLUMN shopjoy_2604.dp_ui_area.disp_end_date IS '전시종료일';
COMMENT ON COLUMN shopjoy_2604.dp_ui_area.disp_end_time IS '전시종료시간';
...
CREATE INDEX idx_dp_ui_area_disp_date ON shopjoy_2604.dp_ui_area USING btree (disp_start_date, disp_end_date);
