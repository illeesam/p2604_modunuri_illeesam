...
COMMENT ON COLUMN ec_disp_widget_lib.widget_type_cd IS '위젯유형 (코드: WIDGET_TYPE — BANNER/PRODUCT/CATEGORY/HTML/SLIDER)';
COMMENT ON COLUMN ec_disp_widget_lib.widget_lib_desc IS '위젯라이브러리설명';
