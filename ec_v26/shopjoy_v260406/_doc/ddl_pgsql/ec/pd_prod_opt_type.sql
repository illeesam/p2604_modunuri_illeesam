...
COMMENT ON COLUMN shopjoy_2604.pd_prod_opt_type.prod_opt_type_level1_cd IS '이 차원이 속한 1단 분류 코드 (코드: PROD_OPT_CATEGORY level=1 — COLOR/SIZE 등)';
COMMENT ON COLUMN shopjoy_2604.pd_prod_opt_type.prod_opt_type_level2_cd IS '이 차원이 속한 2단 분류 코드 (코드: PROD_OPT_CATEGORY level=2 — NULL 가능)';
