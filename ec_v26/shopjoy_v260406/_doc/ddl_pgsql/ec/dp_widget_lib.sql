...
COMMENT ON COLUMN shopjoy_2604.dp_widget_lib.widget_content IS '위젯내용 (HTML 에디터, 3개 테이블 통일)';
COMMENT ON COLUMN shopjoy_2604.dp_widget_lib.widget_config_json IS '위젯설정 (JSON, 3개 테이블 통일)';
