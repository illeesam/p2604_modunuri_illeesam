...
COMMENT ON COLUMN shopjoy_2604.odh_claim_status_hist.claim_status_cd IS '변경 후 클레임상태 (코드: CLAIM_STATUS)';
COMMENT ON COLUMN shopjoy_2604.odh_claim_status_hist.status_reason IS '상태 변경 사유';
COMMENT ON COLUMN shopjoy_2604.odh_claim_status_hist.chg_user_id IS '변경 담당자 (sy_user.user_id, mb_member.member_id)';
COMMENT ON COLUMN shopjoy_2604.odh_claim_status_hist.chg_date IS '변경 일시';
COMMENT ON COLUMN shopjoy_2604.odh_claim_status_hist.memo IS '메모';
COMMENT ON COLUMN shopjoy_2604.odh_claim_status_hist.reg_by IS '등록자 (sy_user.user_id, mb_member.member_id)';
COMMENT ON COLUMN shopjoy_2604.odh_claim_status_hist.reg_date IS '등록일';
