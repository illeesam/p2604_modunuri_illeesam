...
CREATE TABLE shopjoy_2604.mb_member_group (
    member_group_id VARCHAR(21)  NOT NULL CONSTRAINT mb_member_group_pk_member_group_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.mb_member_group.reg_site_id IS '사이트ID (sy_site.site_id)';
