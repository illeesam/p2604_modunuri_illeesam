...
CREATE TABLE shopjoy_2604.mbh_member_token_log (
    log_id           VARCHAR(21)   NOT NULL CONSTRAINT mbh_member_token_log_pk_log_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.mbh_member_token_log.reg_site_id IS '사이트ID (sy_site.site_id)';
...
CREATE INDEX mbh_member_token_log_ix01_action_cd ON shopjoy_2604.mbh_member_token_log USING btree (action_cd);
CREATE INDEX mbh_member_token_log_ix05_reg_date ON shopjoy_2604.mbh_member_token_log USING btree (reg_date);
CREATE INDEX mbh_member_token_log_ix03_login_log_id ON shopjoy_2604.mbh_member_token_log USING btree (login_log_id);
CREATE INDEX mbh_member_token_log_ix04_member_id ON shopjoy_2604.mbh_member_token_log USING btree (member_id);
CREATE INDEX mbh_member_token_log_ix02_auth_id ON shopjoy_2604.mbh_member_token_log USING btree (auth_id);
CREATE INDEX mbh_member_token_log_ix06_trace_id ON shopjoy_2604.mbh_member_token_log USING btree (trace_id);
