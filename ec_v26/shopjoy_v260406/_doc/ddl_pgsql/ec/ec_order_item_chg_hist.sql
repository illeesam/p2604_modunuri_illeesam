...
-- ============================================================
CREATE TABLE ec_order_item_chg_hist (
...
COMMENT ON TABLE  ec_order_item_chg_hist                         IS '주문 품목 변경 이력';
COMMENT ON COLUMN ec_order_item_chg_hist.order_item_chg_hist_id  IS '이력ID';
...
COMMENT ON COLUMN ec_order_item_chg_hist.chg_reason              IS '변경사유';
COMMENT ON COLUMN ec_order_item_chg_hist.chg_user_id                  IS '처리자 (sy_user.user_id)';
COMMENT ON COLUMN ec_order_item_chg_hist.chg_date                IS '처리일시';
COMMENT ON COLUMN ec_order_item_chg_hist.reg_by                  IS '등록자';
COMMENT ON COLUMN ec_order_item_chg_hist.reg_date                IS '등록일';
COMMENT ON COLUMN ec_order_item_chg_hist.upd_by                  IS '수정자';
COMMENT ON COLUMN ec_order_item_chg_hist.upd_date                IS '수정일';
