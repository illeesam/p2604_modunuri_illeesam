...
CREATE TABLE shopjoy_2604.pd_prod_opt (
    prod_opt_id             VARCHAR(21)  NOT NULL CONSTRAINT pd_prod_opt_pk_prod_opt_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pd_prod_opt.reg_site_id IS '사이트ID (sy_site.site_id)';
