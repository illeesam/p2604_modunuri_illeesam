...
CREATE TABLE shopjoy_2604.pdh_prod_sku_chg_hist (
    hist_id     VARCHAR(21)  NOT NULL CONSTRAINT pdh_prod_sku_chg_hist_pk_hist_id PRIMARY KEY,
...
COMMENT ON COLUMN shopjoy_2604.pdh_prod_sku_chg_hist.reg_site_id IS '사이트ID (sy_site.site_id)';
COMMENT ON COLUMN shopjoy_2604.pdh_prod_sku_chg_hist.prod_sku_id IS 'SKU ID (pd_prod_sku.prod_sku_id)';
...
CREATE INDEX pdh_prod_sku_chg_hist_ix01_prod_id ON shopjoy_2604.pdh_prod_sku_chg_hist USING btree (prod_id);
CREATE INDEX pdh_prod_sku_chg_hist_ix02_prod_sku_id ON shopjoy_2604.pdh_prod_sku_chg_hist USING btree (prod_sku_id);
