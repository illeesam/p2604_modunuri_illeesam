...
COMMENT ON COLUMN sy_batch_hist.reg_by        IS '등록자 (sy_user.user_id, ec_member.member_id)';
COMMENT ON COLUMN sy_batch_hist.reg_date      IS '등록일';
COMMENT ON COLUMN sy_batch_hist.upd_by        IS '수정자 (sy_user.user_id, ec_member.member_id)';
