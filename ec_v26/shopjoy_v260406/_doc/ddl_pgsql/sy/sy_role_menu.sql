...
COMMENT ON COLUMN sy_role.reg_by           IS '등록자 (sy_user.user_id)';
COMMENT ON COLUMN sy_role.reg_date         IS '등록일';
COMMENT ON COLUMN sy_role.upd_by           IS '수정자 (sy_user.user_id)';
...
COMMENT ON COLUMN sy_role_menu.reg_by       IS '등록자 (sy_user.user_id)';
COMMENT ON COLUMN sy_role_menu.reg_date     IS '등록일';
COMMENT ON COLUMN sy_role_menu.upd_by       IS '수정자 (sy_user.user_id)';
