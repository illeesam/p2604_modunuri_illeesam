...
COMMENT ON COLUMN sy_vendor_content.title             IS '제목';
COMMENT ON COLUMN sy_vendor_content.subtitle          IS '부제';
...
COMMENT ON COLUMN sy_vendor_content.status_cd         IS '상태 (코드: VENDOR_CONTENT_STATUS)';
...
CREATE INDEX idx_sy_vendor_content_status ON sy_vendor_content (status_cd);
