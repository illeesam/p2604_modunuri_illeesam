...
CREATE TABLE shopjoy_2604.sy_attach_grp (
    attach_grp_id     VARCHAR(21)  NOT NULL CONSTRAINT sy_attach_grp_pk_attach_grp_id PRIMARY KEY,
    ...
    CONSTRAINT sy_attach_grp_uk_attach_grp_code UNIQUE (attach_grp_code)
);
...
CREATE INDEX sy_attach_grp_ix01_attach_grp_code ON shopjoy_2604.sy_attach_grp USING btree (attach_grp_code);
CREATE INDEX sy_attach_grp_ix02_reg_date ON shopjoy_2604.sy_attach_grp USING btree (reg_date);
CREATE INDEX sy_attach_grp_ix03_use_yn ON shopjoy_2604.sy_attach_grp USING btree (use_yn);
