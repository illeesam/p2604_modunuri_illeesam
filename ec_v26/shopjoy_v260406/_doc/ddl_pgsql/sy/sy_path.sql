...
CREATE TABLE shopjoy_2604.sy_path (
    path_id        VARCHAR(21)  NOT NULL DEFAULT nextval('sy_path_path_id_seq'::regclass) CONSTRAINT sy_path_pk_path_id PRIMARY KEY,
...
CREATE INDEX sy_path_ix01_biz_cd ON shopjoy_2604.sy_path USING btree (biz_cd);
CREATE INDEX sy_path_ix02_parent_path_id ON shopjoy_2604.sy_path USING btree (parent_path_id);
