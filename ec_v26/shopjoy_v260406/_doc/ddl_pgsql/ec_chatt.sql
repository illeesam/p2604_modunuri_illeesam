...
COMMENT ON COLUMN ec_chatt.reg_by        IS '등록자 (sy_user.user_id)';
COMMENT ON COLUMN ec_chatt.reg_date      IS '등록일';
COMMENT ON COLUMN ec_chatt.upd_by        IS '수정자 (sy_user.user_id)';
...
COMMENT ON COLUMN ec_chatt_msg.reg_by    IS '등록자 (sy_user.user_id)';
COMMENT ON COLUMN ec_chatt_msg.reg_date  IS '등록일';
COMMENT ON COLUMN ec_chatt_msg.upd_by    IS '수정자 (sy_user.user_id)';
COMMENT ON COLUMN ec_chatt_msg.upd_date  IS '수정일';
