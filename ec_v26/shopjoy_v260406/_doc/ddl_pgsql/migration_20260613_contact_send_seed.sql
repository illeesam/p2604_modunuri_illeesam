...
SELECT 'CD001076','SITE000001','MSG_CHANNEL','EMAIL','이메일',1,'Y',NULL,NULL,NULL,'SYSTEM',CURRENT_TIMESTAMP,NULL,NULL
WHERE NOT EXISTS (SELECT 1 FROM shopjoy_2604.sy_code WHERE code_grp='MSG_CHANNEL' AND code_value='EMAIL' AND site_id='SITE000001');
INSERT INTO shopjoy_2604.sy_code (code_id,site_id,code_grp,code_value,code_label,sort_ord,use_yn,parent_code_value,child_code_values,code_remark,reg_by,reg_date,upd_by,upd_date)
SELECT 'CD001077','SITE000001','MSG_CHANNEL','SMS','SMS',2,'Y',NULL,NULL,NULL,'SYSTEM',CURRENT_TIMESTAMP,NULL,NULL
WHERE NOT EXISTS (SELECT 1 FROM shopjoy_2604.sy_code WHERE code_grp='MSG_CHANNEL' AND code_value='SMS' AND site_id='SITE000001');
INSERT INTO shopjoy_2604.sy_code (code_id,site_id,code_grp,code_value,code_label,sort_ord,use_yn,parent_code_value,child_code_values,code_remark,reg_by,reg_date,upd_by,upd_date)
SELECT 'CD001078','SITE000001','MSG_CHANNEL','KAKAO','알림톡',3,'Y',NULL,NULL,'카카오 알림톡','SYSTEM',CURRENT_TIMESTAMP,NULL,NULL
WHERE NOT EXISTS (SELECT 1 FROM shopjoy_2604.sy_code WHERE code_grp='MSG_CHANNEL' AND code_value='KAKAO' AND site_id='SITE000001');
INSERT INTO shopjoy_2604.sy_code (code_id,site_id,code_grp,code_value,code_label,sort_ord,use_yn,parent_code_value,child_code_values,code_remark,reg_by,reg_date,upd_by,upd_date)
SELECT 'CD001079','SITE000001','MSG_CHANNEL','PUSH','푸시',4,'Y',NULL,NULL,'앱 푸시 알림','SYSTEM',CURRENT_TIMESTAMP,NULL,NULL
WHERE NOT EXISTS (SELECT 1 FROM shopjoy_2604.sy_code WHERE code_grp='MSG_CHANNEL' AND code_value='PUSH' AND site_id='SITE000001');
...
SELECT 'TP000129','SITE000001','EMAIL','CONTACT_RECEIVED_MAIL','문의접수 완료 메일','[ShopJoy] 문의가 정상 접수되었습니다',
...
WHERE NOT EXISTS (SELECT 1 FROM shopjoy_2604.sy_template WHERE template_code='CONTACT_RECEIVED_MAIL' AND site_id='SITE000001');
INSERT INTO shopjoy_2604.sy_template (template_id,site_id,template_type_cd,template_code,template_nm,template_subject,template_content,sample_params,use_yn,reg_by,reg_date,upd_by,upd_date,path_id)
SELECT 'TP000130','SITE000001','KAKAO','CONTACT_RECEIVED_KAKAO','문의접수 완료 알림톡','문의접수 완료',
...
WHERE NOT EXISTS (SELECT 1 FROM shopjoy_2604.sy_template WHERE template_code='CONTACT_RECEIVED_KAKAO' AND site_id='SITE000001');
INSERT INTO shopjoy_2604.sy_template (template_id,site_id,template_type_cd,template_code,template_nm,template_subject,template_content,sample_params,use_yn,reg_by,reg_date,upd_by,upd_date,path_id)
SELECT 'TP000131','SITE000001','EMAIL','CONTACT_RECEIVED_ALARM','문의접수 시스템알림','신규 문의 접수',
...
WHERE NOT EXISTS (SELECT 1 FROM shopjoy_2604.sy_template WHERE template_code='CONTACT_RECEIVED_ALARM' AND site_id='SITE000001');
