...
COMMENT ON COLUMN pdh_prod_content_chg_hist.reg_by        IS '등록자 (sy_user.user_id, mb_mem.member_id)';
COMMENT ON COLUMN pdh_prod_content_chg_hist.reg_date      IS '등록일';
COMMENT ON COLUMN pdh_prod_content_chg_hist.upd_by        IS '수정자 (sy_user.user_id, mb_mem.member_id)';
