...
COMMENT ON TABLE pd_prod_opt_grp IS '상품 옵션 그룹 (색상+사이즈 같은 옵션 조합)';
COMMENT ON COLUMN pd_prod_opt_grp.opt_grp_id  IS '옵션그룹ID';
COMMENT ON COLUMN pd_prod_opt_grp.site_id     IS '사이트ID (sy_site.site_id)';
