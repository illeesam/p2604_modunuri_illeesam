...
--
-- DDL 기준:
--   sy_code_grp : code_grp_id, reg_site_id, code_grp, grp_nm, path_id, code_grp_desc, use_yn, reg_by, reg_date, upd_by, upd_date
--   sy_code     : code_id, reg_site_id, code_grp, code_value, code_label, sort_ord, use_yn, parent_code_value, child_code_values, code_remark, code_level, reg_by, reg_date, upd_by, upd_date
--                 (code_level int4 추가됨)
-- ────────────────────────────────────────────────────────────
-- sy_code_grp :   1건
...
INSERT INTO shopjoy_2604.sy_code_grp
  (code_grp_id, reg_site_id, code_grp, grp_nm, path_id, code_grp_desc, use_yn, reg_by, reg_date, upd_by, upd_date)
VALUES
...
INSERT INTO shopjoy_2604.sy_code (code_id, reg_site_id, code_grp, code_value, code_label, sort_ord, use_yn, parent_code_value, child_code_values, code_remark, code_level, reg_by, reg_date, upd_by, upd_date)
