...
-- 위젯 라이브러리
INSERT INTO ec_disp_widget_lib (widget_lib_id, widget_code, widget_name, widget_type, description, is_system, sort_ord, use_yn, reg_date) VALUES
...
-- 디스플레이 패널
INSERT INTO ec_disp_panel (disp_panel_id, area_code, panel_name, widget_type, disp_type, click_action, click_target, condition_type, auth_required, sort_ord, status, reg_date) VALUES
