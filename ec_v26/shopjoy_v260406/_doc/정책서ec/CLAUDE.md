...
| 파일 | 내용 |
|---|---|
| `mb.01.회원.md` | 고객 회원 관리, 상태(ACTIVE/DORMANT/SUSPENDED/WITHDRAWN) |
| `pd.01.카테고리.md` | 3단계 계층(대/중/소) 카테고리 |
| `pd.02.상품.md` | 상품 정보, 가격, 재고, 옵션(1/2단) |
| `od.01.주문.md` | 주문 상태, 부분배송 정책 |
| `od.02.결제.md` | 6가지 결제수단 통합 관리 |
| `od.03.배송.md` | 출고/입고 배송, 택배사, 송장 |
...
| `pm.04.프로모션할인.md` | 상품 할인 마스터/대상 |
| `pm.05.프로모션사은품.md` | 사은품 조건, 지급 |
| `pm.06.프로모션상품권.md` | 상품권 발행, 사용 |
| `pm.07.프로모션기획전.md` | 기획전 구성, 상품 배치 |
| `pm.08.프로모션이벤트.md` | 이벤트 혜택 관리 |
| `dp.01.전시.md` | 전시 계층 구조 개요 |
| `dp.02.전시Ui.md` | UI 레이아웃, 영역 구성 |
| `dp.03.전시Area.md` | 영역 마스터, 패널 배치 |
| `dp.04.전시Panel.md` | 패널, 위젯 배치 |
| `dp.05.전시Widget.md` | 위젯 인스턴스, 타입별 속성 |
| `dp.06.전시WidgetLib.md` | 위젯 라이브러리, 재사용 |
| `st.01.정산마감.md` | 월별 정산액 계산, 수수료, 마감 |
| `st.02.정산처리.md` | 지급 요청, 확인, 이의신청 |
