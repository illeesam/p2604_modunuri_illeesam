...
-- 코드값 참조
-- ============================================================
-- [CODES] dp_widget.widget_type_cd (위젯유형) : WIDGET_TYPE: image_banner/product_slider/product/cond_product/chart_bar/chart_line/chart_pie/text_banner/info_card/popup/file/file_list/coupon/html_editor/event_banner/cache_banner/widget_embed/barcode/countdown/markdown/video_player/map_widget
