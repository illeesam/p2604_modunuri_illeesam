      ...
      <table style="width: 100%; border-collapse: collapse;">
        <thead>
          <tr style="background: #fafafa; border-bottom: 1px solid #e5e7eb;">
            ...
            <th style="width: 65%; text-align: left; padding: 12px 16px; font-weight: 600; font-size: 13px; color: #666;">Value</th>
            <th style="width: 10%; text-align: center; padding: 12px 16px; font-weight: 600; font-size: 13px; color: #666;">작업</th>
          </tr>
        </thead>
        <tbody>
