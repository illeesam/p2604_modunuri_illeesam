  ...
  setup(props) {
    ...
    const posts = ref([
      { id: 1, title: 'Anteposuerit litterarum formas.', category: 'fashion', author: '김민지', date: '2026.04.10', readTime: '5분',
        ...
        thumb: '', tags: ['패션', '신상품', '코튼100%'], viewCount: 1240, commentCount: 8 },
      { id: 2, title: '2026 봄 트렌드 컬러 가이드', category: 'trend', author: '이수진', date: '2026.04.08', readTime: '7분',
        ...
        thumb: '', tags: ['트렌드', '컬러', '2026SS'], viewCount: 890, commentCount: 5 },
      { id: 3, title: '미니멀 라이프를 위한 옷장 정리법', category: 'lifestyle', author: '박지현', date: '2026.04.05', readTime: '4분',
        ...
        thumb: '', tags: ['미니멀', '정리', '캡슐워드로브'], viewCount: 2100, commentCount: 15 },
      { id: 4, title: '데님 스타일링 A to Z', category: 'howto', author: '정다운', date: '2026.04.03', readTime: '6분',
        ...
        thumb: '', tags: ['데님', '스타일링', '가이드'], viewCount: 1560, commentCount: 12 },
      { id: 5, title: '지속 가능한 패션의 시작', category: 'lifestyle', author: '최예린', date: '2026.03.28', readTime: '8분',
        ...
        thumb: '', tags: ['지속가능', '친환경', '윤리패션'], viewCount: 780, commentCount: 3 },
      { id: 6, title: '봄 아우터 베스트 5', category: 'fashion', author: '강하늘', date: '2026.03.25', readTime: '5분',
        ...
        thumb: '', tags: ['아우터', '추천', '봄패션'], viewCount: 1890, commentCount: 9 },
    ]);
  ...
  <div style="display:grid;grid-template-columns:220px 1fr;gap:32px;" class="blog-grid">
    ...
    <aside>
      ...
      <div>
        ...
        <div v-for="p in latestPosts" :key="p.id" @click="navigate('blogView', { editId: p.id })"
          ...
          <div :style="{ width:'50px', height:'50px', borderRadius:'6px', background: postBg(p.id), flexShrink:0 }"></div>
    ...
    <div>
      <div v-for="post in filteredPosts" :key="post.id"
        ...
        <!-- 썸네일 -->
        <div :style="{ width:'280px', minHeight:'200px', background: postBg(post.id), flexShrink:0, display:'flex', alignItems:'center', justifyContent:'center' }">
