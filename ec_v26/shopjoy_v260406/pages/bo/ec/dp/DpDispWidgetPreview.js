    ...
    <div class="card" style="flex:1;display:flex;flex-direction:column;overflow:hidden;background:#f0f2f5;min-width:0;padding:0;">
      ...
      <div v-else style="flex:1;overflow:auto;padding:16px;">
        <div
          ...
          <!-- 빈 상태 -->
          <div v-if="!dashItems.length v-if="!dashItems.length && !dashDragOverv-if="!dashItems.length && !dashDragOver !uiState.dashDragOver"
          ...
          <div v-if="uiState.dashDragOver v-if="dashDragOver && !dashItemsv-if="dashDragOver && !dashItems !dashItems.length"
