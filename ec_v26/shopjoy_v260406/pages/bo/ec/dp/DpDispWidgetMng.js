  ...
  setup(props) {
    ...
    const handleSearchData = async () => {
      ...
      try {
        ...
        baseGrid.pager.pageTotalCount = dW?.pageTotalCount || 0;
        baseGrid.pager.pageTotalPage  = dW?.pageTotalPage  || 1;
        /* 결과에 반영된 조건 기록 */
  ...
  <div style="display:flex;gap:12px;align-items:flex-start;">
    ...
    <div class="card" style="width:240px;min-width:180px;flex-shrink:0;padding:12px;max-height:calc(100vh - 260px);overflow-y:auto;">
      ...
      <div style="max-height:65vh;overflow:auto;">
        <bo-path-tree biz-cd="ec_disp_widget" :selected="uiState.selectedPath" @select="path => handleSelectAction('pathTree-select', path)" />
      </div>
    </div>
    <!-- ===== □.□. 좌측 표시경로 =============================================== -->
    <!-- ===== ■.■. 우측 목록 ================================================= -->
    <div style="flex:1;min-width:0;width:100%;">
      <!-- ===== ■.■.■. 목록 ================================================== -->
      <bo-grid :columns="listGridColumns" :rows="widgets" :pager="baseGrid.pager" row-key="widgetId"
        :sort-state="baseGrid" list-title="전시위젯" :row-style="fnRowStyle"
