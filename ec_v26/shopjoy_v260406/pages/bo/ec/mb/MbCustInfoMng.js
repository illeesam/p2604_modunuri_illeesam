    ...
    const handleSearchData = async (searchType = 'DEFAULT') => {
      ...
      try {
        const [resCust, resLogin, resCoupon, resSend] = await Promise.all([
          window.boApi.get('/bo/ec/mb/cust-info/page', { params: { pageNo: 1, pageSize: 10000 }, ...apiHdr('고객종합정보', '조회') }),
          window.boApi.get('/bo/sy/user/login-hist/page', { params: { pageNo: 1, pageSize: 10000 }, ...apiHdr('고객종합정보', '조회') }),
          window.boApi.get('/bo/ec/pm/coupon-usage/page', { params: { pageNo: 1, pageSize: 10000 }, ...apiHdr('고객종합정보', '조회') }),
          window.boApi.get('/bo/sy/alarm/page', { params: { pageNo: 1, pageSize: 10000 }, ...apiHdr('고객종합정보', '조회') }),
        ]);
