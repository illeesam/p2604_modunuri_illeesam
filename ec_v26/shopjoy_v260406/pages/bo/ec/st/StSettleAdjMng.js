...
const uiState = reactive({ descOpen: false, error: null, isPageCodeLoad: false, dateRange: '이번달', dateStart: '', dateEnd: '', selectedId: null, isNew: false});
  ...
  const searchParam = reactive(_initSearchParam());
    ...
    // -- return ---------------------------------------------------------------
      ...
      { key: 'type', type: 'select', options: () => codes.codes.settle_adj_types, nullLabel: '유형 전체' },
    ...
    return { uiState, codes, handleDateRangeChange, pager, adjList, baseSearchColumns, baseGridColumns, cfVendors, form, errors, openNew, openEdit, closeForm, handleSave, handleDelete, doApprove, fnAprvBadge, fnTypeBadge, fmtW, onSearch, onReset, searchParam, setPage, onSizeChange };
  },
  template: /* html */`
<div>
