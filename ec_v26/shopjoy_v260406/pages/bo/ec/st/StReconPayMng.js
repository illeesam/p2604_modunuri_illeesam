...
const uiState = reactive({ descOpen: false, error: null, isPageCodeLoad: false, dateRange: '이번달', dateStart: '', dateEnd: ''});
    ...
    const handleFetchData = async () => {
      try {
        const res = await window.boApi.get('/bo/ec/st/recon/pay/page', {
          params: {
    ...
    return { uiState, handleDateRangeChange, DATE_RANGE_OPTIONS, pager, rows, cfPageNums, cfSummary, fnDiffBadge, fnPayBadge, fmtW, onSearch, onReset, searchParam, pager.pageSizes, setPage, onSizeChange };
  },
  template: /* html */`
<div>
