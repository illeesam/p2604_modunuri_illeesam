...
window.CmChattMng = {
  ...
  setup(props) {
    ...
    return {
      ...
      pager, PAGE_SIZES, cfPageNums, fnStatusBadge,
...
<div>
  ...
  <div class="card">
    <div class="toolbar">
      <span class="list-title"><span style="color:#e8587a;font-size:8px;margin-right:5px;vertical-align:middle;">●</span>채팅목록 <span class="list-count">{{ pager.total }}건</span></span>
