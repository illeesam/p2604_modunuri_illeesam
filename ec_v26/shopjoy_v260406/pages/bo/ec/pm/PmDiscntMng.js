  ...
  setup(props) {
    ...
    const handleGridCellAction = (cmd, colKey, row, e = {}) => {
      ...
      if (cmd === 'discnts-cellClick') {
        ...
        if (colKey === 'btn_row_edit')   { return handleLoadDetail(row.discntId); }
    ...
    const fnLoadCodes = async () => {
      ...
      await codeStore.saLoadCodes(['DISCOUNT_TYPE', 'DISCNT_STATUS', 'DISCNT_TYPE', 'PROMO_STATUS', 'DATE_RANGE_OPT'], {compNm: 'PmDiscntMng'});
      try {
        codes.discount_types = codeStore.sgGetGrpCodes('DISCOUNT_TYPE');
        codes.discount_statuses = codeStore.sgGetGrpCodes('DISCNT_STATUS');
