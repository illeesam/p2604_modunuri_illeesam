...
window.SyI18nMng = {
  ...
  setup(props) {
    ...
    const handleFetchData = async () => {
      try {
        const [resKeys, resMsgs] = await Promise.all([
          ...
          window.boApi.get('/bo/sy/i18n-msg/page', { params: { pageNo: 1, pageSize: 10000 } }),
        ]);
    ...
    const saveMsgs = async () => {
      ...
      try {
        const res = await window.boApi.put(`/bo/sy/i18n/${cfSelectedKey.value.i18nId}/msgs`, { msgs: { ...msgForm } });
