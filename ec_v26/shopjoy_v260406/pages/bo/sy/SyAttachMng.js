    ...
    const handleSearchData = async (searchType = 'DEFAULT') => {
      ...
      try {
        const [attachRes, grpRes] = await Promise.all([
          boApi.get('/bo/sy/attach/page', { params: { pageNo: 1, pageSize: 10000 }, ...coUtil.apiHdr('첨부파일관리', '조회') }),
          boApi.get('/base/sy/attach-grp/page', { params: { pageNo: 1, pageSize: 10000 }, ...coUtil.apiHdr('첨부파일관리', '조회') }),
        ]);
