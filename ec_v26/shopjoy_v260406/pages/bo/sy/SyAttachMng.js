    ...
    const handleSearchData = async (searchType = 'DEFAULT') => {
      ...
      try {
        const [attachRes, grpRes] = await Promise.all([
          boApi.get('/bo/sy/attach/page', { params: { pageNo: 1, pageSize: 10000 }, headers: { 'X-UI-Nm': '첨부파일관리', 'X-Cmd-Nm': '조회' } }),
          boApi.get('/bo/sy/attach-grp/page', { params: { pageNo: 1, pageSize: 10000 }, headers: { 'X-UI-Nm': '첨부파일관리', 'X-Cmd-Nm': '조회' } }),
        ]);
