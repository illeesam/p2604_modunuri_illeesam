...
<bo-page title="알림관리">
  ...
  <!-- ===== ■. 표시경로 선택 모달 ========================================== -->
  <bo-pick-modal v-if="pathPickModal ? (pathPickModal.show) : false" popup-code="path" result-type="id" :init-param="{ bizCd: 'sy_alarm' }" modal-name="path-pick" :on-callback="fnCallbackModal" />
</bo-page>
`,
};
