...
window.ZdTestSnsLoginKakao = {
  ...
  setup(props) {
    ...
    onMounted(async () => {
      try {
        const ymlRes = await boApi.get('/bo/sy/app-config/social', coUtil.apiHdr('카카오 소셜 로그인 테스트', 'yml 조회'));
    ...
    return { cfg, result, uiState, handleBtnAction, ymlRows, ymlGridColumns, syPropRows, syPropGridColumns };
  },
