...
<div>
  ...
  <div class="card">
    ...
    <div class="form-actions">
      ...
      <button class="btn btn-secondary" @click="navigate('claimMng')">취소</button>
    </div>
        ...
        <template v-if="relatedOrder">
          <div style="margin-bottom:12px;padding:14px;background:#f9f9f9;border-radius:8px;border:1px solid #e8e8e8;">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;">
              ...
              <button class="btn btn-blue btn-sm" @click="navigate('orderDtl',{id:relatedOrder.orderId})">주문 수정</button>
            </div>
          </div>
          <template v-if="relatedDliv">
            <div style="padding:12px 14px;background:#f0f7ff;border-radius:8px;border:1px solid #bae0ff;font-size:13px;">
              ...
              <button class="btn btn-secondary btn-sm" style="margin-top:8px;" @click="navigate('dlivDtl',{id:relatedDliv.dlivId})">배송 수정</button>
            </div>
          </template>
        </template>
