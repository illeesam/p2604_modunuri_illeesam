...
<div>
  ...
  <div class="card">
    <div class="search-bar">
      <input v-model="searchKw" placeholder="클레임ID / 회원명 / 상품명 검색" @keyup.enter="onSearch" />
      <select v-model="searchType" @change="onSearch"><option value="">유형 전체</option><option>취소</option><option>반품</option><option>교환</option></select>
