...
window.ContactMng = {
  ...
  setup(props) {
    ...
    const exportExcel = () => window.adminUtil.exportCsv(filtered.value, [{label:'ID',key:'inquiryId'},{label:'회원명',key:'userName'},{label:'분류',key:'category'},{label:'제목',key:'title'},{label:'상태',key:'status'},{label:'등록일',key:'date'}], '문의목록.csv');
