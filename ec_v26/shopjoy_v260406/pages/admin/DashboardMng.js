...
window.DashboardMng = {
  ...
  setup(props) {
    ...
    const shortcuts = [
      { id: 'memberMng',   label: '회원관리',   icon: '👥', color: '#e8587a' },
      { id: 'prodMng',     label: '상품관리',   icon: '📦', color: '#1677ff' },
      { id: 'orderMng',    label: '주문관리',   icon: '🛒', color: '#52c41a' },
      { id: 'claimMng',    label: '클레임관리', icon: '⚠️', color: '#ff4d4f' },
      { id: 'dlivMng',     label: '배송관리',   icon: '🚚', color: '#389e0d' },
      { id: 'couponMng',   label: '쿠폰관리',   icon: '🎫', color: '#722ed1' },
      { id: 'eventMng',    label: '이벤트관리', icon: '🎉', color: '#d46b08' },
      { id: 'contactMng',  label: '문의관리',   icon: '💬', color: '#13c2c2' },
      { id: 'siteMng',     label: '사이트관리', icon: '🌐', color: '#2563eb' },
      { id: 'userMng',     label: '사용자관리', icon: '🔑', color: '#c41d7f' },
    ];
