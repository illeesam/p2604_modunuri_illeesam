...
(function () {
  ...
  window.adminData = reactive({
    ...
    brands: [
      { brandId:  1, brandCode: 'NIKE',       brandNm: '나이키',     brandEnNm: 'Nike',        dispPath: 'sports.global', logoUrl: '', sortOrd:  1, useYn: 'Y', remark: '글로벌 스포츠 브랜드',  regDate: '2026-01-01' },
      { brandId:  2, brandCode: 'ADIDAS',     brandNm: '아디다스',   brandEnNm: 'Adidas',      dispPath: 'sports.global', logoUrl: '', sortOrd:  2, useYn: 'Y', remark: '독일 스포츠 브랜드',    regDate: '2026-01-01' },
      { brandId:  3, brandCode: 'PUMA',       brandNm: '푸마',       brandEnNm: 'Puma',        dispPath: 'sports.global', logoUrl: '', sortOrd:  3, useYn: 'Y', remark: '독일 스포츠 브랜드',    regDate: '2026-01-01' },
      { brandId:  4, brandCode: 'NB',         brandNm: '뉴발란스',   brandEnNm: 'New Balance', dispPath: 'sports.global', logoUrl: '', sortOrd:  4, useYn: 'Y', remark: '미국 스포츠 브랜드',    regDate: '2026-01-01' },
      { brandId:  5, brandCode: 'UNIQLO',     brandNm: '유니클로',   brandEnNm: 'Uniqlo',      dispPath: 'fashion.spa', logoUrl: '', sortOrd:  5, useYn: 'Y', remark: '일본 캐주얼 브랜드',    regDate: '2026-01-01' },
      { brandId:  6, brandCode: 'ZARA',       brandNm: '자라',       brandEnNm: 'Zara',        dispPath: 'fashion.spa', logoUrl: '', sortOrd:  6, useYn: 'Y', remark: '스페인 패스트패션',     regDate: '2026-01-01' },
      { brandId:  7, brandCode: 'HM',         brandNm: 'H&M',        brandEnNm: 'H&M',         dispPath: 'fashion.spa', logoUrl: '', sortOrd:  7, useYn: 'Y', remark: '스웨덴 패스트패션',     regDate: '2026-01-01' },
      { brandId:  8, brandCode: 'LEVIS',      brandNm: '리바이스',   brandEnNm: "Levi's",      logoUrl: '', sortOrd:  8, useYn: 'Y', remark: '미국 데님 브랜드',      regDate: '2026-01-01' },
      { brandId:  9, brandCode: 'MLB',        brandNm: 'MLB',        brandEnNm: 'MLB',         dispPath: 'sports.global', logoUrl: '', sortOrd:  9, useYn: 'Y', remark: '야구 라이선스 패션',    regDate: '2026-01-01' },
      { brandId: 10, brandCode: 'DESCENTE',   brandNm: '데상트',     brandEnNm: 'Descente',    dispPath: 'sports.korea', logoUrl: '', sortOrd: 10, useYn: 'Y', remark: '일본 스포츠 브랜드',    regDate: '2026-01-01' },
      { brandId: 11, brandCode: 'SHOPJOY_OWN',brandNm: 'ShopJoy OB', brandEnNm: 'ShopJoy OB',  dispPath: 'shopjoy.pb', logoUrl: '', sortOrd: 11, useYn: 'Y', remark: '자체 브랜드(PB상품)',   regDate: '2026-01-01' },
      { brandId: 12, brandCode: 'LEGACY',     brandNm: '레거시브랜드',brandEnNm: 'Legacy',      dispPath: 'archive.legacy', logoUrl: '', sortOrd: 12, useYn: 'N', remark: '미사용 처리된 브랜드', regDate: '2026-01-01' },
    ],

    codeGroups: [
      { codeGrp: 'MEMBER_GRADE',      grpNm: '회원등급',         dispPath: 'member.grade',         description: '회원 등급 (BASIC/SILVER/GOLD/VIP)',                useYn: 'Y' },
      { codeGrp: 'MEMBER_STATUS',     grpNm: '회원상태',         dispPath: 'member.status',        description: '회원 상태 (ACTIVE/INACTIVE/SUSPENDED/WITHDRAWN)',  useYn: 'Y' },
      { codeGrp: 'GENDER',            grpNm: '성별',             dispPath: 'member.gender',        description: '성별 (M/F)',                                       useYn: 'Y' },
      { codeGrp: 'USER_STATUS',       grpNm: '사용자상태',       dispPath: 'user.status',          description: '관리자 사용자 상태',                                useYn: 'Y' },
      { codeGrp: 'USER_ROLE',         grpNm: '사용자권한',       dispPath: 'user.role',            description: '관리자 권한',                                       useYn: 'Y' },
      { codeGrp: 'DEPT_TYPE',         grpNm: '부서유형',         dispPath: 'user.dept',            description: '부서 유형 (HQ/BRANCH/TEAM)',                       useYn: 'Y' },
      { codeGrp: 'ORDER_STATUS',      grpNm: '주문상태',         dispPath: 'order.status',         description: '주문 상태 (PENDING/PAID/...)',                     useYn: 'Y' },
      { codeGrp: 'PAY_METHOD',        grpNm: '결제수단',         dispPath: 'order.payment',        description: '결제 수단 (CARD/BANK/KAKAO/...)',                  useYn: 'Y' },
      { codeGrp: 'REFUND_METHOD',     grpNm: '환불수단',         dispPath: 'order.refund',         description: '환불 수단',                                         useYn: 'Y' },
      { codeGrp: 'CLAIM_TYPE',        grpNm: '클레임유형',       dispPath: 'claim.type',           description: '취소/반품/교환',                                    useYn: 'Y' },
      { codeGrp: 'CLAIM_STATUS',      grpNm: '클레임상태',       dispPath: 'claim.status',         description: '클레임 처리 상태',                                  useYn: 'Y' },
      { codeGrp: 'CLAIM_REASON',      grpNm: '클레임사유',       dispPath: 'claim.reason',         description: '클레임 사유',                                       useYn: 'Y' },
      { codeGrp: 'COURIER',           grpNm: '택배사',           dispPath: 'dliv.courier',         description: '택배사 코드',                                       useYn: 'Y' },
      { codeGrp: 'DLIV_STATUS',       grpNm: '배송상태',         dispPath: 'dliv.status',          description: '배송 상태',                                         useYn: 'Y' },
      { codeGrp: 'PRODUCT_STATUS',    grpNm: '상품상태',         dispPath: 'product.status',       description: '상품 상태',                                         useYn: 'Y' },
      { codeGrp: 'PRODUCT_SIZE',      grpNm: '상품사이즈',       dispPath: 'product.size',         description: '상품 사이즈',                                       useYn: 'Y' },
      { codeGrp: 'PRODUCT_CATEGORY',  grpNm: '상품카테고리',     dispPath: 'product.category',     description: '상품 카테고리',                                     useYn: 'Y' },
      { codeGrp: 'COUPON_TYPE',       grpNm: '쿠폰유형',         dispPath: 'promotion.coupon.type',   description: '쿠폰 유형 (RATE/FIXED)',                         useYn: 'Y' },
      { codeGrp: 'COUPON_STATUS',     grpNm: '쿠폰상태',         dispPath: 'promotion.coupon.status', description: '쿠폰 상태',                                     useYn: 'Y' },
      { codeGrp: 'EVENT_TYPE',        grpNm: '이벤트유형',       dispPath: 'promotion.event.type',    description: '이벤트 유형',                                    useYn: 'Y' },
      { codeGrp: 'EVENT_STATUS',      grpNm: '이벤트상태',       dispPath: 'promotion.event.status',  description: '이벤트 상태',                                    useYn: 'Y' },
      { codeGrp: 'CACHE_TYPE',        grpNm: '적립금유형',       dispPath: 'promotion.cache.type',    description: '적립금 유형',                                    useYn: 'Y' },
      { codeGrp: 'DISP_AREA',         grpNm: '전시영역',         dispPath: 'disp.area',            description: '전시 영역 코드',                                    useYn: 'Y' },
      { codeGrp: 'DISP_TYPE',         grpNm: '전시유형',         dispPath: 'disp.type',            description: '전시 유형',                                         useYn: 'Y' },
      { codeGrp: 'DISP_STATUS',       grpNm: '전시상태',         dispPath: 'disp.status',          description: '전시 상태',                                         useYn: 'Y' },
      { codeGrp: 'DISP_UI',           grpNm: '전시 UI',          dispPath: 'disp.ui',              description: '전시 UI 타입',                                      useYn: 'Y' },
      { codeGrp: 'VISIBILITY_TARGET', grpNm: '공개대상',         dispPath: 'disp.visibility',      description: '공개 대상',                                         useYn: 'Y' },
      { codeGrp: 'NOTICE_TYPE',       grpNm: '공지유형',         dispPath: 'cs.notice',            description: '공지 유형',                                         useYn: 'Y' },
      { codeGrp: 'CONTACT_STATUS',    grpNm: '문의상태',         dispPath: 'cs.contact',           description: '문의 처리 상태',                                    useYn: 'Y' },
      { codeGrp: 'CHATT_STATUS',      grpNm: '채팅상태',         dispPath: 'cs.chatt',             description: '채팅 상태',                                         useYn: 'Y' },
      { codeGrp: 'ALARM_TYPE',        grpNm: '알림유형',         dispPath: 'system.alarm.type',    description: '알림 유형',                                         useYn: 'Y' },
      { codeGrp: 'ALARM_CHANNEL',     grpNm: '알림채널',         dispPath: 'system.alarm.channel', description: '알림 채널',                                         useYn: 'Y' },
      { codeGrp: 'TEMPLATE_TYPE',     grpNm: '템플릿유형',       dispPath: 'system.template',      description: '템플릿 유형',                                       useYn: 'Y' },
      { codeGrp: 'BATCH_CYCLE',       grpNm: '배치주기',         dispPath: 'system.batch.cycle',   description: '배치 실행 주기',                                    useYn: 'Y' },
      { codeGrp: 'BATCH_STATUS',      grpNm: '배치상태',         dispPath: 'system.batch.status',  description: '배치 상태',                                         useYn: 'Y' },
      { codeGrp: 'VENDOR_STATUS',     grpNm: '업체상태',         dispPath: 'vendor.status',        description: '업체 상태',                                         useYn: 'Y' },
      { codeGrp: 'SITE_STATUS',       grpNm: '사이트상태',       dispPath: 'site.status',          description: '사이트 상태',                                       useYn: 'Y' },
      { codeGrp: 'USE_YN',            grpNm: '사용여부',         dispPath: 'common.use_yn',        description: 'Y/N',                                              useYn: 'Y' },
    ],
    ...
    codes: [
      ...
      { codeId: 48, codeGrp: 'CLAIM_STATUS',    codeLabel: '수거중',     codeValue: 'COLLECT_ING',       sortOrd: 6, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 42, codeGrp: 'CLAIM_STATUS',    codeLabel: '수거완료',   codeValue: 'COLLECT_DONE',      sortOrd: 7, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 43, codeGrp: 'CLAIM_STATUS',    codeLabel: '환불처리중', codeValue: 'REFUND_ING',        sortOrd: 8, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 44, codeGrp: 'CLAIM_STATUS',    codeLabel: '환불완료',   codeValue: 'REFUND_DONE',       sortOrd: 9, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 45, codeGrp: 'CLAIM_STATUS',    codeLabel: '교환요청',   codeValue: 'EXCHANGE_REQ',      sortOrd:10, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 49, codeGrp: 'CLAIM_STATUS',    codeLabel: '상품준비중', codeValue: 'EXCHANGE_PREP',     sortOrd:11, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 50, codeGrp: 'CLAIM_STATUS',    codeLabel: '발송중',     codeValue: 'EXCHANGE_SENDING',  sortOrd:12, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 46, codeGrp: 'CLAIM_STATUS',    codeLabel: '발송완료',   codeValue: 'EXCHANGE_SEND',     sortOrd:13, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      { codeId: 47, codeGrp: 'CLAIM_STATUS',    codeLabel: '교환완료',   codeValue: 'EXCHANGE_DONE',     sortOrd:14, useYn: 'Y', remark: '', regDate: '2026-01-01' },
      /* ── 클레임 사유 ── */
    ...
    roles: [
      { roleId: 1, roleCode: 'SUPER_ADMIN', roleNm: '슈퍼관리자',   parentId: null, roleType: '시스템', sortOrd: 1, useYn: 'Y', restrictPerm: '없음', remark: '전체 권한 보유', regDate: '2025-01-01', dispPath: 'role.admin' },
      ...
      { roleId: 3, roleCode: 'PRODUCT_MGR', roleNm: '상품관리자',   parentId: null, roleType: '업무',   sortOrd: 3, useYn: 'Y', restrictPerm: '없음', remark: '상품 관리 권한', regDate: '2025-01-01', dispPath: 'role.general' },
      { roleId: 4, roleCode: 'ORDER_MGR',   roleNm: '주문관리자',   parentId: null, roleType: '업무',   sortOrd: 4, useYn: 'Y', restrictPerm: '없음', remark: '주문/클레임 관리 권한', regDate: '2025-01-01', dispPath: 'role.general' },
      { roleId: 5, roleCode: 'CS_MGR',      roleNm: '고객지원관리자', parentId: null, roleType: '업무', sortOrd: 5, useYn: 'Y', restrictPerm: '없음', remark: 'CS 관리 권한', regDate: '2025-01-01', dispPath: 'role.general' },
      { roleId: 6, roleCode: 'MARKETING_MGR', roleNm: '마케팅관리자', parentId: null, roleType: '업무', sortOrd: 6, useYn: 'Y', restrictPerm: '없음', remark: '쿠폰/이벤트 관리', regDate: '2025-02-01', dispPath: 'role.general' },
      { roleId: 7, roleCode: 'READONLY',    roleNm: '읽기전용',     parentId: null, roleType: '기타',   sortOrd: 7, useYn: 'Y', restrictPerm: '읽기', remark: '조회만 가능', regDate: '2025-03-01', dispPath: 'role.general' },
      { roleId: 8, roleCode: 'BLOCKED',     roleNm: '차단전용',     parentId: null, roleType: '기타',   sortOrd: 8, useYn: 'Y', restrictPerm: '차단', remark: '모든 접근 차단', regDate: '2025-04-01', dispPath: 'role.general' },
    ],
    roleMenus: [
