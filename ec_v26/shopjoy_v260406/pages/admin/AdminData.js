...
(function () {
  ...
  window.adminData = reactive({
    ...
    codeGroups: [
      { codeGrp: 'MEMBER_GRADE', pathId: 10,      grpNm: '회원등급',         dispPath: 'member.grade',         description: '회원 등급 (BASIC/SILVER/GOLD/VIP)',                useYn: 'Y' },
      { codeGrp: 'MEMBER_STATUS', pathId: 10,     grpNm: '회원상태',         dispPath: 'member.status',        description: '회원 상태 (ACTIVE/INACTIVE/SUSPENDED/WITHDRAWN)',  useYn: 'Y' },
      { codeGrp: 'GENDER', pathId: 10,            grpNm: '성별',             dispPath: 'member.gender',        description: '성별 (M/F)',                                       useYn: 'Y' },
      { codeGrp: 'USER_STATUS', pathId: 10,       grpNm: '사용자상태',       dispPath: 'user.status',          description: '관리자 사용자 상태',                                useYn: 'Y' },
      { codeGrp: 'USER_ROLE', pathId: 10,         grpNm: '사용자권한',       dispPath: 'user.role',            description: '관리자 권한',                                       useYn: 'Y' },
      { codeGrp: 'DEPT_TYPE', pathId: 10,         grpNm: '부서유형',         dispPath: 'user.dept',            description: '부서 유형 (HQ/BRANCH/TEAM)',                       useYn: 'Y' },
      { codeGrp: 'ORDER_STATUS', pathId: 11,      grpNm: '주문상태',         dispPath: 'order.status',         description: '주문 상태 (PENDING/PAID/...)',                     useYn: 'Y' },
      { codeGrp: 'PAY_METHOD', pathId: 11,        grpNm: '결제수단',         dispPath: 'order.payment',        description: '결제 수단 (CARD/BANK/KAKAO/...)',                  useYn: 'Y' },
      { codeGrp: 'REFUND_METHOD', pathId: 11,     grpNm: '환불수단',         dispPath: 'order.refund',         description: '환불 수단',                                         useYn: 'Y' },
      { codeGrp: 'CLAIM_TYPE', pathId: 12,        grpNm: '클레임유형',       dispPath: 'claim.type',           description: '취소/반품/교환',                                    useYn: 'Y' },
      { codeGrp: 'CLAIM_STATUS', pathId: 12,      grpNm: '클레임상태',       dispPath: 'claim.status',         description: '클레임 처리 상태',                                  useYn: 'Y' },
      { codeGrp: 'CLAIM_REASON', pathId: 12,      grpNm: '클레임사유',       dispPath: 'claim.reason',         description: '클레임 사유',                                       useYn: 'Y' },
      { codeGrp: 'COURIER', pathId: 12,           grpNm: '택배사',           dispPath: 'dliv.courier',         description: '택배사 코드',                                       useYn: 'Y' },
      { codeGrp: 'DLIV_STATUS', pathId: 12,       grpNm: '배송상태',         dispPath: 'dliv.status',          description: '배송 상태',                                         useYn: 'Y' },
      { codeGrp: 'PRODUCT_STATUS', pathId: 13,    grpNm: '상품상태',         dispPath: 'product.status',       description: '상품 상태',                                         useYn: 'Y' },
      { codeGrp: 'PRODUCT_SIZE', pathId: 13,      grpNm: '상품사이즈',       dispPath: 'product.size',         description: '상품 사이즈',                                       useYn: 'Y' },
      { codeGrp: 'PRODUCT_CATEGORY', pathId: 13,  grpNm: '상품카테고리',     dispPath: 'product.category',     description: '상품 카테고리',                                     useYn: 'Y' },
      { codeGrp: 'COUPON_TYPE', pathId: 13,       grpNm: '쿠폰유형',         dispPath: 'promotion.coupon.type',   description: '쿠폰 유형 (RATE/FIXED)',                         useYn: 'Y' },
      { codeGrp: 'COUPON_STATUS', pathId: 13,     grpNm: '쿠폰상태',         dispPath: 'promotion.coupon.status', description: '쿠폰 상태',                                     useYn: 'Y' },
      { codeGrp: 'EVENT_TYPE', pathId: 13,        grpNm: '이벤트유형',       dispPath: 'promotion.event.type',    description: '이벤트 유형',                                    useYn: 'Y' },
      { codeGrp: 'EVENT_STATUS', pathId: 13,      grpNm: '이벤트상태',       dispPath: 'promotion.event.status',  description: '이벤트 상태',                                    useYn: 'Y' },
      { codeGrp: 'CACHE_TYPE', pathId: 13,        grpNm: '적립금유형',       dispPath: 'promotion.cache.type',    description: '적립금 유형',                                    useYn: 'Y' },
      { codeGrp: 'DISP_AREA', pathId: 14,         grpNm: '전시영역',         dispPath: 'disp.area',            description: '전시 영역 코드',                                    useYn: 'Y' },
      { codeGrp: 'DISP_TYPE', pathId: 14,         grpNm: '전시유형',         dispPath: 'disp.type',            description: '전시 유형',                                         useYn: 'Y' },
      { codeGrp: 'DISP_STATUS', pathId: 14,       grpNm: '전시상태',         dispPath: 'disp.status',          description: '전시 상태',                                         useYn: 'Y' },
      { codeGrp: 'DISP_UI', pathId: 14,           grpNm: '전시 UI',          dispPath: 'disp.ui',              description: '전시 UI 타입',                                      useYn: 'Y' },
      { codeGrp: 'VISIBILITY_TARGET', pathId: 14, grpNm: '공개대상',         dispPath: 'disp.visibility',      description: '공개 대상',                                         useYn: 'Y' },
      { codeGrp: 'NOTICE_TYPE', pathId: 12,       grpNm: '공지유형',         dispPath: 'cs.notice',            description: '공지 유형',                                         useYn: 'Y' },
      { codeGrp: 'CONTACT_STATUS', pathId: 12,    grpNm: '문의상태',         dispPath: 'cs.contact',           description: '문의 처리 상태',                                    useYn: 'Y' },
      { codeGrp: 'CHATT_STATUS', pathId: 12,      grpNm: '채팅상태',         dispPath: 'cs.chatt',             description: '채팅 상태',                                         useYn: 'Y' },
      { codeGrp: 'ALARM_TYPE', pathId: 10,        grpNm: '알림유형',         dispPath: 'system.alarm.type',    description: '알림 유형',                                         useYn: 'Y' },
      { codeGrp: 'ALARM_CHANNEL', pathId: 10,     grpNm: '알림채널',         dispPath: 'system.alarm.channel', description: '알림 채널',                                         useYn: 'Y' },
      { codeGrp: 'TEMPLATE_TYPE', pathId: 10,     grpNm: '템플릿유형',       dispPath: 'system.template',      description: '템플릿 유형',                                       useYn: 'Y' },
      { codeGrp: 'BATCH_CYCLE', pathId: 10,       grpNm: '배치주기',         dispPath: 'system.batch.cycle',   description: '배치 실행 주기',                                    useYn: 'Y' },
      { codeGrp: 'BATCH_STATUS', pathId: 10,      grpNm: '배치상태',         dispPath: 'system.batch.status',  description: '배치 상태',                                         useYn: 'Y' },
      { codeGrp: 'VENDOR_STATUS', pathId: 10,     grpNm: '업체상태',         dispPath: 'vendor.status',        description: '업체 상태',                                         useYn: 'Y' },
      { codeGrp: 'SITE_STATUS', pathId: 10,       grpNm: '사이트상태',       dispPath: 'site.status',          description: '사이트 상태',                                       useYn: 'Y' },
      { codeGrp: 'USE_YN', pathId: 10,            grpNm: '사용여부',         dispPath: 'common.use_yn',        description: 'Y/N',                                              useYn: 'Y' },
    ],
