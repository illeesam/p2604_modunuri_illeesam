...
(function () {
  ...
  window.adminData = reactive({
    ...
    orders: [
      { orderId: 'ORD-2026-025', userId: 1, userNm: '홍길동', orderDate: '2026-04-05 14:32', prodNm: '오버사이즈 코튼 티셔츠', totalPrice: 26900, status: '주문완료', payMethod: '혼합결제', vendorId: 4 },
      { orderId: 'ORD-2026-024', userId: 1, userNm: '홍길동', orderDate: '2026-04-04 09:18', prodNm: '슬림핏 데님 진 외 1', totalPrice: 238800, status: '결제완료', payMethod: '계좌이체', vendorId: 1 },
      { orderId: 'ORD-2026-023', userId: 2, userNm: '이영희', orderDate: '2026-04-02 21:05', prodNm: '케이블 니트 스웨터 외 1', totalPrice: 104000, status: '배송준비중', payMethod: '혼합결제', vendorId: 2 },
      { orderId: 'ORD-2026-022', userId: 3, userNm: '박민준', orderDate: '2026-03-28 16:44', prodNm: '플로럴 미디 드레스', totalPrice: 79000, status: '배송중', payMethod: '캐쉬', vendorId: 3 },
      { orderId: 'ORD-2026-021', userId: 1, userNm: '홍길동', orderDate: '2026-03-22 11:27', prodNm: '카고 와이드 팬츠', totalPrice: 55000, status: '배송완료', payMethod: '계좌이체', vendorId: 4 },
      { orderId: 'ORD-2026-020', userId: 4, userNm: '김수현', orderDate: '2026-03-18 08:53', prodNm: '스트라이프 린넨 셔츠', totalPrice: 45000, status: '완료', payMethod: '카드결제', vendorId: 1 },
      { orderId: 'ORD-2026-019', userId: 2, userNm: '이영희', orderDate: '2026-03-14 19:01', prodNm: '퀼티드 숏 점퍼', totalPrice: 89000, status: '취소됨', payMethod: '계좌이체', vendorId: 2 },
      { orderId: 'ORD-2026-018', userId: 1, userNm: '홍길동', orderDate: '2026-03-10 13:22', prodNm: '오버사이즈 코튼 티셔츠 x2', totalPrice: 59800, status: '완료', payMethod: '계좌이체', vendorId: 3 },
      { orderId: 'ORD-2026-017', userId: 6, userNm: '정민호', orderDate: '2026-03-07 10:48', prodNm: '케이블 니트 스웨터', totalPrice: 49000, status: '배송완료', payMethod: '카드결제', vendorId: 4 },
      { orderId: 'ORD-2026-016', userId: 3, userNm: '박민준', orderDate: '2026-02-27 15:36', prodNm: '슬림핏 데님 진', totalPrice: 59900, status: '완료', payMethod: '계좌이체', vendorId: 1 },
      { orderId: 'ORD-2026-015', userId: 8, userNm: '윤성준', orderDate: '2026-02-22 22:14', prodNm: '플로럴 미디 드레스 외 1', totalPrice: 108900, status: '완료', payMethod: '카드결제', vendorId: 2 },
      { orderId: 'ORD-2026-014', userId: 8, userNm: '윤성준', orderDate: '2026-02-18 07:59', prodNm: '카고 와이드 팬츠', totalPrice: 55000, status: '완료', payMethod: '계좌이체', vendorId: 3 },
      { orderId: 'ORD-2026-013', userId: 5, userNm: '최지우', orderDate: '2026-02-14 12:33', prodNm: '오버사이즈 코튼 티셔츠', totalPrice: 29900, status: '주문완료', payMethod: '계좌이체', vendorId: 4 },
      { orderId: 'ORD-2026-012', userId: 7, userNm: '강예은', orderDate: '2026-02-10 18:07', prodNm: '슬림핏 데님 진 외 1', totalPrice: 94900, status: '결제완료', payMethod: '계좌이체', vendorId: 1 },
      { orderId: 'ORD-2026-011', userId: 1, userNm: '홍길동', orderDate: '2026-02-05 09:41', prodNm: '울 블렌드 롱코트', totalPrice: 119000, status: '취소됨', payMethod: '계좌이체', vendorId: 2 },
    ],
