...
(function () {
  ...
  window.adminData = reactive({
    ...
    codeGroups: [
      ...
      { codeGrp: 'ORDER_STATUS', pathId: 11,      grpNm: '주문상태',         dispPath: 'order.status',         description: '주문 상태 (계층형)',                               type: '트리', useYn: 'Y' },
      { codeGrp: 'PAY_METHOD', pathId: 11,        grpNm: '결제수단',         dispPath: 'order.payment',        description: '결제 수단 (CARD/BANK/KAKAO/...)',                  type: '일반', useYn: 'Y' },
      ...
      { codeGrp: 'CLAIM_STATUS', pathId: 12,      grpNm: '클레임상태',       dispPath: 'claim.status',         description: '클레임 처리 상태 (계층형)',                        type: '트리', useYn: 'Y' },
      ...
      { codeGrp: 'DLIV_STATUS', pathId: 12,       grpNm: '배송상태',         dispPath: 'dliv.status',          description: '배송 상태 (계층형)',                               type: '트리', useYn: 'Y' },
    ...
    codes: [
      ...
      /* ── 주문 상태 ── */
      { codeId: 10, codeGrp: 'ORDER_STATUS',    codeLabel: '주문완료',   codeValue: 'ORDER_COMPLETE', sortOrd: 1, useYn: 'Y', remark: '결제 전 주문 접수', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 11, codeGrp: 'ORDER_STATUS',    codeLabel: '결제완료',   codeValue: 'PAY_COMPLETE',   sortOrd: 2, useYn: 'Y', remark: '결제 승인 완료', parentCodeValue: 'ORDER_COMPLETE', regDate: '2026-01-01' },
      { codeId: 12, codeGrp: 'ORDER_STATUS',    codeLabel: '배송준비중', codeValue: 'DLIV_READY',     sortOrd: 3, useYn: 'Y', remark: '출고 준비 단계', parentCodeValue: 'PAY_COMPLETE', regDate: '2026-01-01' },
      { codeId: 13, codeGrp: 'ORDER_STATUS',    codeLabel: '배송중',     codeValue: 'DLIV_ING',       sortOrd: 4, useYn: 'Y', remark: '택배사 인수 후', parentCodeValue: 'DLIV_READY', regDate: '2026-01-01' },
      { codeId: 14, codeGrp: 'ORDER_STATUS',    codeLabel: '배송완료',   codeValue: 'DLIV_DONE',      sortOrd: 5, useYn: 'Y', remark: '수령 확인 전', parentCodeValue: 'DLIV_ING', regDate: '2026-01-01' },
      { codeId: 15, codeGrp: 'ORDER_STATUS',    codeLabel: '완료',       codeValue: 'COMPLETE',       sortOrd: 6, useYn: 'Y', remark: '구매 확정', parentCodeValue: 'DLIV_DONE', regDate: '2026-01-01' },
      { codeId: 16, codeGrp: 'ORDER_STATUS',    codeLabel: '취소됨',     codeValue: 'CANCEL',         sortOrd: 7, useYn: 'Y', remark: '주문 취소 처리', parentCodeValue: null, regDate: '2026-01-01' },
      /* ── 결제 수단 ── */
      { codeId: 17, codeGrp: 'PAY_METHOD',      codeLabel: '카드결제',   codeValue: 'CARD',           sortOrd: 1, useYn: 'Y', remark: '신용/체크카드', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 18, codeGrp: 'PAY_METHOD',      codeLabel: '계좌이체',   codeValue: 'BANK',           sortOrd: 2, useYn: 'Y', remark: '실시간 계좌이체', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 19, codeGrp: 'PAY_METHOD',      codeLabel: '캐쉬',       codeValue: 'CACHE',          sortOrd: 3, useYn: 'Y', remark: '적립금 사용', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 20, codeGrp: 'PAY_METHOD',      codeLabel: '혼합결제',   codeValue: 'MIX',            sortOrd: 4, useYn: 'Y', remark: '캐쉬+카드/계좌 병행', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 21, codeGrp: 'PAY_METHOD',      codeLabel: '무통장입금', codeValue: 'VBANK',          sortOrd: 5, useYn: 'Y', remark: '가상계좌 무통장', parentCodeValue: null, regDate: '2026-01-01' },
      /* ── 환불 수단 ── */
      ...
      /* ── 배송 상태 ── */
      { codeId: 30, codeGrp: 'DLIV_STATUS',     codeLabel: '배송준비',   codeValue: 'READY',          sortOrd: 1, useYn: 'Y', remark: '출고 대기 중', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 31, codeGrp: 'DLIV_STATUS',     codeLabel: '배송중',     codeValue: 'ING',            sortOrd: 2, useYn: 'Y', remark: '택배사 이동 중', parentCodeValue: 'READY', regDate: '2026-01-01' },
      { codeId: 32, codeGrp: 'DLIV_STATUS',     codeLabel: '배송완료',   codeValue: 'DONE',           sortOrd: 3, useYn: 'Y', remark: '수령 완료', parentCodeValue: 'ING', regDate: '2026-01-01' },
      { codeId: 33, codeGrp: 'DLIV_STATUS',     codeLabel: '반송',       codeValue: 'RETURN',         sortOrd: 4, useYn: 'Y', remark: '반송 처리', parentCodeValue: null, regDate: '2026-01-01' },
      /* ── 클레임 유형 ── */
      ...
      /* ── 클레임 상태 ── */
      { codeId: 37, codeGrp: 'CLAIM_STATUS',    codeLabel: '취소요청',   codeValue: 'CANCEL_REQ',     sortOrd: 1, useYn: 'Y', remark: '', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 38, codeGrp: 'CLAIM_STATUS',    codeLabel: '취소처리중', codeValue: 'CANCEL_ING',     sortOrd: 2, useYn: 'Y', remark: '', parentCodeValue: 'CANCEL_REQ', regDate: '2026-01-01' },
      { codeId: 39, codeGrp: 'CLAIM_STATUS',    codeLabel: '취소완료',   codeValue: 'CANCEL_DONE',    sortOrd: 3, useYn: 'Y', remark: '', parentCodeValue: 'CANCEL_REQ', regDate: '2026-01-01' },
      { codeId: 40, codeGrp: 'CLAIM_STATUS',    codeLabel: '반품요청',   codeValue: 'RETURN_REQ',        sortOrd: 4, useYn: 'Y', remark: '', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 41, codeGrp: 'CLAIM_STATUS',    codeLabel: '수거예정',   codeValue: 'COLLECT_SCHED',     sortOrd: 5, useYn: 'Y', remark: '', parentCodeValue: 'RETURN_REQ', regDate: '2026-01-01' },
      { codeId: 48, codeGrp: 'CLAIM_STATUS',    codeLabel: '수거중',     codeValue: 'COLLECT_ING',       sortOrd: 6, useYn: 'Y', remark: '', parentCodeValue: 'RETURN_REQ', regDate: '2026-01-01' },
      { codeId: 42, codeGrp: 'CLAIM_STATUS',    codeLabel: '수거완료',   codeValue: 'COLLECT_DONE',      sortOrd: 7, useYn: 'Y', remark: '', parentCodeValue: 'RETURN_REQ', regDate: '2026-01-01' },
      { codeId: 43, codeGrp: 'CLAIM_STATUS',    codeLabel: '환불처리중', codeValue: 'REFUND_ING',        sortOrd: 8, useYn: 'Y', remark: '', parentCodeValue: 'RETURN_REQ', regDate: '2026-01-01' },
      { codeId: 44, codeGrp: 'CLAIM_STATUS',    codeLabel: '환불완료',   codeValue: 'REFUND_DONE',       sortOrd: 9, useYn: 'Y', remark: '', parentCodeValue: 'RETURN_REQ', regDate: '2026-01-01' },
      { codeId: 45, codeGrp: 'CLAIM_STATUS',    codeLabel: '교환요청',   codeValue: 'EXCHANGE_REQ',      sortOrd:10, useYn: 'Y', remark: '', parentCodeValue: null, regDate: '2026-01-01' },
      { codeId: 49, codeGrp: 'CLAIM_STATUS',    codeLabel: '상품준비중', codeValue: 'EXCHANGE_PREP',     sortOrd:11, useYn: 'Y', remark: '', parentCodeValue: 'EXCHANGE_REQ', regDate: '2026-01-01' },
      { codeId: 50, codeGrp: 'CLAIM_STATUS',    codeLabel: '발송중',     codeValue: 'EXCHANGE_SENDING',  sortOrd:12, useYn: 'Y', remark: '', parentCodeValue: 'EXCHANGE_REQ', regDate: '2026-01-01' },
      { codeId: 46, codeGrp: 'CLAIM_STATUS',    codeLabel: '발송완료',   codeValue: 'EXCHANGE_SEND',     sortOrd:13, useYn: 'Y', remark: '', parentCodeValue: 'EXCHANGE_REQ', regDate: '2026-01-01' },
      { codeId: 47, codeGrp: 'CLAIM_STATUS',    codeLabel: '교환완료',   codeValue: 'EXCHANGE_DONE',     sortOrd:14, useYn: 'Y', remark: '', parentCodeValue: 'EXCHANGE_REQ', regDate: '2026-01-01' },
      /* ── 클레임 사유 ── */
