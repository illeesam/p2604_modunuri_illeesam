...
(function () {
  ...
  window.adminData = reactive({
    ...
    props: [
      { propId: 1,  siteId: 1, dispPath: 'site.title',                propLabel: '사이트 제목',         propValue: 'ShopJoy',                propType: 'STRING',  sortOrd: 1, useYn: 'Y', remark: '브라우저 탭 제목' },
      { propId: 2,  siteId: 1, dispPath: 'site.tagline',              propLabel: '사이트 태그라인',     propValue: '쇼핑의 즐거움',           propType: 'STRING',  sortOrd: 2, useYn: 'Y', remark: '' },
      { propId: 3,  siteId: 1, dispPath: 'site.email.smtp.host',      propLabel: 'SMTP 호스트',         propValue: 'smtp.gmail.com',         propType: 'STRING',  sortOrd: 1, useYn: 'Y', remark: '' },
      { propId: 4,  siteId: 1, dispPath: 'site.email.smtp.port',      propLabel: 'SMTP 포트',           propValue: '587',                    propType: 'NUMBER',  sortOrd: 2, useYn: 'Y', remark: 'TLS' },
      { propId: 5,  siteId: 1, dispPath: 'site.email.from',           propLabel: '발신 이메일',         propValue: 'noreply@shopjoy.com',    propType: 'STRING',  sortOrd: 3, useYn: 'Y', remark: '' },
      { propId: 6,  siteId: 1, dispPath: 'site.sms.provider',         propLabel: 'SMS 공급자',          propValue: 'aligo',                  propType: 'STRING',  sortOrd: 1, useYn: 'Y', remark: '' },
      { propId: 7,  siteId: 1, dispPath: 'site.sms.api_key',          propLabel: 'SMS API 키',          propValue: 'sk_xxxxx',               propType: 'STRING',  sortOrd: 2, useYn: 'Y', remark: '암호화 권장' },
      { propId: 8,  siteId: 1, dispPath: 'order.cancel.timeout_min',  propLabel: '주문 취소 제한(분)',  propValue: '30',                     propType: 'NUMBER',  sortOrd: 1, useYn: 'Y', remark: '' },
      { propId: 9,  siteId: 1, dispPath: 'order.review.point',        propLabel: '리뷰 작성 포인트',    propValue: '500',                    propType: 'NUMBER',  sortOrd: 2, useYn: 'Y', remark: '' },
      { propId: 10, siteId: 1, dispPath: 'order.shipping.free_min',   propLabel: '무료배송 최소금액',   propValue: '50000',                  propType: 'NUMBER',  sortOrd: 3, useYn: 'Y', remark: '' },
      { propId: 11, siteId: 1, dispPath: 'member.signup.point',       propLabel: '가입 축하 포인트',    propValue: '3000',                   propType: 'NUMBER',  sortOrd: 1, useYn: 'Y', remark: '' },
      { propId: 12, siteId: 1, dispPath: 'member.vip.threshold',      propLabel: 'VIP 승급 누적금액',   propValue: '1000000',                propType: 'NUMBER',  sortOrd: 2, useYn: 'Y', remark: '' },
      { propId: 13, siteId: 1, dispPath: 'member.password.min_len',   propLabel: '비밀번호 최소길이',   propValue: '8',                      propType: 'NUMBER',  sortOrd: 3, useYn: 'Y', remark: '' },
      { propId: 14, siteId: 1, dispPath: 'payment.kakao.cid',         propLabel: '카카오페이 CID',      propValue: 'TC0ONETIME',             propType: 'STRING',  sortOrd: 1, useYn: 'Y', remark: '' },
      { propId: 15, siteId: 1, dispPath: 'payment.toss.client_key',   propLabel: '토스 클라이언트 키',  propValue: 'test_ck_xxxxx',          propType: 'STRING',  sortOrd: 2, useYn: 'Y', remark: '' },
      { propId: 16, siteId: 1, dispPath: 'feature.review.use',        propLabel: '리뷰 기능 사용',      propValue: 'true',                   propType: 'BOOLEAN', sortOrd: 1, useYn: 'Y', remark: '' },
      { propId: 17, siteId: 1, dispPath: 'feature.coupon.use',        propLabel: '쿠폰 기능 사용',      propValue: 'true',                   propType: 'BOOLEAN', sortOrd: 2, useYn: 'Y', remark: '' },
      { propId: 18, siteId: 1, dispPath: 'feature.cache.use',         propLabel: '캐쉬 기능 사용',      propValue: 'true',                   propType: 'BOOLEAN', sortOrd: 3, useYn: 'Y', remark: '' },
      { propId: 19, siteId: 1, dispPath: 'cache.ttl.product',         propLabel: '상품 캐시 TTL(초)',   propValue: '600',                    propType: 'NUMBER',  sortOrd: 1, useYn: 'Y', remark: '' },
      { propId: 20, siteId: 1, dispPath: 'cache.ttl.member',          propLabel: '회원 캐시 TTL(초)',   propValue: '300',                    propType: 'NUMBER',  sortOrd: 2, useYn: 'Y', remark: '' },
    ],
