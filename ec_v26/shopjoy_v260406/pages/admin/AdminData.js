...
(function () {
  ...
  window.adminData = reactive({
    ...
    roles: [
      { roleId: 1,  roleCode: 'SUPER_ADMIN',    roleNm: '슈퍼관리자 권한', parentId: null, roleType: '시스템', sortOrd: 1,  useYn: 'Y', restrictPerm: '없음', remark: '전체 권한 보유', regDate: '2025-01-01', dispPath: 'role.admin' },
      ...
      { roleId: 15, roleCode: 'SITE_GROUP',     roleNm: '사이트 권한',   parentId: null, roleType: '시스템', sortOrd: 3,  useYn: 'Y', restrictPerm: '없음', remark: '사이트 관리자 그룹', regDate: '2026-01-01', dispPath: 'role.admin' },
      ...
      { roleId: 9,  roleCode: 'SITE_MGR_ROOT',  roleNm: '판매업체 권한', parentId: null, roleType: '사이트', sortOrd: 13, useYn: 'Y', restrictPerm: '없음', remark: '판매사업자 그룹 루트', regDate: '2026-01-01', dispPath: 'role.site' },
      ...
      { roleId: 20, roleCode: 'DLIV_ROOT',      roleNm: '배송업체 권한', parentId: null, roleType: '사이트', sortOrd: 20, useYn: 'Y', restrictPerm: '없음', remark: '배송사업자 그룹 루트', regDate: '2026-01-01', dispPath: 'role.site' },
    ...
    menus: [
      ...
      { menuId:  93, menuCode: 'SY_ROLE',          menuNm: '권한관리',       parentId: 91,   menuUrl: '#page=syRoleMng',     menuType: '페이지', sortOrd: 2, useYn: 'Y', remark: '', regDate: '2025-01-01' },
