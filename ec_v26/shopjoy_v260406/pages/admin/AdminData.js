...
(function () {
  ...
  window.adminData = reactive({
    ...
    roles: [
      ...
      { roleId: 9,  roleCode: 'SITE_MGR_ROOT',  roleNm: '판매사업자 권한', parentId: null, roleType: '사이트', sortOrd: 13, useYn: 'Y', restrictPerm: '없음', remark: '판매사업자 그룹 루트', regDate: '2026-01-01', dispPath: 'role.site' },
      ...
      { roleId: 20, roleCode: 'DLIV_ROOT',      roleNm: '배송사업자 권한', parentId: null, roleType: '사이트', sortOrd: 20, useYn: 'Y', restrictPerm: '없음', remark: '배송사업자 그룹 루트', regDate: '2026-01-01', dispPath: 'role.site' },
