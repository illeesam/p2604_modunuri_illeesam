...
window.PdProdDtl = {
  ...
  setup(props) {
    ...
    Vue.watch(topTab, v => { window._pdProdDtlState.tab = v; });
    const viewMode2 = ref(window._pdProdDtlState.viewMode || 'tab');
    Vue.watch(viewMode2, v => { window._pdProdDtlState.viewMode = v; });
    ...
    <div class="card" v-show="showTab('info')" style="margin:0;">
      ...
      <div class="form-actions">
        <template v-if="viewMode">
          ...
          <button class="btn btn-secondary" @click="navigate('pdProdMng')">닫기</button>
        </template>
        <template v-else>
