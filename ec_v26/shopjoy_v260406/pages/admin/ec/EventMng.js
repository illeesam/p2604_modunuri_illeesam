...
window.EventMng = {
  ...
  setup(props) {
    ...
    const inlineNavigate = (pg, opts = {}) => { if (pg === 'ecEventMng') { selectedId.value = null; return; } props.navigate(pg, opts); };
...
<div>
  ...
  <div class="card">
    <div class="toolbar">
      <span class="list-title">이벤트목록 <span class="list-count">{{ total }}건</span></span>
