...
window.ChattMng = {
  ...
  setup(props) {
    ...
    const inlineNavigate = (pg, opts = {}) => { if (pg === 'ecChattMng') { selectedId.value = null; return; } props.navigate(pg, opts); };
...
<div>
  ...
  <div class="card">
    <div class="toolbar">
      <span class="list-title">채팅목록 <span class="list-count">{{ total }}건</span></span>
