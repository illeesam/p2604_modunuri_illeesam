...
window.PmEventDtl = {
  ...
  template: /* html */`
<div>
  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;"><div class="page-title">{{ isNew ? '이벤트 등록' : (viewMode ? '이벤트 상세' : '이벤트 수정') }}</div><span v-if="!isNew" style="font-size:12px;color:#999;">#{{ form.eventId }}</span></div>
