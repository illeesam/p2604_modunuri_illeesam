  ...
  setup(props) {
    ...
    const save = async () => {
      ...
      await window.adminApiCall({
        ...
        navigateTo: 'pmGiftMng',
      });
    };

    return { isNew, tab, form, errors, showTab, viewMode2, save, visibilityOptions, hasVisibility, toggleVisibility, condValLabel };
  },
  template: /* html */`
<div>
