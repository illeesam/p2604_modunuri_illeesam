...
window._ecDlivDtlState = window._ecDlivDtlState || { tab: 'info', viewMode: 'tab' };
window.EcDlivDtl = {
  name: 'EcDlivDtl',
  ...
  setup(props) {
    ...
    const tab = ref(window._ecDlivDtlState.tab || 'info');
    Vue.watch(tab, v => { window._ecDlivDtlState.tab = v; });
    const viewMode2 = ref(window._ecDlivDtlState.viewMode || 'tab');
    Vue.watch(viewMode2, v => { window._ecDlivDtlState.viewMode = v; });
