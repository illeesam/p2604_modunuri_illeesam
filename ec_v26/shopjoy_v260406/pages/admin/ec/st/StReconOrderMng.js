...
window.StReconOrderMng = {
  ...
  setup(props) {
    ...
    return { DATE_RANGE_OPTIONS, dateRange, dateStart, dateEnd, onDateRangeChange, searchKw, searchDiff, pager, rows, total, totPages, pageList, pageNums, summary, diffBadge, fmtW, onSearch, onReset };
  },
  template: /* html */`
<div>
