...
<div>
  ...
  <div class="card">
    <div class="toolbar">
      ...
      <button class="btn btn-primary btn-sm" @click="navigate('chattDtl', {id:null})">+ 신규</button>
    </div>
    <table class="admin-table">
      ...
      <tbody>
        ...
        <tr v-for="c in pageList" :key="c.chatId">
          <td>{{ c.chatId }}</td>
          <td><span class="ref-link" @click="showRefModal('member', c.userId)">{{ c.userName }}</span></td>
          <td><span class="title-link" @click="navigate('chattDtl',{id:c.chatId})">{{ c.subject }}</span></td>
          ...
          <td><div class="actions">
            <button class="btn btn-blue btn-sm" @click="navigate('chattDtl',{id:c.chatId})">보기</button>
