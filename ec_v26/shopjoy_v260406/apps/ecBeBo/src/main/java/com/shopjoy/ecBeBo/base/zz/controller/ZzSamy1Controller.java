...
import com.shopjoy.ecBeBo.base.zz.service.ZzSamy1Service;
...
public class ZzSamy1Controller {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzSamy1>> create(@Valid @RequestBody ZzSamy1 entity) {
    ...
    public ResponseEntity<ApiResponse<ZzSamy1>> update(
            @PathVariable("samy1Id") String samy1Id, @Valid @RequestBody ZzSamy1 entity) {
