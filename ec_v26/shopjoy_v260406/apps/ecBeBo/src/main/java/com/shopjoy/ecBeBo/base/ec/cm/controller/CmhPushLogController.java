...
import com.shopjoy.ecBeBo.base.ec.cm.service.CmhPushLogService;
...
public class CmhPushLogController {
    ...
    /* 푸시 발송 이력 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<CmhPushLogDto.Item>>> page(@Valid @ModelAttribute CmhPushLogDto.Request req) {
