...
import com.shopjoy.ecBeBo.base.ec.od.service.OdhOrderChgHistService;
...
public class OdhOrderChgHistController {
    ...
    /* 주문 변경 이력 등록 */
    @PostMapping
    public ResponseEntity<ApiResponse<OdhOrderChgHist>> create(@Valid @RequestBody OdhOrderChgHist entity) {
