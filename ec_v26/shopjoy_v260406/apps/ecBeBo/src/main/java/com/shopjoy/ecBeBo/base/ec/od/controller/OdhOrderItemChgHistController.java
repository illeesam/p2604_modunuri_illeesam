...
import com.shopjoy.ecBeBo.base.ec.od.service.OdhOrderItemChgHistService;
...
public class OdhOrderItemChgHistController {
    ...
    /* 주문 아이템 변경 이력 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<OdhOrderItemChgHistDto.Item>>> page(@Valid @ModelAttribute OdhOrderItemChgHistDto.Request req) {
        return ResponseEntity.ok(ApiResponse.ok(service.getPageData(req)));
    }

    /* 주문 아이템 변경 이력 등록 */
    @PostMapping
    public ResponseEntity<ApiResponse<OdhOrderItemChgHist>> create(@Valid @RequestBody OdhOrderItemChgHist entity) {
