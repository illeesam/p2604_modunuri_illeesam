...
import com.shopjoy.ecBeBo.base.sy.service.SyVendorUserRoleService;
...
public class SyVendorUserRoleController {
    ...
    /* 업체 사용자 역할 연결 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<SyVendorUserRole>> save(@PathVariable("id") String id, @Valid @RequestBody SyVendorUserRole entity) {
    ...
    /* 업체 사용자 역할 연결 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<SyVendorUserRole>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody SyVendorUserRole entity) {
        entity.setVendorUserRoleId(id);
    ...
    public ResponseEntity<ApiResponse<SyVendorUserRole>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody SyVendorUserRole entity) {
