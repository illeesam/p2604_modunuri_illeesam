...
public class BoSyPropController {
    ...
    /* 수정 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<SyProp>> update(@PathVariable("id") String id, @Valid @RequestBody SyProp body) {
        return ResponseEntity.ok(ApiResponse.ok(boSyPropService.update(id, body)));
    }

    /* upsert */
    @PostMapping("/{id}")
    public ResponseEntity<ApiResponse<SyProp>> upsert(@PathVariable("id") String id, @Valid @RequestBody SyProp body) {
        return ResponseEntity.ok(ApiResponse.ok(boSyPropService.update(id, body)));
    }
    ...
    public ResponseEntity<ApiResponse<java.util.List<java.util.Map<String, Object>>>> pathCounts(@Valid @ModelAttribute SyPropDto.Request req) {
