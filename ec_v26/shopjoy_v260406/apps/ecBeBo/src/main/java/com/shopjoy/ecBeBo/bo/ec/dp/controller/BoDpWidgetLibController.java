...
public class BoDpWidgetLibController {
    ...
    /* 등록 */
    @PostMapping
    public ResponseEntity<ApiResponse<DpWidgetLib>> create(@Valid @RequestBody DpWidgetLib body) {
    ...
    public ResponseEntity<ApiResponse<java.util.List<java.util.Map<String, Object>>>> pathCounts(@Valid @ModelAttribute DpWidgetLibDto.Request req) {
