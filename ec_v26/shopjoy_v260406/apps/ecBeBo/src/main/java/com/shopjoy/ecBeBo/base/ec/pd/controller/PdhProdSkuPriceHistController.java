...
import com.shopjoy.ecBeBo.base.ec.pd.service.PdhProdSkuPriceHistService;
...
public class PdhProdSkuPriceHistController {
    ...
    /* 상품 SKU 가격 이력 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<PdhProdSkuPriceHistDto.Item>>> page(@Valid @ModelAttribute PdhProdSkuPriceHistDto.Request req) {
