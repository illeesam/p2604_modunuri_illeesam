...
public class BoStSettleEtcAdjService {
    ...
    /* 페이지조회 */
    public BasePage<StSettleEtcAdjDto.Item> getPageData(StSettleEtcAdjDto.Request req) { return stSettleEtcAdjService.getPageData(req); }
    ...
    @Transactional public void saveListBase(List<StSettleEtcAdj> rows) { stSettleEtcAdjService.saveListBase(rows); }
}
