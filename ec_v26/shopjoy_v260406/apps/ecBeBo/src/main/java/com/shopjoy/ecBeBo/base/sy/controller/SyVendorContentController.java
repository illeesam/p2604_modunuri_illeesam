...
import com.shopjoy.ecBeBo.base.sy.service.SyVendorContentService;
...
public class SyVendorContentController {
    ...
    /* 업체 콘텐츠 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyVendorContentDto.Item>>> page(@Valid @ModelAttribute SyVendorContentDto.Request req) {
