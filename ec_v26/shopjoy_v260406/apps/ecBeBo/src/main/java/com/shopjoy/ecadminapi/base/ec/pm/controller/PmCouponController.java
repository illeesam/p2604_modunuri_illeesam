...
public class PmCouponController {
    ...
    /* 쿠폰 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PmCoupon>> save(@PathVariable("id") String id, @Valid @RequestBody PmCoupon entity) {
    ...
    /* 쿠폰 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PmCoupon>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody PmCoupon entity) {
        entity.setCouponId(id);
    ...
    public ResponseEntity<ApiResponse<PmCoupon>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody PmCoupon entity) {
        PmCoupon result = switch (cmd) {
