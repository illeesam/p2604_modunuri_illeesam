...
import com.shopjoy.ecBeBo.base.sy.data.dto.SyhBatchLogDto;
import com.shopjoy.ecBeBo.base.sy.service.SyhBatchLogService;
...
public class SyhBatchLogController {
    ...
    /** page — 페이징조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyhBatchLogDto.Item>>> page(@Valid @ModelAttribute SyhBatchLogDto.Request req) {
