...
public class BoDpWidgetLibService {
    ...
    /* 페이지조회 */
    public BasePage<DpWidgetLibDto.Item> getPageData(DpWidgetLibDto.Request req) { return dpWidgetLibService.getPageData(req); }
    ...
    @Transactional public void saveListBase(List<DpWidgetLib> rows) { dpWidgetLibService.saveListBase(rows); }
