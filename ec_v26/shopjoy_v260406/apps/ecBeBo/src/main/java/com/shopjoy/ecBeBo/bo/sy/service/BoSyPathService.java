...
import com.shopjoy.ecBeBo.base.sy.service.SyPathService;
...
public class BoSyPathService {
    ...
    /* 페이지조회 */
    public BasePage<SyPathDto.Item> getPageData(SyPathDto.Request req) { return syPathService.getPageData(req); }
