...
import com.shopjoy.ecBeBo.base.ec.od.service.OdhClaimChgHistService;
...
public class OdhClaimChgHistController {
    ...
    /* 클레임 변경 이력 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<OdhClaimChgHistDto.Item>>> page(@Valid @ModelAttribute OdhClaimChgHistDto.Request req) {
    ...
    /* 클레임 변경 이력 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<OdhClaimChgHist>> save(@PathVariable("id") String id, @Valid @RequestBody OdhClaimChgHist entity) {
    ...
    /* 클레임 변경 이력 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<OdhClaimChgHist>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody OdhClaimChgHist entity) {
        entity.setClaimChgHistId(id);
    ...
    public ResponseEntity<ApiResponse<OdhClaimChgHist>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody OdhClaimChgHist entity) {
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody List<OdhClaimChgHist> rows) {
        switch (cmd) {
