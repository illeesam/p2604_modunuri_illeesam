...
public class BoSyAttachService {
    ...
    /* 페이지조회 */
    public BasePage<SyAttachDto.Item> getPageData(SyAttachDto.Request req) { return syAttachService.getPageData(req); }
    ...
    @Transactional public void saveListBase(List<SyAttach> rows) { syAttachService.saveListBase(rows); }
}
