...
/** PdhProdStatusHist(상품 상태 이력) QueryDSL Custom 구현체 */
...
public class QPdhProdStatusHistRepositoryImpl implements QPdhProdStatusHistRepository {
    ...
    private JPAQuery<PdhProdStatusHistDto.Item> baseSelColumnQuery() {
        return queryFactory
                .select(Projections.bean(PdhProdStatusHistDto.Item.class,
                        ...
                        pdhProdStatusHist.regBy,      // 등록자
                        pdhProdStatusHist.regDate,    // 등록일시
                        pdhProdStatusHist.updBy,      // 수정자
                        pdhProdStatusHist.updDate,    // 수정일시
                        pdhProdStatusHist.regSiteId,  // 등록사이트ID
    ...
    public Optional<PdhProdStatusHistDto.Item> selectById(String id) {
        PdhProdStatusHistDto.Item dtl = baseSelColumnQuery()
    ...
    public List<PdhProdStatusHistDto.Item> selectList(PdhProdStatusHistDto.Request search) {
        ...
        List<PdhProdStatusHistDto.Item> list = query.fetch();
        return list;
    }
    ...
    public BasePage<PdhProdStatusHistDto.Item> selectPageData(PdhProdStatusHistDto.Request search) {
        ...
        OrderSpecifier<?>[] orders = orderList.toArray(OrderSpecifier[]::new);
        List<PdhProdStatusHistDto.Item> pageList = query.clone()
