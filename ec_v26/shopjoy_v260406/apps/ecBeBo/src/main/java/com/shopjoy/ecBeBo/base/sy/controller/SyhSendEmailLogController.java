...
import com.shopjoy.ecBeBo.base.sy.service.SyhSendEmailLogService;
...
public class SyhSendEmailLogController {
    ...
    /** page — 페이징조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyhSendEmailLogDto.Item>>> page(@Valid @ModelAttribute SyhSendEmailLogDto.Request req) {
