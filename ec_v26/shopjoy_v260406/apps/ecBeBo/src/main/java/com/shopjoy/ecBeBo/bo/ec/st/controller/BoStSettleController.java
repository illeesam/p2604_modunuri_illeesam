...
import com.shopjoy.ecBeBo.base.ec.st.data.dto.StSettleChangeStatusDto;
import com.shopjoy.ecBeBo.base.ec.st.data.entity.StSettle;
import com.shopjoy.ecBeBo.bo.ec.st.service.BoStSettleService;
...
public class BoStSettleController {
    ...
    /** update — 수정 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<StSettle>> update(@PathVariable("id") String id, @Valid @RequestBody StSettle body) {
    ...
    /** upsert */
    @PostMapping("/{id}")
    public ResponseEntity<ApiResponse<StSettle>> upsert(@PathVariable("id") String id, @Valid @RequestBody StSettle body) {
