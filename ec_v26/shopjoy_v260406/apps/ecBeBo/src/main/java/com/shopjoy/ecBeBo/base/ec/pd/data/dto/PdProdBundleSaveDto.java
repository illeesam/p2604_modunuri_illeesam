...
public class PdProdBundleSaveDto {
    ...
    public static class CreateRequest {
        private String prodNm;      // 신규 묶음상품명
        private List<Item> items;   // 구성품 목록
    }

    @Getter @Setter @NoArgsConstructor
    public static class UpdateItemsRequest {
        private List<Item> items;   // 갱신할 구성품 목록 (전체 교체)
    }

    @Getter @Setter @NoArgsConstructor
    public static class Item {
        private String prodId;      // 구성품 상품ID (pd_prod.prod_id) — 독립 판매 상품
