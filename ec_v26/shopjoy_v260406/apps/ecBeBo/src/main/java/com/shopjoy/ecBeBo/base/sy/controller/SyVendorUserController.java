...
public class SyVendorUserController {
    ...
    /* 업체 사용자 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyVendorUserDto.Item>>> page(@Valid @ModelAttribute SyVendorUserDto.Request req) {
    ...
    /* 업체 사용자 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<SyVendorUser>> save(@PathVariable("id") String id, @Valid @RequestBody SyVendorUser entity) {
    ...
    /* 업체 사용자 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<SyVendorUser>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody SyVendorUser entity) {
        entity.setVendorUserId(id);
    ...
    public ResponseEntity<ApiResponse<SyVendorUser>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody SyVendorUser entity) {
        SyVendorUser result = switch (cmd) {
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody List<SyVendorUser> rows) {
        switch (cmd) {
