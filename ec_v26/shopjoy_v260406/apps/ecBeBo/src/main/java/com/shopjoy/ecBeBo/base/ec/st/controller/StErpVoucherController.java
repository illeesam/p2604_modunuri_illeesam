...
public class StErpVoucherController {
    ...
    /* ERP 전표 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<StErpVoucher>> save(@PathVariable("id") String id, @Valid @RequestBody StErpVoucher entity) {
    ...
    /* ERP 전표 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<StErpVoucher>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody StErpVoucher entity) {
        entity.setErpVoucherId(id);
    ...
    public ResponseEntity<ApiResponse<StErpVoucher>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody StErpVoucher entity) {
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody List<StErpVoucher> rows) {
        switch (cmd) {
