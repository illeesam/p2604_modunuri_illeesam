...
public class PdProdController {
    ...
    /* 상품 등록 */
    @PostMapping
    public ResponseEntity<ApiResponse<PdProd>> create(@Valid @RequestBody PdProd entity) {
        return ResponseEntity.status(201).body(ApiResponse.created(service.create(entity)));
    }

    /* 상품 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PdProd>> save(@PathVariable("id") String id, @Valid @RequestBody PdProd entity) {
        entity.setProdId(id);
    ...
    /* 상품 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PdProd>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody PdProd entity) {
        entity.setProdId(id);
    ...
    public ResponseEntity<ApiResponse<PdProd>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody PdProd entity) {
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody List<PdProd> rows) {
        switch (cmd) {
