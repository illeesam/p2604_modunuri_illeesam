...
import com.shopjoy.ecBeBo.bo.sy.service.BoSyAccessErrorLogService;
...
public class BoSyAccessErrorLogController {
    ...
    /** page — 페이징조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyhAccessErrorLogDto.Item>>> page(@Valid @ModelAttribute SyhAccessErrorLogDto.Request req) {
