...
import com.shopjoy.ecBeBo.base.sy.service.SyhBatchHistService;
...
public class SyhBatchHistController {
    ...
    /** page — 페이징조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyhBatchHistDto.Item>>> page(@Valid @ModelAttribute SyhBatchHistDto.Request req) {
