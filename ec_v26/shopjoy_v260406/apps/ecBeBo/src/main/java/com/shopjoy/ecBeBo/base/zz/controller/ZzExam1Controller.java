...
import com.shopjoy.ecBeBo.base.zz.service.ZzExam1Service;
...
public class ZzExam1Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzExam1Dto.Item>>> page(@Valid @ModelAttribute ZzExam1Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzExam1>> create(@Valid @RequestBody ZzExam1 entity) {
    ...
    public ResponseEntity<ApiResponse<ZzExam1>> update(
            @PathVariable("exam1Id") String exam1Id, @Valid @RequestBody ZzExam1 entity) {
