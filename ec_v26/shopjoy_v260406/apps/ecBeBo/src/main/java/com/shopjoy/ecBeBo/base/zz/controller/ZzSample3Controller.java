...
import com.shopjoy.ecBeBo.base.zz.service.ZzSample3Service;
...
public class ZzSample3Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzSample3Dto.Item>>> page(@Valid @ModelAttribute ZzSample3Dto.Request req) {
    ...
    public ResponseEntity<ApiResponse<ZzSample3>> update(
            @PathVariable("id") String id, @Valid @RequestBody ZzSample3 entity) {
