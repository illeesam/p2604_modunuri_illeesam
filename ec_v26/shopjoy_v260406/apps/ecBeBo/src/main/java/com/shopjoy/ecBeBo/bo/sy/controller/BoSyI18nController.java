...
import com.shopjoy.ecBeBo.base.sy.data.dto.SyI18nSaveMsgsDto;
...
public class BoSyI18nController {
    ...
    /* 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyI18nDto.Item>>> page(@Valid @ModelAttribute SyI18nDto.Request req) {
