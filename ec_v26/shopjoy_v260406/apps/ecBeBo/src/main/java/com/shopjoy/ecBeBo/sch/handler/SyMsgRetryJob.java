...
import com.shopjoy.ecBeBo.co.cm.service.CmMailSendService;
import com.shopjoy.ecBeBo.co.cm.service.CmKakaoSendService;
import com.shopjoy.ecBeBo.co.cm.service.CmSmsSendService;
import com.shopjoy.ecBeBo.co.cm.service.CmAlarmSendService;
...
public class SyMsgRetryJob implements SchBatchJobHandler {
    ...
    private int retryEmails(LocalDateTime now) {
        ...
        List<SyhSendEmailLog> targets = emailLogRepository.findByResultCdAndSendDateBefore("FAILED", to).stream()
    ...
    private int retryMsgs(LocalDateTime now) {
        ...
        List<SyhSendMsgLog> targets = msgLogRepository.findByResultCdAndSendDateBefore("FAILED", to).stream()
