...
public class ZzExmy2Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzExmy2Dto.Item>>> page(@Valid @ModelAttribute ZzExmy2Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzExmy2>> create(@Valid @RequestBody ZzExmy2 entity) {
