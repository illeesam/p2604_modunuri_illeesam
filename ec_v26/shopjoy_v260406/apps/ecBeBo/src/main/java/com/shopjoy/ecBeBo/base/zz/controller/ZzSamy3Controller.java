...
import com.shopjoy.ecBeBo.base.zz.service.ZzSamy3Service;
...
public class ZzSamy3Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzSamy3Dto.Item>>> page(@Valid @ModelAttribute ZzSamy3Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzSamy3>> create(@Valid @RequestBody ZzSamy3 entity) {
    ...
    public ResponseEntity<ApiResponse<ZzSamy3>> update(
            @PathVariable("samy3Id") String samy3Id, @Valid @RequestBody ZzSamy3 entity) {
