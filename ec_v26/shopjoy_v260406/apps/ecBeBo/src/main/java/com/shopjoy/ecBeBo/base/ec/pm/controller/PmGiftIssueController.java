...
import com.shopjoy.ecBeBo.base.ec.pm.service.PmGiftIssueService;
...
public class PmGiftIssueController {
    ...
    /* 사은품 발행 이력 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PmGiftIssue>> save(@PathVariable("id") String id, @Valid @RequestBody PmGiftIssue entity) {
    ...
    /* 사은품 발행 이력 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PmGiftIssue>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody PmGiftIssue entity) {
        entity.setGiftIssueId(id);
    ...
    public ResponseEntity<ApiResponse<PmGiftIssue>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody PmGiftIssue entity) {
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody List<PmGiftIssue> rows) {
        switch (cmd) {
