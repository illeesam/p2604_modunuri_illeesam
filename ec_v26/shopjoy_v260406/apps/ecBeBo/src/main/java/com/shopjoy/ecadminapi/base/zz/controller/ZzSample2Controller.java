...
import com.shopjoy.ecadminapi.base.zz.service.ZzSample2Service;
...
public class ZzSample2Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzSample2Dto.Item>>> page(@Valid @ModelAttribute ZzSample2Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzSample2>> create(@Valid @RequestBody ZzSample2 entity) {
    ...
    public ResponseEntity<ApiResponse<ZzSample2>> update(
            @PathVariable("id") String id, @Valid @RequestBody ZzSample2 entity) {
