...
public class PdProdQnaController {
    ...
    /* 상품 문의 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PdProdQna>> save(@PathVariable("id") String id, @Valid @RequestBody PdProdQna entity) {
    ...
    /* 상품 문의 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PdProdQna>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody PdProdQna entity) {
        entity.setProdQnaId(id);
    ...
    public ResponseEntity<ApiResponse<PdProdQna>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody PdProdQna entity) {
