...
public class BoSyBbmController {
    ...
    /* 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyBbmDto.Item>>> page(@Valid @ModelAttribute SyBbmDto.Request req) {
    ...
    /* 수정 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<SyBbm>> update(@PathVariable("id") String id, @Valid @RequestBody SyBbm body) {
        return ResponseEntity.ok(ApiResponse.ok(boSyBbmService.update(id, body)));
    }

    /* upsert */
    @PostMapping("/{id}")
    public ResponseEntity<ApiResponse<SyBbm>> upsert(@PathVariable("id") String id, @Valid @RequestBody SyBbm body) {
        return ResponseEntity.ok(ApiResponse.ok(boSyBbmService.update(id, body)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
        ...
        switch (cmd) {
            case "base" -> boSyBbmService.saveListBase(rows);
    ...
    public ResponseEntity<ApiResponse<java.util.List<java.util.Map<String, Object>>>> pathCounts(@Valid @ModelAttribute SyBbmDto.Request req) {
