...
import com.shopjoy.ecBeBo.base.ec.pd.service.PdCategoryProdService;
...
public class PdCategoryProdController {
    ...
    /* 카테고리-상품 매핑 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<PdCategoryProdDto.Item>>> page(@Valid @ModelAttribute PdCategoryProdDto.Request req) {
        return ResponseEntity.ok(ApiResponse.ok(service.getPageData(req)));
    }

    /* 카테고리-상품 매핑 등록 */
    @PostMapping
    public ResponseEntity<ApiResponse<PdCategoryProd>> create(@Valid @RequestBody PdCategoryProd entity) {
