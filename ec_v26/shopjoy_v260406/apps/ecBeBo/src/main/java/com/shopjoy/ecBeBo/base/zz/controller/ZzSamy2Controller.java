...
import com.shopjoy.ecBeBo.base.zz.service.ZzSamy2Service;
...
public class ZzSamy2Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzSamy2Dto.Item>>> page(@Valid @ModelAttribute ZzSamy2Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzSamy2>> create(@Valid @RequestBody ZzSamy2 entity) {
    ...
    public ResponseEntity<ApiResponse<ZzSamy2>> update(
            @PathVariable("samy2Id") String samy2Id, @Valid @RequestBody ZzSamy2 entity) {
