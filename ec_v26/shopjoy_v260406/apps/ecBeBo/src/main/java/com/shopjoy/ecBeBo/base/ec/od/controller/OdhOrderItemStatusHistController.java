...
import com.shopjoy.ecBeBo.base.ec.od.service.OdhOrderItemStatusHistService;
...
public class OdhOrderItemStatusHistController {
    ...
    /* 주문 아이템 상태 이력 등록 */
    @PostMapping
    public ResponseEntity<ApiResponse<OdhOrderItemStatusHist>> create(@Valid @RequestBody OdhOrderItemStatusHist entity) {
