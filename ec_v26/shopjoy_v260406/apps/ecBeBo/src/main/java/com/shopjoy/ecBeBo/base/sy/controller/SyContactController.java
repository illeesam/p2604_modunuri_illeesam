...
import com.shopjoy.ecBeBo.base.sy.service.SyContactService;
...
public class SyContactController {
    ...
    /* 문의 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<SyContact>> save(@PathVariable("id") String id, @Valid @RequestBody SyContact entity) {
    ...
    /* 문의 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<SyContact>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody SyContact entity) {
        entity.setContactId(id);
    ...
    public ResponseEntity<ApiResponse<SyContact>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody SyContact entity) {
