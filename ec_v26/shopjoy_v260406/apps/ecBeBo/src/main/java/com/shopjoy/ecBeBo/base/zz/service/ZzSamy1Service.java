...
import com.shopjoy.ecBeBo.base.zz.data.dto.ZzSamy1Dto;
import com.shopjoy.ecBeBo.base.zz.data.dto.ZzSamy2Dto;
import com.shopjoy.ecBeBo.base.zz.data.dto.ZzSamy3Dto;
import com.shopjoy.ecBeBo.base.zz.data.entity.ZzSamy1;
import com.shopjoy.ecBeBo.base.zz.mapper.ZzSamy1Mapper;
import com.shopjoy.ecBeBo.base.zz.mapper.ZzSamy2Mapper;
import com.shopjoy.ecBeBo.base.zz.mapper.ZzSamy3Mapper;
...
public class ZzSamy1Service {
    ...
    public BasePage<ZzSamy1Dto.Item> getPageData(ZzSamy1Dto.Request req) {
        PageHelper.addPaging(req);
        List<ZzSamy1Dto.Item> list = zzSamy1Mapper.selectPageData(req);
        _listFillRelations(list);
        long total = zzSamy1Mapper.selectPageCount(req);
        BasePage<ZzSamy1Dto.Item> res = new BasePage<>();
