...
import com.shopjoy.ecBeBo.bo.sy.service.BoSyUserTokenLogService;
...
public class BoSyUserTokenLogController {
    ...
    /** page — 페이징조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyhUserTokenLogDto.Item>>> page(@Valid @ModelAttribute SyhUserTokenLogDto.Request req) {
