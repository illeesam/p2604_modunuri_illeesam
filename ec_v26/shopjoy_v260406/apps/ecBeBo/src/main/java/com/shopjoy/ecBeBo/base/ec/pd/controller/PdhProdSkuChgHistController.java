...
import com.shopjoy.ecBeBo.base.ec.pd.service.PdhProdSkuChgHistService;
...
public class PdhProdSkuChgHistController {
    ...
    /* 상품 SKU 변경 이력 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<PdhProdSkuChgHistDto.Item>>> page(@Valid @ModelAttribute PdhProdSkuChgHistDto.Request req) {
