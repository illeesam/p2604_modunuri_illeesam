...
import com.shopjoy.ecBeBo.base.ec.od.data.entity.QOdRefund;
import com.shopjoy.ecBeBo.base.ec.od.repository.qrydsl.QOdRefundRepository;
...
/** OdRefund(환불 마스터 (클레임 건별 환불 총괄)) QueryDSL Custom 구현체 */
