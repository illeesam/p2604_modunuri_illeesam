...
import com.shopjoy.ecBeBo.base.zz.service.ZzExmy3Service;
...
public class ZzExmy3Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzExmy3Dto.Item>>> page(@Valid @ModelAttribute ZzExmy3Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzExmy3>> create(@Valid @RequestBody ZzExmy3 entity) {
