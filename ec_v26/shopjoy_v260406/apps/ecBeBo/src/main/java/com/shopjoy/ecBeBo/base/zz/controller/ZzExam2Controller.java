...
import com.shopjoy.ecBeBo.base.zz.service.ZzExam2Service;
...
public class ZzExam2Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzExam2Dto.Item>>> page(@Valid @ModelAttribute ZzExam2Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzExam2>> create(@Valid @RequestBody ZzExam2 entity) {
    ...
    public ResponseEntity<ApiResponse<ZzExam2>> update(
            @PathVariable("exam1Id") String exam1Id,
            @PathVariable("exam2Id") String exam2Id,
            @Valid @RequestBody ZzExam2 entity) {
