...
import com.shopjoy.ecBeBo.base.ec.pd.service.PdhProdViewLogService;
...
public class PdhProdViewLogController {
    ...
    /* 상품 조회 로그 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<PdhProdViewLogDto.Item>>> page(@Valid @ModelAttribute PdhProdViewLogDto.Request req) {
    ...
    /* 상품 조회 로그 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PdhProdViewLog>> save(@PathVariable("id") String id, @Valid @RequestBody PdhProdViewLog entity) {
        entity.setLogId(id);
    ...
    /* 상품 조회 로그 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PdhProdViewLog>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody PdhProdViewLog entity) {
        entity.setLogId(id);
    ...
    public ResponseEntity<ApiResponse<PdhProdViewLog>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody PdhProdViewLog entity) {
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody List<PdhProdViewLog> rows) {
        switch (cmd) {
