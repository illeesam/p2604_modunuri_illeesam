...
import com.shopjoy.ecBeBo.bo.ec.od.service.BoOdDlivService;
...
public class BoOdDlivController {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<OdDlivDto.Item>>> page(@Valid @ModelAttribute OdDlivDto.Request req) {
    ...
    /** update — 수정 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<OdDliv>> update(@PathVariable("id") String id, @Valid @RequestBody OdDliv body) {
    ...
    /** upsert */
    @PostMapping("/{id}")
    public ResponseEntity<ApiResponse<OdDliv>> upsert(@PathVariable("id") String id, @Valid @RequestBody OdDliv body) {
