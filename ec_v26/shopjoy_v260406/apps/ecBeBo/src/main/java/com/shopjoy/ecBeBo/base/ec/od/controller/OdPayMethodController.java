...
import com.shopjoy.ecBeBo.base.ec.od.service.OdPayMethodService;
...
public class OdPayMethodController {
    ...
    /* 결제수단 등록 */
    @PostMapping
    public ResponseEntity<ApiResponse<OdPayMethod>> create(@Valid @RequestBody OdPayMethod entity) {
