...
import com.shopjoy.ecBeBo.bo.ec.pd.service.BoPdCategoryService;
...
public class BoPdCategoryController {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<PdCategoryDto.Item>>> page(@Valid @ModelAttribute PdCategoryDto.Request req) {
