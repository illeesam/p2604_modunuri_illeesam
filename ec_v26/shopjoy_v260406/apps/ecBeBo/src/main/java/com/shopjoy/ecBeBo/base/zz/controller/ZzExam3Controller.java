...
import com.shopjoy.ecBeBo.base.zz.service.ZzExam3Service;
...
public class ZzExam3Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzExam3Dto.Item>>> page(@Valid @ModelAttribute ZzExam3Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzExam3>> create(@Valid @RequestBody ZzExam3 entity) {
