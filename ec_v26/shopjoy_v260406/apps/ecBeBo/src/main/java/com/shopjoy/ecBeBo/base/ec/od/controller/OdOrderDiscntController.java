...
public class OdOrderDiscntController {
    ...
    /* 주문 할인 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<OdOrderDiscntDto.Item>>> page(@Valid @ModelAttribute OdOrderDiscntDto.Request req) {
    ...
    /* 주문 할인 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<OdOrderDiscnt>> save(@PathVariable("id") String id, @Valid @RequestBody OdOrderDiscnt entity) {
    ...
    /* 주문 할인 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<OdOrderDiscnt>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody OdOrderDiscnt entity) {
        entity.setOrderDiscntId(id);
    ...
    public ResponseEntity<ApiResponse<OdOrderDiscnt>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody OdOrderDiscnt entity) {
    ...
    public ResponseEntity<ApiResponse<Void>> saveListCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody List<OdOrderDiscnt> rows) {
        switch (cmd) {
