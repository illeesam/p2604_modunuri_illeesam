...
import com.shopjoy.ecBeBo.base.zz.service.ZzExmy1Service;
...
public class ZzExmy1Controller {
    ...
    /** page — 페이지 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<ZzExmy1Dto.Item>>> page(@Valid @ModelAttribute ZzExmy1Dto.Request req) {
    ...
    /** create — 생성 */
    @PostMapping
    public ResponseEntity<ApiResponse<ZzExmy1>> create(@Valid @RequestBody ZzExmy1 entity) {
    ...
    public ResponseEntity<ApiResponse<ZzExmy1>> update(
            @PathVariable("exmy1Id") String exmy1Id, @Valid @RequestBody ZzExmy1 entity) {
