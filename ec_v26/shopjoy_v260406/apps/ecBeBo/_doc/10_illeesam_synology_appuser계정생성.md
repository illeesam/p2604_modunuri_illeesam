...
| 이 문서의 기준값 | 계정명 `appuser`, 비밀번호 `appuser1**` — 다른 값을 쓴다면 [`scripts/.synology-deploy.env`](../../../scripts/.synology-deploy.env)와 GitHub Actions 시크릿도 그 값에 맞춰 갱신 필요 |
