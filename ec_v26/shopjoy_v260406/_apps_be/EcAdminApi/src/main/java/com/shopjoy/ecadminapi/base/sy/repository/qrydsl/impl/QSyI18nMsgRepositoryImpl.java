...
public class QSyI18nMsgRepositoryImpl implements QSyI18nMsgRepository {
    ...
    /* 다국어 메시지 페이지조회 */
    @Override
    public BasePage<SyI18nMsgDto.Item> selectPageData(SyI18nMsgDto.Request search) {
        ...
        List<SyI18nMsgDto.Item> content = query.clone()
        ...
        BasePage<SyI18nMsgDto.Item> res = new BasePage<>();
        return res.setPageInfo(content, CmUtil.nvlLong(total), pageNo, pageSize, search);
    }

    private BooleanExpression andSearchValue(String searchValue, String searchType) {
        return QdslUtil.searchValueFields(searchValue, searchType, List.of(
            QdslUtil.FieldDef.like("i18nId", syI18nMsg.i18nId),
            QdslUtil.FieldDef.like("i18nMsg", syI18nMsg.i18nMsg),
            QdslUtil.FieldDef.like("i18nMsgId", syI18nMsg.i18nMsgId),
            QdslUtil.FieldDef.like("langCd", syI18nMsg.langCd)
        ));
    }
