...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdClaimRepository;
...
public class QOdClaimRepositoryImpl implements QOdClaimRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdClaimDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  c.claimId));     break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, c.claimId));     break;
            ...
            default:         orders.add(new OrderSpecifier(Order.DESC, c.requestDate)); break;
        }
        return orders;
    }
