...
import com.shopjoy.ecadminapi.base.ec.pm.repository.QPmDiscntUsageRepository;
...
public class QPmDiscntUsageRepositoryImpl implements QPmDiscntUsageRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(PmDiscntUsageDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  u.discntUsageId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, u.discntUsageId)); break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  u.discntNm));      break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, u.discntNm));      break;
