...
import com.shopjoy.ecadminapi.base.ec.mb.repository.QMbMemberGroupRepository;
...
public class QMbMemberGroupRepositoryImpl implements QMbMemberGroupRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(MbMemberGroupDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  g.memberGroupId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, g.memberGroupId)); break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  g.groupNm));       break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, g.groupNm));       break;
