...
public class QCmPathRepositoryImpl implements QCmPathRepository {
    ...
    public List<CmPathDto.Item> selectList(CmPathDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(cmPath.useYn, search.getUseYn()));
        wheres.add(QdslUtil.strEq(cmPath.bizCd, search.getBizCd()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(cmPath.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(cmPath.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<CmPathDto.Item> selectPageData(CmPathDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(cmPath.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(cmPath.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
