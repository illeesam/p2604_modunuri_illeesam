...
public class QStSettleEtcAdjRepositoryImpl implements QStSettleEtcAdjRepository {
    ...
    public List<StSettleEtcAdjDto.Item> selectList(StSettleEtcAdjDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettleEtcAdj.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettleEtcAdj.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
