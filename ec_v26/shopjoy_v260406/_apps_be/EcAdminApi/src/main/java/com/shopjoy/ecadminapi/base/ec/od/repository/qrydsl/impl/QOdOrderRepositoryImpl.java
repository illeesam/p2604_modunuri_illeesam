...
public class QOdOrderRepositoryImpl implements QOdOrderRepository {
    ...
    public List<OdOrderDto.Item> selectList(OdOrderDto.Request search) {
        ...
        if ("reg_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odOrder.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odOrder.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("pay_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odOrder.payDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("dliv_ship_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odOrder.dlivShipDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(odOrder.orderDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // order_date (기본)
        }
    ...
    public BasePage<OdOrderDto.Item> selectPageData(OdOrderDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odOrder.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odOrder.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("pay_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odOrder.payDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("dliv_ship_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odOrder.dlivShipDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("order_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odOrder.orderDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
