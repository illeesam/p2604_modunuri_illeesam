...
public class QOdhOrderStatusHistRepositoryImpl implements QOdhOrderStatusHistRepository {
    ...
    /* siteId 정확 일치 */
    private BooleanExpression andSiteIdEq(OdhOrderStatusHistDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? odhOrderStatusHist.siteId.eq(search.getSiteId()) : null;
    }

    /* orderStatusHistId 정확 일치 */
    private BooleanExpression andOrderStatusHistIdEq(OdhOrderStatusHistDto.Request search) {
