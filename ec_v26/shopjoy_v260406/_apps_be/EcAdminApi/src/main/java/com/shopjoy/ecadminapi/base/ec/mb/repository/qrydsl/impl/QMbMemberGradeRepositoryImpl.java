...
public class QMbMemberGradeRepositoryImpl implements QMbMemberGradeRepository {
    ...
    public List<MbMemberGradeDto.Item> selectList(MbMemberGradeDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(mbMemberGrade.memberGradeId, search.getMemberGradeId()));
        wheres.add(QdslUtil.strEq(mbMemberGrade.useYn, search.getUseYn()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(mbMemberGrade.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(mbMemberGrade.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<MbMemberGradeDto.Item> selectPageData(MbMemberGradeDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(mbMemberGrade.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(mbMemberGrade.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
