...
public class QCmBlogTagRepositoryImpl implements QCmBlogTagRepository {
    ...
    public List<CmBlogTagDto.Item> selectList(CmBlogTagDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(cmBlogTag.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(cmBlogTag.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
