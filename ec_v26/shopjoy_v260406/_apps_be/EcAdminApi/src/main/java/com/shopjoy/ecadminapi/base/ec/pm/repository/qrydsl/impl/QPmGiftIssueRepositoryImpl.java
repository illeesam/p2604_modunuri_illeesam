...
public class QPmGiftIssueRepositoryImpl implements QPmGiftIssueRepository {
    ...
    public List<PmGiftIssueDto.Item> selectList(PmGiftIssueDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pmGiftIssue.giftIssueId, search.getGiftIssueId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("reg_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pmGiftIssue.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pmGiftIssue.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pmGiftIssue.issueDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // issue_date (기본)
        }
    ...
    public BasePage<PmGiftIssueDto.Item> selectPageData(PmGiftIssueDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pmGiftIssue.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pmGiftIssue.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("issue_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pmGiftIssue.issueDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
