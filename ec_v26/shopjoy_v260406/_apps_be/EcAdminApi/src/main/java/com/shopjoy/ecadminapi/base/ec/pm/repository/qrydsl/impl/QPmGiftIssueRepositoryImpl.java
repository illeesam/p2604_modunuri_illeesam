...
public class QPmGiftIssueRepositoryImpl implements QPmGiftIssueRepository {
    ...
    public List<PmGiftIssueDto.Item> selectList(PmGiftIssueDto.Request search) {
        ...
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmGiftIssue.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmGiftIssue.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("issue_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmGiftIssue.issueDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
