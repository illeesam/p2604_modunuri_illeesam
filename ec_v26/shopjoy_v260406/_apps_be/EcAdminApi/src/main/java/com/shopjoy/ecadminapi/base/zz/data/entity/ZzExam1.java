...
public class ZzExam1 extends BaseEntity {
    ...
    @Size(max = 200, message = "col11 는 200자 이내여야 합니다.")
    private String col11;

    @Column(name = "col12", length = 200)
    @Size(max = 200, message = "col12 는 200자 이내여야 합니다.")
    private String col12;

    @Column(name = "col13", length = 200)
    @Size(max = 200, message = "col13 는 200자 이내여야 합니다.")
    private String col13;

    @Column(name = "col14", length = 200)
    @Size(max = 200, message = "col14 는 200자 이내여야 합니다.")
    private String col14;

    @Column(name = "col15", length = 200)
    @Size(max = 200, message = "col15 는 200자 이내여야 합니다.")
