...
import com.shopjoy.ecadminapi.base.ec.pm.repository.QPmEventItemRepository;
...
public class QPmEventItemRepositoryImpl implements QPmEventItemRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(PmEventItemDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  i.eventItemId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, i.eventItemId)); break;
