...
public class QPdProdContentRepositoryImpl implements QPdProdContentRepository {
    ...
    public List<PdProdContentDto.Item> selectList(PdProdContentDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pdProdContent.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pdProdContent.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
