...
import com.shopjoy.ecadminapi.base.ec.pd.repository.QPdhProdViewLogRepository;
...
public class QPdhProdViewLogRepositoryImpl implements QPdhProdViewLogRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(PdhProdViewLogDto.Request s) {
        ...
        switch (sort) {
            ...
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  l.refNm));   break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, l.refNm));   break;
