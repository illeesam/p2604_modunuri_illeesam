...
public class QSyhAccessErrorLogRepositoryImpl implements QSyhAccessErrorLogRepository {
    ...
    private BooleanBuilder buildCondition(SyhAccessErrorLogDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",errorType,")) or.or(l.errorType.likeIgnoreCase(pattern));
            ...
            if (__all || __types.contains(",loggerNm,")) or.or(l.loggerNm.likeIgnoreCase(pattern));
            ...
            if (__all || __types.contains(",stackTrace,")) or.or(l.stackTrace.likeIgnoreCase(pattern));
