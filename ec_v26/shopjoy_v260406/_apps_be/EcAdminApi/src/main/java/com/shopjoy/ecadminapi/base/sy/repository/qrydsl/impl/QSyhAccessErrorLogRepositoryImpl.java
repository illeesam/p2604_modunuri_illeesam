...
public class QSyhAccessErrorLogRepositoryImpl implements QSyhAccessErrorLogRepository {
    ...
    private BooleanBuilder buildCondition(SyhAccessErrorLogDto.Request s) {
        ...
        /* searchValue LIKE OR — QSyhAccessErrorLog 의 String 필드 (감사필드 제외) */
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            or.or(l.errorType.likeIgnoreCase(pattern));
            ...
            or.or(l.loggerNm.likeIgnoreCase(pattern));
            ...
            or.or(l.stackTrace.likeIgnoreCase(pattern));
