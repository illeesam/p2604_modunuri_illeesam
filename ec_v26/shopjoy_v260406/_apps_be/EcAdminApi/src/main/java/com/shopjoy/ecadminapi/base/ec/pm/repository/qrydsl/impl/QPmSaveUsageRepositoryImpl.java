...
public class QPmSaveUsageRepositoryImpl implements QPmSaveUsageRepository {
    ...
    public List<PmSaveUsageDto.Item> selectList(PmSaveUsageDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmSaveUsage.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmSaveUsage.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
