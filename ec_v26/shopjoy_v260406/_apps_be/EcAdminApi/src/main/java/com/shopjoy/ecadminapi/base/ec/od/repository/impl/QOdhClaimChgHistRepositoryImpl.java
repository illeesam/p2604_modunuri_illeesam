...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdhClaimChgHistRepository;
...
public class QOdhClaimChgHistRepositoryImpl implements QOdhClaimChgHistRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdhClaimChgHistDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  h.claimChgHistId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, h.claimChgHistId)); break;
