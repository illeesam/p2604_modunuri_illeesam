...
public class QOdOrderItemDiscntRepositoryImpl implements QOdOrderItemDiscntRepository {
    ...
    private BooleanBuilder buildCondition(OdOrderItemDiscntDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",couponId,")) or.or(d.couponId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",couponIssueId,")) or.or(d.couponIssueId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",discntTypeCd,")) or.or(d.discntTypeCd.likeIgnoreCase(pattern));
            if (__all || __types.contains(",itemDiscntId,")) or.or(d.itemDiscntId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",orderId,")) or.or(d.orderId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",orderItemId,")) or.or(d.orderItemId.likeIgnoreCase(pattern));
