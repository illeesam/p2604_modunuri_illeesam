...
public class QStSettlePayRepositoryImpl implements QStSettlePayRepository {
    ...
    public List<StSettlePayDto.Item> selectList(StSettlePayDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(stSettlePay.settlePayId, search.getSettlePayId()));
        wheres.add(QdslUtil.strEq(stSettlePay.payStatusCd, search.getPayStatusCd()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(stSettlePay.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(stSettlePay.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<StSettlePayDto.Item> selectPageData(StSettlePayDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stSettlePay.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stSettlePay.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
