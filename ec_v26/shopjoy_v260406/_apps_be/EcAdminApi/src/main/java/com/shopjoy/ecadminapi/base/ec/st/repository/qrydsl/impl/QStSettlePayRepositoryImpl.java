...
public class QStSettlePayRepositoryImpl implements QStSettlePayRepository {
    ...
    public List<StSettlePayDto.Item> selectList(StSettlePayDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettlePay.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettlePay.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
