...
public class QSyhApiLogRepositoryImpl implements QSyhApiLogRepository {
    ...
    public List<SyhApiLogDto.Item> selectList(SyhApiLogDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syhApiLog.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syhApiLog.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
