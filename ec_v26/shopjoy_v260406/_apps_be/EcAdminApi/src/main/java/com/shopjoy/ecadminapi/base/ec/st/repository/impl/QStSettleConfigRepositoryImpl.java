...
import com.shopjoy.ecadminapi.base.ec.st.repository.QStSettleConfigRepository;
...
public class QStSettleConfigRepositoryImpl implements QStSettleConfigRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(StSettleConfigDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  c.settleConfigId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, c.settleConfigId)); break;
