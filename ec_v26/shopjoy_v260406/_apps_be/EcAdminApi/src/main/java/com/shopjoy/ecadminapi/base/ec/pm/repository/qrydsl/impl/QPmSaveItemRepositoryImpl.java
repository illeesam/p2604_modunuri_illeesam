...
public class QPmSaveItemRepositoryImpl implements QPmSaveItemRepository {
    ...
    private BooleanExpression andDateRangeBetween(PmSaveItemDto.Request search) {
        if (search == null
