...
public class QPmPlanItemRepositoryImpl implements QPmPlanItemRepository {
    ...
    public List<PmPlanItemDto.Item> selectList(PmPlanItemDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pmPlanItem.planItemId, search.getPlanItemId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pmPlanItem.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pmPlanItem.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<PmPlanItemDto.Item> selectPageData(PmPlanItemDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pmPlanItem.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pmPlanItem.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
