...
public class QStReconRepositoryImpl implements QStReconRepository {
    ...
    public List<StReconDto.Item> selectList(StReconDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stRecon.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stRecon.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
