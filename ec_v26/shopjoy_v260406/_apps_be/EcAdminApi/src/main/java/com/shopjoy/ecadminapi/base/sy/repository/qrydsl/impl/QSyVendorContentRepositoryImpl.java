...
public class QSyVendorContentRepositoryImpl implements QSyVendorContentRepository {
    ...
    public List<SyVendorContentDto.Item> selectList(SyVendorContentDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syVendorContent.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syVendorContent.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
