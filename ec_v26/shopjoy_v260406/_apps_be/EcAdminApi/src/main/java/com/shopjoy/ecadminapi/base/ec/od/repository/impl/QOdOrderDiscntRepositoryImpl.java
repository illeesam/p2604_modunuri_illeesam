...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdOrderDiscntRepository;
...
public class QOdOrderDiscntRepositoryImpl implements QOdOrderDiscntRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdOrderDiscntDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  d.orderDiscntId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, d.orderDiscntId)); break;
