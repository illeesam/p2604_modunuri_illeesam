...
public class QOdPayRepositoryImpl implements QOdPayRepository {
    ...
    public List<OdPayDto.Item> selectList(OdPayDto.Request search) {
        ...
        if ("reg_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odPay.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odPay.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(odPay.payDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // pay_date (기본)
        }
    ...
    public BasePage<OdPayDto.Item> selectPageData(OdPayDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odPay.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odPay.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("pay_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odPay.payDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
