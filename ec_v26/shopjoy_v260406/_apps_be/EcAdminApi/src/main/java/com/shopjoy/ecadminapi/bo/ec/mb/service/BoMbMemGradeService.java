...
public class BoMbMemGradeService {
    ...
    /* 페이지조회 */
    public BasePage<MbMemberGradeDto.Item> getPageData(MbMemberGradeDto.Request req) { return mbMemberGradeService.getPageData(req); }
    ...
    @Transactional public void saveListBase(List<MbMemberGrade> rows) { mbMemberGradeService.saveListBase(rows); }
}
