...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdClaimItemRepository;
...
public class QOdClaimItemRepositoryImpl implements QOdClaimItemRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdClaimItemDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  i.claimItemId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, i.claimItemId)); break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  i.prodNm));      break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, i.prodNm));      break;
