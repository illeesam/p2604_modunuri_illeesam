...
public class QCmChattRoomRepositoryImpl implements QCmChattRoomRepository {
    ...
    /** 페이지 목록 */
    @Override
    public BasePage<CmChattRoomDto.Item> selectPageData(CmChattRoomDto.Request search) {
        ...
        List<CmChattRoomDto.Item> content = query.clone()
        ...
        BasePage<CmChattRoomDto.Item> res = new BasePage<>();
