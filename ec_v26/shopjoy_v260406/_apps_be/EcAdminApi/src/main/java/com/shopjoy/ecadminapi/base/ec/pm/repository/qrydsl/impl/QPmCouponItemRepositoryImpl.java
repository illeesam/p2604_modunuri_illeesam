...
public class QPmCouponItemRepositoryImpl implements QPmCouponItemRepository {
    ...
    private BooleanBuilder buildCondition(PmCouponItemDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",couponId,")) or.or(i.couponId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",couponItemId,")) or.or(i.couponItemId.likeIgnoreCase(pattern));
