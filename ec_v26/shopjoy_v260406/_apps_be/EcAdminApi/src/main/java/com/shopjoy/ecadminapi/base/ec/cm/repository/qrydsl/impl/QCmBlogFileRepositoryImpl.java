...
public class QCmBlogFileRepositoryImpl implements QCmBlogFileRepository {
    ...
    public List<CmBlogFileDto.Item> selectList(CmBlogFileDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(cmBlogFile.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(cmBlogFile.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
