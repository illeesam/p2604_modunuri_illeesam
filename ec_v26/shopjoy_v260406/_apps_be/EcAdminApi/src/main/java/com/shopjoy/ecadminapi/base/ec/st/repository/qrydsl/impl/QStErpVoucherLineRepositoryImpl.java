...
public class QStErpVoucherLineRepositoryImpl implements QStErpVoucherLineRepository {
    ...
    public List<StErpVoucherLineDto.Item> selectList(StErpVoucherLineDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(stErpVoucherLine.erpVoucherLineId, search.getErpVoucherLineId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(stErpVoucherLine.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(stErpVoucherLine.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<StErpVoucherLineDto.Item> selectPageData(StErpVoucherLineDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stErpVoucherLine.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stErpVoucherLine.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
