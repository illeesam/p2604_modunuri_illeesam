...
import com.shopjoy.ecadminapi.base.sy.repository.QSyBbsRepository;
...
public class QSyBbsRepositoryImpl implements QSyBbsRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(SyBbsDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  b.bbsId));    break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, b.bbsId));    break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  b.authorNm)); break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, b.authorNm)); break;
