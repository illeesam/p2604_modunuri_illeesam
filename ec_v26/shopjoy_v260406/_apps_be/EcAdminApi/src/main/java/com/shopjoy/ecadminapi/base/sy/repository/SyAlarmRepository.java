...
public interface SyAlarmRepository extends JpaRepository<SyAlarm, String>, QSyAlarmRepository {
    ...
    @Query(value = """
            /* com.shopjoy.ecadminapi.base.sy.repository.SyAlarmRepository :: findPathSyAlarmTreeNodeCounts() */
            ...
            """, nativeQuery = true)
    List<Object[]> findPathSyAlarmTreeNodeCounts(@Param("bizCd")     String bizCd,
