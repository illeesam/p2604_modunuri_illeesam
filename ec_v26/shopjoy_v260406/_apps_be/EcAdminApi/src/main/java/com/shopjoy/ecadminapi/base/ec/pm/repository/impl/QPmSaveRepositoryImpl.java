...
import com.shopjoy.ecadminapi.base.ec.pm.repository.QPmSaveRepository;
...
public class QPmSaveRepositoryImpl implements QPmSaveRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(PmSaveDto.Request search) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  s.saveId));  break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, s.saveId));  break;
