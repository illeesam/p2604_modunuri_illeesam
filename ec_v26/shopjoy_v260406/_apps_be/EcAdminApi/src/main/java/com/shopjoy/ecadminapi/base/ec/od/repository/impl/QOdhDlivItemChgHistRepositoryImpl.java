...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdhDlivItemChgHistRepository;
...
public class QOdhDlivItemChgHistRepositoryImpl implements QOdhDlivItemChgHistRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdhDlivItemChgHistDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  h.dlivItemChgHistId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, h.dlivItemChgHistId)); break;
