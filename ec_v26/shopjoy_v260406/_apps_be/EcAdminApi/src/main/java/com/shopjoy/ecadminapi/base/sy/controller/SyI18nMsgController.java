...
public class SyI18nMsgController {
    ...
    /* 다국어 메시지 페이지조회 */
    @GetMapping("/page")
    public ResponseEntity<ApiResponse<BasePage<SyI18nMsgDto.Item>>> page(@Valid @ModelAttribute SyI18nMsgDto.Request req) {
    ...
    public ResponseEntity<ApiResponse<SyI18nMsg>> saveOneCmd(
            @PathVariable("cmd") String cmd, @RequestBody SyI18nMsg entity) {
        SyI18nMsg result = switch (cmd) {
