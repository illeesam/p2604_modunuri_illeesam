...
public class QSyNotiRepositoryImpl implements QSyNotiRepository {
    ...
    public List<SyNotiDto.Item> selectList(SyNotiDto.Request search) {
        ...
        JPAQuery<SyNotiDto.Item> query = baseSelColumnQuery()
                ...
                .where(
                    QdslUtil.strEq(syNoti.notiId, search.getNotiId()),
                    QdslUtil.strEq(syNoti.recvTypeCd, search.getRecvTypeCd()),
                    QdslUtil.strEq(syNoti.recvId, search.getRecvId()),
                    QdslUtil.strEq(syNoti.notiTypeCd, search.getNotiTypeCd()),
                    QdslUtil.strEq(syNoti.channelCd, search.getChannelCd()),
                    QdslUtil.strEq(syNoti.readYn, search.getReadYn()),
                    QdslUtil.strEq(syNoti.regSiteId, search.getSiteId()),
