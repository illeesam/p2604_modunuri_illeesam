...
import com.shopjoy.ecadminapi.base.ec.pm.repository.QPmVoucherRepository;
...
public class QPmVoucherRepositoryImpl implements QPmVoucherRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(PmVoucherDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  v.voucherId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, v.voucherId)); break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  v.voucherNm)); break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, v.voucherNm)); break;
