...
import com.shopjoy.ecadminapi.base.ec.cm.repository.QCmBlogTagRepository;
...
public class QCmBlogTagRepositoryImpl implements QCmBlogTagRepository {
    ...
    private BooleanBuilder buildCondition(CmBlogTagDto.Request s) {
        ...
        // searchValue + searchTypes (def_tag_nm)
    ...
    private List<OrderSpecifier<?>> buildOrder(CmBlogTagDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  t.blogTagId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, t.blogTagId)); break;
