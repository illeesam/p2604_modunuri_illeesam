...
public class QPmCouponUsageRepositoryImpl implements QPmCouponUsageRepository {
    ...
    /* siteId 정확 일치 */
    private BooleanExpression andSiteId(PmCouponUsageDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? u.siteId.eq(search.getSiteId()) : null;
    }

    /* usageId 정확 일치 */
    private BooleanExpression andUsageId(PmCouponUsageDto.Request search) {
        return search != null && StringUtils.hasText(search.getUsageId())
                ? u.usageId.eq(search.getUsageId()) : null;
    }

    /* 기간 — dateType + dateStart + dateEnd (yyyy-MM-dd, 끝일 포함) */
    private BooleanExpression andDateRange(PmCouponUsageDto.Request search) {
        if (search == null
    ...
    private BooleanExpression andSearchValue(PmCouponUsageDto.Request search) {
