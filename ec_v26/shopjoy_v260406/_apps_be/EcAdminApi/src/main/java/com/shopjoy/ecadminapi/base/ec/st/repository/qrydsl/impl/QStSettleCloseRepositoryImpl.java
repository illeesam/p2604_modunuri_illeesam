...
public class QStSettleCloseRepositoryImpl implements QStSettleCloseRepository {
    ...
    public List<StSettleCloseDto.Item> selectList(StSettleCloseDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(stSettleClose.settleCloseId, search.getSettleCloseId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(stSettleClose.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(stSettleClose.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<StSettleCloseDto.Item> selectPageData(StSettleCloseDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stSettleClose.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stSettleClose.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
