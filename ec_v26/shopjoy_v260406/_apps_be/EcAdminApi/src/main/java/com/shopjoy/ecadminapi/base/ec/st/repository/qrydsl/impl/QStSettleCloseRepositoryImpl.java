...
public class QStSettleCloseRepositoryImpl implements QStSettleCloseRepository {
    ...
    public List<StSettleCloseDto.Item> selectList(StSettleCloseDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettleClose.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettleClose.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
