...
public class QPdRestockNotiRepositoryImpl implements QPdRestockNotiRepository {
    ...
    /* siteId 정확 일치 */
    private BooleanExpression andSiteIdEq(PdRestockNotiDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? pdRestockNoti.siteId.eq(search.getSiteId()) : null;
    }

    /* restockNotiId 정확 일치 */
    private BooleanExpression andRestockNotiIdEq(PdRestockNotiDto.Request search) {
    ...
    /* prodId 정확 일치 */
    private BooleanExpression andProdIdEq(PdRestockNotiDto.Request search) {
    ...
    private BooleanExpression andNotiYnEq(PdRestockNotiDto.Request search) {
        return search != null && StringUtils.hasText(search.getNotiYn())
                ? pdRestockNoti.notiYn.eq(search.getNotiYn()) : null;
    }

    /* 기간 — dateType + dateStart + dateEnd (yyyy-MM-dd, 끝일 포함) */
    private BooleanExpression andDateRangeBetween(PdRestockNotiDto.Request search) {
        if (search == null
