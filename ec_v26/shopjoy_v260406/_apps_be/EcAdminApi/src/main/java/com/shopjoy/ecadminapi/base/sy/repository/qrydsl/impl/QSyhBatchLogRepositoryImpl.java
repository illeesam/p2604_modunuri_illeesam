...
public class QSyhBatchLogRepositoryImpl implements QSyhBatchLogRepository {
    ...
    public List<SyhBatchLogDto.Item> selectList(SyhBatchLogDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(syhBatchLog.batchLogId, search.getBatchLogId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(syhBatchLog.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(syhBatchLog.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<SyhBatchLogDto.Item> selectPageData(SyhBatchLogDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syhBatchLog.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syhBatchLog.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
