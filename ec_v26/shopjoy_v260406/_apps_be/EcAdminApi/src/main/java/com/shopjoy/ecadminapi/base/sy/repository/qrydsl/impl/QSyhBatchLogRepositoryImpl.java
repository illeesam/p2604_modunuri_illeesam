...
public class QSyhBatchLogRepositoryImpl implements QSyhBatchLogRepository {
    ...
    public List<SyhBatchLogDto.Item> selectList(SyhBatchLogDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syhBatchLog.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syhBatchLog.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
