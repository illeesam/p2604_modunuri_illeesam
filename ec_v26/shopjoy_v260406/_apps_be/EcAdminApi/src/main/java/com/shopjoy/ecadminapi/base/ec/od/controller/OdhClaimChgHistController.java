...
public class OdhClaimChgHistController {
    ...
    @PostMapping("/save")
    public ResponseEntity<ApiResponse<OdhClaimChgHist>> saveDefault(@RequestBody OdhClaimChgHist entity) {
        return ResponseEntity.ok(ApiResponse.ok(service.save("base", entity), "저장되었습니다."));
    }

    /** save -- rowStatus 단건 분기 저장 (cmd 변형) */
    @PostMapping("/save/{cmd}")
    public ResponseEntity<ApiResponse<OdhClaimChgHist>> saveCmd(
