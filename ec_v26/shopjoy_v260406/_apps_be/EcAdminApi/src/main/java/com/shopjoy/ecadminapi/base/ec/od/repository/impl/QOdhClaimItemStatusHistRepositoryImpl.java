...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdhClaimItemStatusHistRepository;
...
public class QOdhClaimItemStatusHistRepositoryImpl implements QOdhClaimItemStatusHistRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdhClaimItemStatusHistDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  h.claimItemStatusHistId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, h.claimItemStatusHistId)); break;
