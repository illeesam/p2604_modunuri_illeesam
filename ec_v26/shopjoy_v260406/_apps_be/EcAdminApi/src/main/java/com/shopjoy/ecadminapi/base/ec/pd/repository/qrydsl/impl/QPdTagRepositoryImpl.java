...
public class QPdTagRepositoryImpl implements QPdTagRepository {
    ...
    public List<PdTagDto.Item> selectList(PdTagDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pdTag.tagId, search.getTagId()));
        wheres.add(QdslUtil.strEq(pdTag.useYn, search.getUseYn()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pdTag.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pdTag.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<PdTagDto.Item> selectPageData(PdTagDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdTag.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdTag.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
        ...
        List<PdTagDto.Item> content = query.clone()
