...
public class QPmEventItemRepositoryImpl implements QPmEventItemRepository {
    ...
    /* eventId IN */
    private BooleanExpression andEventIdsIn(PmEventItemDto.Request search) {
        return search != null && !CollectionUtils.isEmpty(search.getEventIds())
                ? pmEventItem.eventId.in(search.getEventIds()) : null;
    }

    /* eventId 정확 일치 */
    private BooleanExpression andEventIdEq(PmEventItemDto.Request search) {
        return search != null && StringUtils.hasText(search.getEventId())
                ? pmEventItem.eventId.eq(search.getEventId()) : null;
    }

    /* siteId 정확 일치 */
    private BooleanExpression andSiteIdEq(PmEventItemDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? pmEventItem.siteId.eq(search.getSiteId()) : null;
    }

    /* eventItemId 정확 일치 */
    private BooleanExpression andEventItemIdEq(PmEventItemDto.Request search) {
    ...
    private BooleanExpression andDateRangeBetween(PmEventItemDto.Request search) {
        if (search == null
