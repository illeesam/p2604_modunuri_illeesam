...
public class QPmEventItemRepositoryImpl implements QPmEventItemRepository {
    ...
    private BooleanBuilder buildCondition(PmEventItemDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",eventId,")) or.or(i.eventId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",eventItemId,")) or.or(i.eventItemId.likeIgnoreCase(pattern));
