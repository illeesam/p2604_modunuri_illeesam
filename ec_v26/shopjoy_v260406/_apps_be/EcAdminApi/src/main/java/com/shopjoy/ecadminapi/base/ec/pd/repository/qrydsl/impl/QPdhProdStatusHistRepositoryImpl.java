...
public class QPdhProdStatusHistRepositoryImpl implements QPdhProdStatusHistRepository {
    ...
    public List<PdhProdStatusHistDto.Item> selectList(PdhProdStatusHistDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pdhProdStatusHist.prodStatusHistId, search.getProdStatusHistId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pdhProdStatusHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pdhProdStatusHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    /* 상품 상태 이력 페이지조회 */
    @Override
    public BasePage<PdhProdStatusHistDto.Item> selectPageData(PdhProdStatusHistDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdhProdStatusHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdhProdStatusHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
