...
public class QPdProdSkuRepositoryImpl implements QPdProdSkuRepository {
    ...
    public List<PdProdSkuDto.Item> selectList(PdProdSkuDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pdProdSku.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pdProdSku.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
