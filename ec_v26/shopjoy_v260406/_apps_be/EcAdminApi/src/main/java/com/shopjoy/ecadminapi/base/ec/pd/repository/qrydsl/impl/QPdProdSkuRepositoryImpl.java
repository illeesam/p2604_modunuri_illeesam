...
public class QPdProdSkuRepositoryImpl implements QPdProdSkuRepository {
    ...
    public List<PdProdSkuDto.Item> selectList(PdProdSkuDto.Request search) {
        ...
        wheres.add(QdslUtil.strIn(pdProdSku.prodId, search.getProdIds()));
        wheres.add(QdslUtil.strEq(pdProdSku.prodId, search.getProdId()));
        wheres.add(QdslUtil.strEq(pdProdSku.prodSkuId, search.getProdSkuId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pdProdSku.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pdProdSku.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<PdProdSkuDto.Item> selectPageData(PdProdSkuDto.Request search) {
        ...
        whereList.add(QdslUtil.strIn(pdProdSku.prodId, search.getProdIds()));
        whereList.add(QdslUtil.strEq(pdProdSku.prodId, search.getProdId()));
        whereList.add(QdslUtil.strEq(pdProdSku.prodSkuId, search.getProdSkuId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdProdSku.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdProdSku.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
