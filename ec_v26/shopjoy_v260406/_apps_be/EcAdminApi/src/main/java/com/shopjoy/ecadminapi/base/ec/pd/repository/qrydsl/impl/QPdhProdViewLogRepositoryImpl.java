...
public class QPdhProdViewLogRepositoryImpl implements QPdhProdViewLogRepository {
    ...
    /* siteId 정확 일치 */
    private BooleanExpression andSiteIdEq(PdhProdViewLogDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? pdhProdViewLog.siteId.eq(search.getSiteId()) : null;
    }

    /* logId 정확 일치 */
    private BooleanExpression andLogIdEq(PdhProdViewLogDto.Request search) {
        return search != null && StringUtils.hasText(search.getLogId())
                ? pdhProdViewLog.logId.eq(search.getLogId()) : null;
    }

    /* 기간 — dateType + dateStart + dateEnd (yyyy-MM-dd, 끝일 포함) */
    private BooleanExpression andDateRangeBetween(PdhProdViewLogDto.Request search) {
        if (search == null
