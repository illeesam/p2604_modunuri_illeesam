...
public class QPdProdQnaRepositoryImpl implements QPdProdQnaRepository {
    ...
    public List<PdProdQnaDto.Item> selectList(PdProdQnaDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pdProdQna.prodQnaId, search.getProdQnaId()));
        wheres.add(QdslUtil.strEq(pdProdQna.prodId, search.getProdId()));
        wheres.add(QdslUtil.strEq(pdProdQna.answYn, search.getAnswYn()));
        wheres.add(QdslUtil.strEq(pdProdQna.useYn, search.getUseYn()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pdProdQna.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pdProdQna.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<PdProdQnaDto.Item> selectPageData(PdProdQnaDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdProdQna.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdProdQna.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
