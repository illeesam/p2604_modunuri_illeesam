...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdhOrderChgHistRepository;
...
public class QOdhOrderChgHistRepositoryImpl implements QOdhOrderChgHistRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdhOrderChgHistDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  h.orderChgHistId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, h.orderChgHistId)); break;
