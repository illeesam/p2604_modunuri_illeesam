...
public class QZzSample1RepositoryImpl implements QZzSample1Repository {
    ...
    public List<ZzSample1Dto.Item> selectList(ZzSample1Dto.Request search) {
        ...
        wheres.add(QdslUtil.strIn(zzSample1.sample1Id, search.getSample1Ids()));
        wheres.add(QdslUtil.strEq(zzSample1.sample1Id, search.getSample1Id()));
        wheres.add(QdslUtil.strEq(zzSample1.useYn, search.getUseYn()));
