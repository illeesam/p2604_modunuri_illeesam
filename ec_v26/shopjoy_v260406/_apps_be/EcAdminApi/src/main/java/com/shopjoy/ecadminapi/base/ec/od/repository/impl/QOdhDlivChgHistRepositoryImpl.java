...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdhDlivChgHistRepository;
...
public class QOdhDlivChgHistRepositoryImpl implements QOdhDlivChgHistRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdhDlivChgHistDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  h.dlivChgHistId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, h.dlivChgHistId)); break;
