...
import com.shopjoy.ecadminapi.base.ec.od.repository.QOdhDlivStatusHistRepository;
...
public class QOdhDlivStatusHistRepositoryImpl implements QOdhDlivStatusHistRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(OdhDlivStatusHistDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  h.dlivStatusHistId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, h.dlivStatusHistId)); break;
