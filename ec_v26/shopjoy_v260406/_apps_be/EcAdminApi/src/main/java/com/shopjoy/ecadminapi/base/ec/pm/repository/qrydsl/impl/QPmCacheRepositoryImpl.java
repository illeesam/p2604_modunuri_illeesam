...
public class QPmCacheRepositoryImpl implements QPmCacheRepository {
    ...
    public List<PmCacheDto.Item> selectList(PmCacheDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmCache.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmCache.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
