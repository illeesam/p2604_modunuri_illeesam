...
public class QPmCacheRepositoryImpl implements QPmCacheRepository {
    ...
    public List<PmCacheDto.Item> selectList(PmCacheDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pmCache.cacheId, search.getCacheId()));
        wheres.add(QdslUtil.strEq(pmCache.cacheTypeCd, search.getCacheTypeCd()));
        wheres.add(QdslUtil.strEq(pmCache.memberId, search.getMemberId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pmCache.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pmCache.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<PmCacheDto.Item> selectPageData(PmCacheDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pmCache.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pmCache.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
