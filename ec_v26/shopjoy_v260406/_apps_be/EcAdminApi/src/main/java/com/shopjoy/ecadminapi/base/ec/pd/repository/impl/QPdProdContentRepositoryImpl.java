...
import com.shopjoy.ecadminapi.base.ec.pd.repository.QPdProdContentRepository;
...
public class QPdProdContentRepositoryImpl implements QPdProdContentRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(PdProdContentDto.Request req) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  c.prodContentId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, c.prodContentId)); break;
