...
public class QCmBlogCateRepositoryImpl implements QCmBlogCateRepository {
    ...
    public List<CmBlogCateDto.Item> selectList(CmBlogCateDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(cmBlogCate.blogCateId, search.getBlogCateId()));
        wheres.add(QdslUtil.strEq(cmBlogCate.useYn, search.getUseYn()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(cmBlogCate.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(cmBlogCate.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<CmBlogCateDto.Item> selectPageData(CmBlogCateDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(cmBlogCate.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(cmBlogCate.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
