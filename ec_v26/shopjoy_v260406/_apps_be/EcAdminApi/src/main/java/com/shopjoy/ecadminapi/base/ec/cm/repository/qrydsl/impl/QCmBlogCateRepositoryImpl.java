...
public class QCmBlogCateRepositoryImpl implements QCmBlogCateRepository {
    ...
    /* siteId 정확 일치 */
    private BooleanExpression andSiteIdEq(CmBlogCateDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? cmBlogCate.siteId.eq(search.getSiteId()) : null;
    }

    /* blogCateId 정확 일치 */
    private BooleanExpression andBlogCateIdEq(CmBlogCateDto.Request search) {
        return search != null && StringUtils.hasText(search.getBlogCateId())
                ? cmBlogCate.blogCateId.eq(search.getBlogCateId()) : null;
    }

    /* useYn 정확 일치 */
    private BooleanExpression andUseYnEq(CmBlogCateDto.Request search) {
        return search != null && StringUtils.hasText(search.getUseYn())
                ? cmBlogCate.useYn.eq(search.getUseYn()) : null;
    }

    /* 기간 — dateType + dateStart + dateEnd (yyyy-MM-dd, 끝일 포함) */
    private BooleanExpression andDateRangeBetween(CmBlogCateDto.Request search) {
        if (search == null
