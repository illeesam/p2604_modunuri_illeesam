...
public class QStSettleRepositoryImpl implements QStSettleRepository {
    ...
    public List<StSettleDto.Item> selectList(StSettleDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettle.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(stSettle.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
