...
public class PmEventController {
    ...
    /* 이벤트 저장 */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PmEvent>> save(@PathVariable("id") String id, @Valid @RequestBody PmEvent entity) {
    ...
    /* 이벤트 수정 */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PmEvent>> updateSelective(@PathVariable("id") String id, @Valid @RequestBody PmEvent entity) {
        entity.setEventId(id);
    ...
    public ResponseEntity<ApiResponse<PmEvent>> saveOneCmd(
            @PathVariable("cmd") String cmd, @Valid @RequestBody PmEvent entity) {
