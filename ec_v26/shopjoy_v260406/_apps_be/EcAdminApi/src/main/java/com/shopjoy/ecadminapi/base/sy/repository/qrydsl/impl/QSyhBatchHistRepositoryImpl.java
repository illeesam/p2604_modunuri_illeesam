...
public class QSyhBatchHistRepositoryImpl implements QSyhBatchHistRepository {
    ...
    /* siteId 정확 일치 */
    private BooleanExpression andSiteIdEq(SyhBatchHistDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? syhBatchHist.siteId.eq(search.getSiteId()) : null;
    }

    /* batchHistId 정확 일치 */
    private BooleanExpression andBatchHistIdEq(SyhBatchHistDto.Request search) {
    ...
    private BooleanExpression andDateRangeBetween(SyhBatchHistDto.Request search) {
        if (search == null
