...
public class QSyhBatchHistRepositoryImpl implements QSyhBatchHistRepository {
    ...
    public List<SyhBatchHistDto.Item> selectList(SyhBatchHistDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(syhBatchHist.batchHistId, search.getBatchHistId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(syhBatchHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(syhBatchHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<SyhBatchHistDto.Item> selectPageData(SyhBatchHistDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syhBatchHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syhBatchHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
