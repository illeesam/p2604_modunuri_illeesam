...
public class QSyhBatchHistRepositoryImpl implements QSyhBatchHistRepository {
    ...
    public List<SyhBatchHistDto.Item> selectList(SyhBatchHistDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syhBatchHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syhBatchHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
