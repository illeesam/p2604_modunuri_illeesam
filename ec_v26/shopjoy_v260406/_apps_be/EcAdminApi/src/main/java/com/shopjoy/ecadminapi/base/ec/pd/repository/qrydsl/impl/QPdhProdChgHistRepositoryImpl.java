...
public class QPdhProdChgHistRepositoryImpl implements QPdhProdChgHistRepository {
    ...
    public List<PdhProdChgHistDto.Item> selectList(PdhProdChgHistDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pdhProdChgHist.prodChgHistId, search.getProdChgHistId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pdhProdChgHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pdhProdChgHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<PdhProdChgHistDto.Item> selectPageData(PdhProdChgHistDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdhProdChgHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdhProdChgHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
