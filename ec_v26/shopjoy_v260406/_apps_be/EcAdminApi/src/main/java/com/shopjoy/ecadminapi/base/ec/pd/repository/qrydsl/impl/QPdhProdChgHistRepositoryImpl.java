...
public class QPdhProdChgHistRepositoryImpl implements QPdhProdChgHistRepository {
    ...
    public List<PdhProdChgHistDto.Item> selectList(PdhProdChgHistDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pdhProdChgHist.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pdhProdChgHist.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
