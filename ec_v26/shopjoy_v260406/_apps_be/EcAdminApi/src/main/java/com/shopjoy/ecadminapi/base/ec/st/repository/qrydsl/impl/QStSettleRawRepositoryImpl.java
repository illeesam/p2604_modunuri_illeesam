...
public class QStSettleRawRepositoryImpl implements QStSettleRawRepository {
    ...
    public List<StSettleRawDto.Item> selectList(StSettleRawDto.Request search) {
        ...
        if ("reg_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(stSettleRaw.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(stSettleRaw.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(stSettleRaw.orderDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // order_date (기본)
        }
    ...
    /* 정산 원천 데이터 페이지조회 */
    @Override
    public BasePage<StSettleRawDto.Item> selectPageData(StSettleRawDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stSettleRaw.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stSettleRaw.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("order_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stSettleRaw.orderDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
