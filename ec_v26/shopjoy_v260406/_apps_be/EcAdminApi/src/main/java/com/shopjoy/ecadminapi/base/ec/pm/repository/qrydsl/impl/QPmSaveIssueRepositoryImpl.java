...
public class QPmSaveIssueRepositoryImpl implements QPmSaveIssueRepository {
    ...
    public List<PmSaveIssueDto.Item> selectList(PmSaveIssueDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmSaveIssue.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(pmSaveIssue.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
