...
public class QSyhSendEmailLogRepositoryImpl implements QSyhSendEmailLogRepository {
    ...
    public List<SyhSendEmailLogDto.Item> selectList(SyhSendEmailLogDto.Request search) {
        ...
        if ("reg_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(syhSendEmailLog.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(syhSendEmailLog.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(syhSendEmailLog.sendDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // send_date (기본)
        }
    ...
    public BasePage<SyhSendEmailLogDto.Item> selectPageData(SyhSendEmailLogDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syhSendEmailLog.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syhSendEmailLog.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("send_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syhSendEmailLog.sendDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
