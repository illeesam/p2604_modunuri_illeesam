...
public class QOdRefundRepositoryImpl implements QOdRefundRepository {
    ...
    public List<OdRefundDto.Item> selectList(OdRefundDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(odRefund.refundId, search.getRefundId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odRefund.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(odRefund.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<OdRefundDto.Item> selectPageData(OdRefundDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odRefund.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odRefund.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
