...
public class QPdProdSetItemRepositoryImpl implements QPdProdSetItemRepository {
    ...
    public List<PdProdSetItemDto.Item> selectList(PdProdSetItemDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(pdProdSetItem.prodSetItemId, search.getProdSetItemId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(pdProdSetItem.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(pdProdSetItem.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<PdProdSetItemDto.Item> selectPageData(PdProdSetItemDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdProdSetItem.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(pdProdSetItem.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
