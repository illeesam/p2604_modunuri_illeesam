...
public class QOdhPayStatusHistRepositoryImpl implements QOdhPayStatusHistRepository {
    ...
    /* siteId 정확 일치 */
    private BooleanExpression andSiteId(OdhPayStatusHistDto.Request search) {
        return search != null && StringUtils.hasText(search.getSiteId())
                ? h.siteId.eq(search.getSiteId()) : null;
    }

    /* payStatusHistId 정확 일치 */
    private BooleanExpression andPayStatusHistId(OdhPayStatusHistDto.Request search) {
    ...
    private BooleanExpression andSearchValue(OdhPayStatusHistDto.Request search) {
