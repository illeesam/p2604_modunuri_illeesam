...
public class QOdhPayStatusHistRepositoryImpl implements QOdhPayStatusHistRepository {
    ...
    private BooleanBuilder buildCondition(OdhPayStatusHistDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",payStatusCd,")) or.or(h.payStatusCd.likeIgnoreCase(pattern));
            if (__all || __types.contains(",payStatusCdBefore,")) or.or(h.payStatusCdBefore.likeIgnoreCase(pattern));
            if (__all || __types.contains(",payStatusHistId,")) or.or(h.payStatusHistId.likeIgnoreCase(pattern));
