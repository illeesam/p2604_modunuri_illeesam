...
public class OdhOrderItemChgHistDto {
    ...
    public static class Request extends BaseRequest {
        ...
        @Size(max = 21) private String orderItemChgHistId;  // 이력ID
    }

    @Getter @Setter @NoArgsConstructor
    public static class Item {
        private String orderItemChgHistId;  // 이력ID
        private String orderId;  // 주문ID (od_order.)
        private String orderItemId;  // 주문품목ID (od_order_item.)
        private String chgTypeCd;  // 변경유형코드 (QTY/PRICE/OPT/STATUS/AMOUNT/COUPON)
