...
import com.shopjoy.ecadminapi.base.ec.cm.repository.QCmhPushLogRepository;
...
public class QCmhPushLogRepositoryImpl implements QCmhPushLogRepository {
    ...
    private BooleanBuilder buildCondition(CmhPushLogDto.Request s) {
        ...
        // searchValue + searchTypes (def_push_log_title)
    ...
    private List<OrderSpecifier<?>> buildOrder(CmhPushLogDto.Request s) {
        ...
        switch (sort) {
            ...
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  l.pushLogTitle)); break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, l.pushLogTitle)); break;
