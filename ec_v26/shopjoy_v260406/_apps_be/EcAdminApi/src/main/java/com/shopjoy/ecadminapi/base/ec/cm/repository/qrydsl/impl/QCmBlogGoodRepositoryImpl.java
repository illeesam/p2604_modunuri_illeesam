...
public class QCmBlogGoodRepositoryImpl implements QCmBlogGoodRepository {
    ...
    private BooleanBuilder buildCondition(CmBlogGoodDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",blogId,")) or.or(g.blogId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",likeId,")) or.or(g.likeId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",siteId,")) or.or(g.siteId.likeIgnoreCase(pattern));
            if (__all || __types.contains(",userId,")) or.or(g.userId.likeIgnoreCase(pattern));
