...
public class QCmBlogGoodRepositoryImpl implements QCmBlogGoodRepository {
    ...
    public List<CmBlogGoodDto.Item> selectList(CmBlogGoodDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(cmBlogGood.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(cmBlogGood.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
