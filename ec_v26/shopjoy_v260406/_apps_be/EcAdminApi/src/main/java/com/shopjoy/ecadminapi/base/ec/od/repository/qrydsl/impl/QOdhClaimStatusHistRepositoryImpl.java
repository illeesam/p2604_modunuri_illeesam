...
public class QOdhClaimStatusHistRepositoryImpl implements QOdhClaimStatusHistRepository {
    ...
    private BooleanBuilder buildCondition(OdhClaimStatusHistDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",claimStatusCd,")) or.or(h.claimStatusCd.likeIgnoreCase(pattern));
            if (__all || __types.contains(",claimStatusCdBefore,")) or.or(h.claimStatusCdBefore.likeIgnoreCase(pattern));
            if (__all || __types.contains(",claimStatusHistId,")) or.or(h.claimStatusHistId.likeIgnoreCase(pattern));
