...
import com.shopjoy.ecadminapi.base.sy.repository.QSyDeptRepository;
...
public class QSyDeptRepositoryImpl implements QSyDeptRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(SyDeptDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  d.deptId));  break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, d.deptId));  break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  d.deptNm));  break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, d.deptNm));  break;
