...
public class QZzSample2RepositoryImpl implements QZzSample2Repository {
    ...
    private static final QZzSample2 s = QZzSample2.zzSample2;

    /* buildBaseQuery */
    private JPAQuery<ZzSample2Dto.Item> buildBaseQuery() {
        return queryFactory
    ...
    public Optional<ZzSample2Dto.Item> selectById(String id) {
        ZzSample2Dto.Item dto = buildBaseQuery()
                .where(s.sample2Id.eq(id))
                .fetchOne();
    ...
    public List<ZzSample2Dto.Item> selectList(ZzSample2Dto.Request search) {
        ...
        JPAQuery<ZzSample2Dto.Item> query = buildBaseQuery().where(where);
    ...
    /* 페이지조회 */
    @Override
    public ZzSample2Dto.PageResponse selectPageList(ZzSample2Dto.Request search) {
    ...
    /* buildCondition */
    private BooleanBuilder buildCondition(ZzSample2Dto.Request search) {
        ...
        if (search != null && StringUtils.hasText(search.getSearchValue())) {
            ...
            if (__all || __types.contains(",sample2Id,")) or.or(s.sample2Id.likeIgnoreCase(pattern));
    ...
    private List<OrderSpecifier<?>> buildOrder(ZzSample2Dto.Request search) {
        ...
        if (!StringUtils.hasText(sort)) {
            ...
            orders.add(new OrderSpecifier<>(Order.ASC, s.sample2Id));
            return orders;
        }
    ...
    public int updateSelective(ZzSample2 entity) {
        ...
        long affected = update.where(s.sample2Id.eq(entity.getSample2Id())).execute();
        return (int) affected;
    }
}
