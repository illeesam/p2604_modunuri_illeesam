...
import com.shopjoy.ecadminapi.base.sy.repository.QSyContactRepository;
...
public class QSyContactRepositoryImpl implements QSyContactRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(SyContactDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  c.contactId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, c.contactId)); break;
