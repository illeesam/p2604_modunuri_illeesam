...
import com.shopjoy.ecadminapi.base.ec.pm.repository.QPmEventBenefitRepository;
...
public class QPmEventBenefitRepositoryImpl implements QPmEventBenefitRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(PmEventBenefitDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  b.benefitId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, b.benefitId)); break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  b.benefitNm)); break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, b.benefitNm)); break;
