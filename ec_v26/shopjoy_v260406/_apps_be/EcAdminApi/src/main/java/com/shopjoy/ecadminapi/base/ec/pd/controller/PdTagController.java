...
public class PdTagController {
    ...
    @PostMapping("/save")
    public ResponseEntity<ApiResponse<PdTag>> saveDefault(@RequestBody PdTag entity) {
        return ResponseEntity.ok(ApiResponse.ok(service.save("base", entity), "저장되었습니다."));
    }

    /** save -- rowStatus 단건 분기 저장 (cmd 변형) */
    @PostMapping("/save/{cmd}")
    public ResponseEntity<ApiResponse<PdTag>> saveCmd(
            @PathVariable("cmd") String cmd, @RequestBody PdTag entity) {
