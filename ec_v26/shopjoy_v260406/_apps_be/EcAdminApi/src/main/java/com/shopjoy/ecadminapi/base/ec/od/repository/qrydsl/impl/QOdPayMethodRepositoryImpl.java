...
public class QOdPayMethodRepositoryImpl implements QOdPayMethodRepository {
    ...
    public List<OdPayMethodDto.Item> selectList(OdPayMethodDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(odPayMethod.payMethodId, search.getPayMethodId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odPayMethod.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(odPayMethod.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<OdPayMethodDto.Item> selectPageData(OdPayMethodDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odPayMethod.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odPayMethod.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
