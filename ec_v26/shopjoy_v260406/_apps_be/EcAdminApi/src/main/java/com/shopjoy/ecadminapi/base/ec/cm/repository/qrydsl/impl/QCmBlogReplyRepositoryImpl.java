...
public class QCmBlogReplyRepositoryImpl implements QCmBlogReplyRepository {
    ...
    public List<CmBlogReplyDto.Item> selectList(CmBlogReplyDto.Request search) {
        ...
        wheres.add(QdslUtil.strIn(cmBlogReply.blogId, search.getBlogIds()));
        wheres.add(QdslUtil.strEq(cmBlogReply.blogId, search.getBlogId()));
        wheres.add(QdslUtil.strEq(cmBlogReply.blogReplyId, search.getBlogReplyId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(cmBlogReply.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(cmBlogReply.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<CmBlogReplyDto.Item> selectPageData(CmBlogReplyDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(cmBlogReply.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(cmBlogReply.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
