...
public class QOdRefundMethodRepositoryImpl implements QOdRefundMethodRepository {
    ...
    public List<OdRefundMethodDto.Item> selectList(OdRefundMethodDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(odRefundMethod.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(odRefundMethod.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
