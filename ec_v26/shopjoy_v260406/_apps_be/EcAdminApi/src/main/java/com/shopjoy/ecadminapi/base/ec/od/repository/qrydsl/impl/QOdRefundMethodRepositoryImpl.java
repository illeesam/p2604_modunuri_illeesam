...
public class QOdRefundMethodRepositoryImpl implements QOdRefundMethodRepository {
    ...
    public List<OdRefundMethodDto.Item> selectList(OdRefundMethodDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(odRefundMethod.refundMethodId, search.getRefundMethodId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(odRefundMethod.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(odRefundMethod.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<OdRefundMethodDto.Item> selectPageData(OdRefundMethodDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odRefundMethod.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(odRefundMethod.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
