...
public class QMbMemberRoleRepositoryImpl implements QMbMemberRoleRepository {
    ...
    public List<MbMemberRoleDto.Item> selectList(MbMemberRoleDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(mbMemberRole.memberRoleId, search.getMemberRoleId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(mbMemberRole.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(mbMemberRole.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<MbMemberRoleDto.Item> selectPageData(MbMemberRoleDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(mbMemberRole.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(mbMemberRole.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
