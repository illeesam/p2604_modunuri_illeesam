...
public class QMbMemberRoleRepositoryImpl implements QMbMemberRoleRepository {
    ...
    public List<MbMemberRoleDto.Item> selectList(MbMemberRoleDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(mbMemberRole.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(mbMemberRole.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
