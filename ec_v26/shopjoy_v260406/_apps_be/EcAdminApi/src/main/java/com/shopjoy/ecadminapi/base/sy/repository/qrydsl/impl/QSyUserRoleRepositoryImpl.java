...
public class QSyUserRoleRepositoryImpl implements QSyUserRoleRepository {
    ...
    public List<SyUserRoleDto.Item> selectList(SyUserRoleDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syUserRole.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(syUserRole.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
