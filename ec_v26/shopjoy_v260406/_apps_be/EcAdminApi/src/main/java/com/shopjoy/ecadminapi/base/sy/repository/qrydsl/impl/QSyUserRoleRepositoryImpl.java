...
public class QSyUserRoleRepositoryImpl implements QSyUserRoleRepository {
    ...
    public List<SyUserRoleDto.Item> selectList(SyUserRoleDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(syUserRole.userRoleId, search.getUserRoleId()));
        wheres.add(QdslUtil.strEq(syUserRole.userId, search.getUserId()));
        wheres.add(QdslUtil.strEq(syUserRole.roleId, search.getRoleId()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(syUserRole.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(syUserRole.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<SyUserRoleDto.Item> selectPageData(SyUserRoleDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syUserRole.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(syUserRole.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
