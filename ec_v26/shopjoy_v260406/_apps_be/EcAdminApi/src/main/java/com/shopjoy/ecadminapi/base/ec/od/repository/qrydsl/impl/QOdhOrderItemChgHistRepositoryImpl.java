...
public class QOdhOrderItemChgHistRepositoryImpl implements QOdhOrderItemChgHistRepository {
    ...
    private BooleanBuilder buildCondition(OdhOrderItemChgHistDto.Request s) {
        ...
        if (s != null && StringUtils.hasText(s.getSearchValue())) {
            ...
            if (__all || __types.contains(",orderItemChgHistId,")) or.or(h.orderItemChgHistId.likeIgnoreCase(pattern));
    ...
    private List<OrderSpecifier<?>> buildOrder(OdhOrderItemChgHistDto.Request s) {
        ...
        if (!StringUtils.hasText(sort)) {
            ...
            orders.add(new OrderSpecifier<>(Order.ASC, h.orderItemChgHistId));
            return orders;
        }
        ...
        for (String part : sortParts) {
            ...
            if (fieldAndDir.length == 2) {
                ...
                if ("orderItemChgHistId".equals(field)) {
                    orders.add(new OrderSpecifier(order, h.orderItemChgHistId));
