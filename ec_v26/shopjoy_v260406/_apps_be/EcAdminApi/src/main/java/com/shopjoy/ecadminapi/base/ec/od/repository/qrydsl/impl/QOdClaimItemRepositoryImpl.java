...
public class QOdClaimItemRepositoryImpl implements QOdClaimItemRepository {
    ...
    public List<OdClaimItemDto.Item> selectList(OdClaimItemDto.Request search) {
        ...
        wheres.add("upd_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(odClaimItem.updDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
        wheres.add("reg_date".equals(search.getDateRangeType()) ? QdslUtil.dateBetween(odClaimItem.regDate, search.getDateRangeStart(), search.getDateRangeEnd()) : null);
