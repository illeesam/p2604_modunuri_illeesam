...
import com.shopjoy.ecadminapi.base.ec.cm.repository.QCmBlogCateRepository;
...
public class QCmBlogCateRepositoryImpl implements QCmBlogCateRepository {
    ...
    private List<OrderSpecifier<?>> buildOrder(CmBlogCateDto.Request s) {
        ...
        switch (sort) {
            case "id_asc":   orders.add(new OrderSpecifier(Order.ASC,  c.blogCateId)); break;
            case "id_desc":  orders.add(new OrderSpecifier(Order.DESC, c.blogCateId)); break;
            case "nm_asc":   orders.add(new OrderSpecifier(Order.ASC,  c.blogCateNm)); break;
            case "nm_desc":  orders.add(new OrderSpecifier(Order.DESC, c.blogCateNm)); break;
