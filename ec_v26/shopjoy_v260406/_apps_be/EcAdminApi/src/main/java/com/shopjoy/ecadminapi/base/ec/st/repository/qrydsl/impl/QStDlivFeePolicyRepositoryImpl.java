...
public class QStDlivFeePolicyRepositoryImpl implements QStDlivFeePolicyRepository {
    ...
    public List<StDlivFeePolicyDto.Item> selectList(StDlivFeePolicyDto.Request search) {
        ...
        wheres.add(QdslUtil.strEq(stDlivFeePolicy.siteId, search.getSiteId()));
        wheres.add(QdslUtil.strEq(stDlivFeePolicy.dlivMethodCd, search.getDlivMethodCd()));
        wheres.add(QdslUtil.strEq(stDlivFeePolicy.useYn, search.getUseYn()));
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            wheres.add(QdslUtil.dateBetween(stDlivFeePolicy.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else {
            wheres.add(QdslUtil.dateBetween(stDlivFeePolicy.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));   // reg_date (기본)
        }
    ...
    public BasePage<StDlivFeePolicyDto.Item> selectPageData(StDlivFeePolicyDto.Request search) {
        ...
        /* 기간검색 — dateRangeType 값에 따라 대상 컬럼을 직접 지정 */
        if ("upd_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stDlivFeePolicy.updDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        } else if ("reg_date".equals(search.getDateRangeType())) {
            whereList.add(QdslUtil.dateBetween(stDlivFeePolicy.regDate, search.getDateRangeStart(), search.getDateRangeEnd()));
        }
