...
public class AutoRestController {
    ...
    public ResponseEntity<ApiResponse<RowMap>> create(
        ...
        checkTable(table);
        RowMap created = service.create(table, body, getUserId(user));
    ...
    public ResponseEntity<ApiResponse<RowMap>> update(
            ...
            @AuthenticationPrincipal UserDetails user) {
        checkTable(table);
        return ResponseEntity.ok(ApiResponse.ok(service.update(table, id, body, getUserId(user))));
    }
    ...
    public ResponseEntity<ApiResponse<RowMap>> patch(
            ...
            @AuthenticationPrincipal UserDetails user) {
        checkTable(table);
        return ResponseEntity.ok(ApiResponse.ok(service.patch(table, id, body, getUserId(user))));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
            ...
            @AuthenticationPrincipal UserDetails user) {
        checkTable(table);
        service.delete(table, id, getUserId(user));
    ...
    public ResponseEntity<ApiResponse<Integer>> bulkDelete(
            ...
            @AuthenticationPrincipal UserDetails user) {
        checkTable(table);
        int cnt = service.bulkDelete(table, req.getIds(), getUserId(user));
