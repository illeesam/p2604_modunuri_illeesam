...
public class OdPayController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<OdPay>> updatePartial(@PathVariable("id") String id, @RequestBody OdPay entity) {
        entity.setPayId(id);
    ...
    public ResponseEntity<ApiResponse<List<OdPay>>> saveList(@RequestBody List<OdPay> rows) {
