...
public class OdOrderItemDiscntController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<OdOrderItemDiscntDto>> getById(@PathVariable("id") String id) {
    ...
    public ResponseEntity<ApiResponse<OdOrderItemDiscnt>> save(
            @PathVariable("id") String id, @RequestBody OdOrderItemDiscnt entity) {
