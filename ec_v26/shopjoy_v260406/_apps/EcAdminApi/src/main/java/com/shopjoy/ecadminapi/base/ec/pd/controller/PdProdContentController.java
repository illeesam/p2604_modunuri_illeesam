...
public class PdProdContentController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PdProdContent>> updatePartial(@PathVariable("id") String id, @RequestBody PdProdContent entity) {
        entity.setProdContentId(id);
    ...
    public ResponseEntity<ApiResponse<List<PdProdContent>>> saveList(@RequestBody List<PdProdContent> rows) {
