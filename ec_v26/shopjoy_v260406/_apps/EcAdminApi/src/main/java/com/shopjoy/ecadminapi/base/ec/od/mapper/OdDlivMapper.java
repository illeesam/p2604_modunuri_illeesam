...
public interface OdDlivMapper {
    ...
    List<OdDlivDto.Item> selectList(OdDlivDto.Request req);

    List<OdDlivDto.Item> selectPageList(OdDlivDto.Request req);

    long selectPageCount(OdDlivDto.Request req);
