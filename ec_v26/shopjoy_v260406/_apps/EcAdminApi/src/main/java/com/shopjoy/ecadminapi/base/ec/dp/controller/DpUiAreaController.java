...
public class DpUiAreaController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<DpUiArea>> updatePartial(@PathVariable("id") String id, @RequestBody DpUiArea entity) {
        entity.setUiAreaId(id);
    ...
    public ResponseEntity<ApiResponse<List<DpUiArea>>> saveList(@RequestBody List<DpUiArea> rows) {
