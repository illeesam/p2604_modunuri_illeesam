...
public class PdhProdChgHistController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PdhProdChgHist>> updatePartial(@PathVariable("id") String id, @RequestBody PdhProdChgHist entity) {
        entity.setProdChgHistId(id);
    ...
    public ResponseEntity<ApiResponse<List<PdhProdChgHist>>> saveList(@RequestBody List<PdhProdChgHist> rows) {
