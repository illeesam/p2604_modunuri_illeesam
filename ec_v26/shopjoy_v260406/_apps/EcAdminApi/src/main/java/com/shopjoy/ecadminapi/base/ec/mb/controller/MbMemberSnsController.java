...
public class MbMemberSnsController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<MbMemberSns>> updatePartial(@PathVariable("id") String id, @RequestBody MbMemberSns entity) {
        entity.setMemberSnsId(id);
    ...
    public ResponseEntity<ApiResponse<List<MbMemberSns>>> saveList(@RequestBody List<MbMemberSns> rows) {
