...
public class PmEventBenefitController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PmEventBenefit>> updatePartial(@PathVariable("id") String id, @RequestBody PmEventBenefit entity) {
        entity.setBenefitId(id);
    ...
    public ResponseEntity<ApiResponse<List<PmEventBenefit>>> saveList(@RequestBody List<PmEventBenefit> rows) {
