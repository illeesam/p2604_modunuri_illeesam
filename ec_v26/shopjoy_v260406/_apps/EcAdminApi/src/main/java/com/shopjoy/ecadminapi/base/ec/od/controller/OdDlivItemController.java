...
public class OdDlivItemController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<OdDlivItem>> updatePartial(@PathVariable("id") String id, @RequestBody OdDlivItem entity) {
        entity.setDlivItemId(id);
    ...
    public ResponseEntity<ApiResponse<List<OdDlivItem>>> saveList(@RequestBody List<OdDlivItem> rows) {
