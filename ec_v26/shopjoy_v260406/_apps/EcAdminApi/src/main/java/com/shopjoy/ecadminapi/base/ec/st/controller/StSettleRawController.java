...
public class StSettleRawController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<StSettleRaw>> updatePartial(@PathVariable("id") String id, @RequestBody StSettleRaw entity) {
        entity.setSettleRawId(id);
    ...
    public ResponseEntity<ApiResponse<List<StSettleRaw>>> saveList(@RequestBody List<StSettleRaw> rows) {
