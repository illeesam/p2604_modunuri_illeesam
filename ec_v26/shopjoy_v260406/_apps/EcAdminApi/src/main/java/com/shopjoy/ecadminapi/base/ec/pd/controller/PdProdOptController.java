...
public class PdProdOptController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PdProdOpt>> updatePartial(@PathVariable("id") String id, @RequestBody PdProdOpt entity) {
        entity.setOptId(id);
    ...
    public ResponseEntity<ApiResponse<List<PdProdOpt>>> saveList(@RequestBody List<PdProdOpt> rows) {
