...
public class PdProdSetItemController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PdProdSetItem>> updatePartial(@PathVariable("id") String id, @RequestBody PdProdSetItem entity) {
        entity.setSetItemId(id);
    ...
    public ResponseEntity<ApiResponse<List<PdProdSetItem>>> saveList(@RequestBody List<PdProdSetItem> rows) {
