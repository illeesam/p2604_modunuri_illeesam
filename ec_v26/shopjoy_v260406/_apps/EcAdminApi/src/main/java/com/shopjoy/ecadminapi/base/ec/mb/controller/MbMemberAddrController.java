...
public class MbMemberAddrController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<MbMemberAddr>> updatePartial(@PathVariable("id") String id, @RequestBody MbMemberAddr entity) {
        entity.setMemberAddrId(id);
    ...
    public ResponseEntity<ApiResponse<List<MbMemberAddr>>> saveList(@RequestBody List<MbMemberAddr> rows) {
