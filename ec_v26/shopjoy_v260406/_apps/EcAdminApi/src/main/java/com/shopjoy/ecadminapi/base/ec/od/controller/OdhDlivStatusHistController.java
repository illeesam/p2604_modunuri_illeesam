...
public class OdhDlivStatusHistController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<OdhDlivStatusHist>> updatePartial(@PathVariable("id") String id, @RequestBody OdhDlivStatusHist entity) {
        entity.setDlivStatusHistId(id);
    ...
    public ResponseEntity<ApiResponse<List<OdhDlivStatusHist>>> saveList(@RequestBody List<OdhDlivStatusHist> rows) {
