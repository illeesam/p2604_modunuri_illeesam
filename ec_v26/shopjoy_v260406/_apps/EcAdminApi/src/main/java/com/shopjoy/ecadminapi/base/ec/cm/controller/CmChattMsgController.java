...
public class CmChattMsgController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<CmChattMsg>> updatePartial(@PathVariable("id") String id, @RequestBody CmChattMsg entity) {
        entity.setChattMsgId(id);
    ...
    public ResponseEntity<ApiResponse<List<CmChattMsg>>> saveList(@RequestBody List<CmChattMsg> rows) {
