...
public class PmDiscntUsageController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<PmDiscntUsage>> updatePartial(@PathVariable("id") String id, @RequestBody PmDiscntUsage entity) {
        entity.setDiscntUsageId(id);
    ...
    public ResponseEntity<ApiResponse<List<PmDiscntUsage>>> saveList(@RequestBody List<PmDiscntUsage> rows) {
