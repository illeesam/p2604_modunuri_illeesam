...
public class DpPanelItemController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<DpPanelItem>> updatePartial(@PathVariable("id") String id, @RequestBody DpPanelItem entity) {
        entity.setPanelItemId(id);
    ...
    public ResponseEntity<ApiResponse<List<DpPanelItem>>> saveList(@RequestBody List<DpPanelItem> rows) {
